...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemReturn/getItemReturnDetailSelectList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>可选取退货明细列表接口</h1>
		<h3>/client/itemReturn/getItemReturnDetailSelectList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="projectMan" value="00220">String</td>
				</tr>
				<tr>
					<td>客户编号custCode</td>
					<td><input type="text" name="custCode" value="CT000692">String</td>
				</tr>
				<tr>
