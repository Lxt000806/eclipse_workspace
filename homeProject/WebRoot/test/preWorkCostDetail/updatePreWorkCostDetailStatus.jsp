...
function formSubmit(){
	...
	var url = "<%=path %>/client/preWorkCostDetail/updatePreWorkCostDetailStatus?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>修改工资预申请状态接口</h1>
		<h3>/client/preWorkCostDetail/updatePreWorkCostDetailStatus</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>工资预申请单编号pk</td>
					<td><input type="text" name="pk" value="">Integer</td>
				</tr>
				<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="">String 1：申请(草稿)2：提交 9：取消</td>
				</tr>
				<tr>
					<td></td>
