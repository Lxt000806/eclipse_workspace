...
function formSubmit(){
	...
	var url = "<%=path %>/client/preWorkCostDetail/getPrjWithHoldList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>项目经理预扣单列表接口</h1>
		<h3>/client/preWorkCostDetail/getPrjWithHoldList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>客户编号custCode</td>
					<td><input type="text" name="custCode" value="CT018603">String</td>
				</tr>
				<tr>
					<td>工种分类2 workType2</td>
					<td><input type="text" name="workType2" value="008">String</td>
				</tr>
				<tr>
					<td>工种分类2名称 workType2Descr</td>
					<td><input type="text" name="workType2Descr" value="">String</td>
				</tr>
				<tr>
					<td>预扣单号withHoldNo</td>
					<td><input type="text" name="withHoldNo" value="">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
