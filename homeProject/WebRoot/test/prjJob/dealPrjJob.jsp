...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjJob/dealPrjJob?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>项目任务处理接口</h1>
		<h3>/client/prjJob/dealPrjJob</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>处理说明dealRemark</td>
					<td><input type="text" name="dealRemark" value="">String</td>
				</tr>
				<tr>
					<td>处理结果endCode</td>
					<td><input type="text" name="endCode" value="">String</td>
				</tr>
				<tr>
					<td>地址address</td>
				...
				<tr>
					<td>任务处理图片列表photoNameList</td>
					<td><input type="text" name="photoNameList" value="">String</td>
				</tr>
				<tr>
					<td></td>
