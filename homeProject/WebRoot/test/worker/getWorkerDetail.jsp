...
function formSubmit(){
	...
	var url = "<%=path %>/client/worker/getWorkerDetail?"+datas;
	ajaxGet(url);
}
...
<body bgcolor="#ffffff">
	<center>
		...
		<h1>工人详情接口</h1>
		<h3>/client/worker/getWorkerDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="portalAccount" value="13850473172">String</td>
				</tr>
				<tr>
					<td>密码portalPwd</td>
					<td><input type="password" name="portalPwd" value="a12345">String</td>
				</tr>
				<tr>
