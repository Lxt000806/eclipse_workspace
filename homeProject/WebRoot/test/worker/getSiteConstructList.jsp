...
function formSubmit(){
	...
	var url = "<%=path %>/client/worker/getSiteConstructList?"+datas;
	ajaxGet(url);
}
...
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取在建工地列表</h1>
		<h3>/client/worker/getSiteConstructList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
        		...
        		<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="">String 1 or null:在建 其他:完工</td>
				</tr>
				<tr>
					<td>每页大小pageSize</td>
