...
function formSubmit(){
	...
	var url = "<%=path %>/client/item/saveItem";
	ajaxPost(url,datas);
}
</script>
</head>
	...
	<center>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>操作员编号id</td>
					<td><input type="text" name="id" value="">String</td>
				</tr>
				<tr>
					<td>批次名称remarks</td>
				...
				<tr>
					<td>材料类型itemType</td>
					<td><input type="text" name="itemType" value="JZ">String</td>
				</tr>
				<tr>
					<td>批次明细列表batchDetail</td>
					<td><input type="text" name="batchDetail" value="">String (json数据集)</td>
				</tr>
				<tr>
					<td>批次类型batchType</td>
					<td><input type="text" name="batchType" value="">String </td>
				</tr>
				<tr>
					<td></td>
