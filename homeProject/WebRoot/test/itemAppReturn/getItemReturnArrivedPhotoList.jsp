...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppReturn/getItemReturnArrivedPhotoList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>查看退货到达图片接口</h1>
		<h3>/client/driverItemAppReturn/getItemReturnArrivedPhotoList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="portalType" value="2">String</td>
				</tr>
				<tr>
					<td>退货到达编号id</td>
