...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppReturn/deleteItemAppReturnPhoto?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>删除退货图片接口</h1>
		<h3>/client/driverItemAppReturn/deleteItemAppReturnPhoto</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>退货图片名称id</td>
					<td><input type="text" name="id" value="">String(多个图片逗号隔开)</td>
				</tr>
				<tr>
					<td></td>
