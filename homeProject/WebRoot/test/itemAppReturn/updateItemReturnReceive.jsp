...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppReturn/updateItemReturnReceive?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>更新收货接口</h1>
		<h3>/client/driverItemAppReturn/updateItemReturnReceive</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>退货编号id</td>
					<td><input type="text" name="id" value="0000000001">String</td>
				</tr>
				<tr>
					<td>司机编号code</td>
					<td><input type="text" name="code" value="d001">String</td>
				</tr>
				<tr>
					<td>材料明细materialDetail</td>
					<td><input type="text" name="materialDetail" value="">String (json数据集)</td>
				</tr>
				<tr>
					<td>照片明细photoNames</td>
					<td><input type="text" name="photoNames" value="">String 多个之间用,隔开</td>
				</tr>
				<tr>
					<td></td>
