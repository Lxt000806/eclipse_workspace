...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppReturn/getItemReturnArrivedList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>已退货列表接口</h1>
		<h3>/client/driverItemAppReturn/getItemReturnArrivedList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>司机编号id</td>
					<td><input type="text" name="id" value="d001">String</td>
				</tr>
				<tr>
					<td>楼盘address</td>
