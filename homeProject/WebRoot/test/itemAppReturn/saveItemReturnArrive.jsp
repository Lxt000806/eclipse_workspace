...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppReturn/saveItemReturnArrive?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>到货保存接口</h1>
		<h3>/client/driverItemAppReturn/saveItemReturnArrive</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>材料明细pk</td>
					<td><input type="text" name="pk" value="">String 多个之间用,隔开</td>
				</tr>
				<tr>
