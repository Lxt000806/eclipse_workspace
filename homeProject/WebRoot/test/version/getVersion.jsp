...
function formSubmit(){
	...
	var url = "<%=path %>/client/version/checkVersion?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>核对版本接口</h1>
		<h3>/client/version/checkVersion</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>版本号versionNo</td>
					<td><input type="text" name="versionNo" value="1.0.0"></td>
				</tr>
					<tr>
					<td>应用名name</td>
					<td><input type="text" name="name" value="">String</td>
				</tr>
				<tr>
					<td>员工编号number</td>
					<td><input type="text" name="number" value="">String</td>
				</tr>
				<tr>
					<td></td>
