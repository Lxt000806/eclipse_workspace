...
function formSubmit(){
	...
	var url = "<%=path %>/client/employee/getEmployeeDetail?"+datas;
	ajaxGet(url);
}
...
<body bgcolor="#ffffff">
	<center>
		...
		<h1>员工详情接口</h1>
		<h3>/client/employee/getEmployeeDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="portalAccount" value="18888888888">String</td>
				</tr>
				<tr>
					<td>密码portalPwd</td>
					<td><input type="password" name="portalPwd" value="000000">String</td>
				</tr>
				<tr>
