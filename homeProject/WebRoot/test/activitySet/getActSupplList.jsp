...
function formSubmit(){
	...
	var url = "<%=path %>/client/activityGift/getActSupplList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取活动供应商列表接口</h1>
		<h3>/client/activityGift/getActSupplList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="supplType" value="">String</td>
				</tr>
				<tr>
					<td>供应商名称supplCodeDescr</td>
					<td><input type="text" name="supplCodeDescr" value="">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
