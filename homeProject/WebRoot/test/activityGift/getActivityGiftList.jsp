...
function formSubmit(){
	...
	var url = "<%=path %>/client/activityGift/getActivityGiftList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取活动礼品列表接口</h1>
		<h3>/client/activityGift/getActivityGiftList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>登记操作员姓名tokenCzyDescr</td>
					<td><input type="text" name="tokenCzyDescr" value="">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
