...
function formSubmit(){
	...
	var url = "<%=path %>/client/activityGift/doSaveActivityGift?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>添加活动礼品接口</h1>
		<h3>/client/activityGift/doSaveActivityGift</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>礼品编号itemCode</td>
					<td><input type="text" name="itemCode" value="10">String</td>
				</tr>
				<tr>
					<td>数量qty</td>
					<td><input type="number" name="qty" value="">Double</td>
				</tr>
				<tr>
					<td></td>
