...
function formSubmit(){
	...
	var url = "<%=path %>/client/activity/getTicketList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>门票业主信息列表接口</h1>
		<h3>/client/activity/getTicketList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="3">String</td>
				</tr>
				<tr>
					<td>前端请求模块页面requestFromPage</td>
					<td><input type="text" name="requestFromPage" value="">String,原actNo在evt里面判断为空,其他模块调用可能传空,做页面判断</td>
				</tr>
				<tr>
					<td>业务员编号businessMan</td>
					<td><input type="text" name="businessMan" value="3">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
