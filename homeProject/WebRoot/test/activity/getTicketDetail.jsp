...
function formSubmit(){
	...
	var url = "<%=path %>/client/activity/getTicketDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>门票详情</h1>
		<h3>/client/activity/getTicketDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>活动编号actNo</td>
					<td><input type="text" name="actNo" value="ac001">String</td>
				</tr>
				<tr>
					<td>门票号ticketNo</td>
					<td><input type="text" name="ticketNo" value="t00023">String</td>
				</tr>
				<tr>
					<td></td>
