...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProblem/getPrjPromTypeList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取责任分类列表接口</h1>
		<h3>/client/prjProblem/getPrjPromTypeList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>责任部门prjPromDept</td>
					<td><input type="text" name="prjPromDept" value="">String,表tPrjPromDept</td>
				</tr>
				<tr>
					<td></td>
