...
function formSubmit(){
	...
	var url = "<%=path %>/client/personMessage/updateBatchPersonMessage?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>批量修改消息状态接口</h1>
		<h3>/client/personMessage/updateBatchPersonMessage</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>接收人类型rcvType</td>
					<td><input type="text" name="rcvType" value="">String 1：员工 2：客户</td>
				</tr>
				<tr>
					<td>接收人rcvCzy</td>
					<td><input type="text" name="rcvCzy" value="">String</td>
				</tr>
				<tr>
					<td>消息类型msgType</td>
					<td><input type="text" name="msgType" value="">String</td>
				</tr>
				<tr>
					<td></td>
