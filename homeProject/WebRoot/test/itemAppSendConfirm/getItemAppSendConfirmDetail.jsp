...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemAppSendConfirm/getItemAppSendConfirmDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>确认到货单详情接口</h1>
		<h3>/client/itemAppSendConfirm/getItemAppSendConfirmDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>发货单号id</td>
					<td><input type="text" name="id" value="IAS0000000004">String</td>
				</tr>
				<tr>
					<td></td>
