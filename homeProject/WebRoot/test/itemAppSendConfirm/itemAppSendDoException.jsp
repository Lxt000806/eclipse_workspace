...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemAppSendConfirm/itemAppSendDoException?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>到货单确认异常接口</h1>
		<h3>/client/itemAppSendConfirm/itemAppSendDoException</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>发货编号no</td>
					<td><input type="text" name="no" value="IAS0000000004">String</td>
				</tr>
				<tr>
					<td>confirmMan确认人</td>
					<td><input type="text" name="confirmMan" value="00220">String</td>
				</tr>
				<tr>
					<td>confirmReason 确认异常原因</td>
					<td><input type="text" name="confirmReason" value="">String</td>
				</tr>
				<tr>
					<td>projectManRemark项目经理备注</td>
					<td><input type="text" name="projectManRemark" value="">String</td>
				</tr>
				<tr>
					<td></td>
