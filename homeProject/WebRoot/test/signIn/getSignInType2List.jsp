...
function formSubmit(){
	...
	var url = "<%=path %>/client/signIn/getSignInType2List?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取签到类型2列表</h1>
		<h3>/client/signIn/getSignInType2List</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>签到类型1 signInType1</td>
					<td><input type="text" name="signInType1" value="">String : 01 通用;02 集成</td>
				</tr>
				<tr>
					<td></td>
