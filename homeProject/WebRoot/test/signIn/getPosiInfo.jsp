...
function formSubmit(){
	...
	var url = "<%=path %>/client/signIn/getPosiInfo?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取项目名称的位置信息接口</h1>
		<h3>/client/signIn/getPosiInfo</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>城市city</td>
					<td><input type="text" name="city" value="福州">String(默认选择福州  有些地址只有在同省市区内才能查出)</td>
				</tr>
				<tr>
					<td>是否限制城市city_limit</td>
					<td><input type="text" name="city_limit" value="0">String 0:不限制() 1:限制(只在限制市区查询)</td>
				</tr>
				<tr>
					<td>地址address</td>
					<td><input type="text" name="address" value="晴园虹锦">String</td>
				</tr>
				<tr>
					<td></td>
