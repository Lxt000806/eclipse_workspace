...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProgConfirm/getSiteConfirmDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>工地验收详情接口</h1>
		<h3>/client/prjProgConfirm/getSiteConfirmDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>工地验收编号id</td>
					<td><input type="text" name="id" value="PM00000011">String</td>
				</tr>
				<tr>
					<td></td>
