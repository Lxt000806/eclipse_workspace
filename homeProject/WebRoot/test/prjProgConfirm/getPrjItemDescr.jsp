...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProgConfirm/getPrjItemDescr?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>未验收施工阶段列表接口</h1>
		<h3>/client/prjProgConfirm/getPrjItemDescr</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>客户编号id</td>
					<td><input type="text" name="id" value="CT003449">String</td>
				</tr>
				<tr>
					<td>工程角色prjRole</td>
					<td><input type="text" name="prjRole" value="">String</td>
				</tr>
				<tr>
					<td>项目节点prjItem</td>
