...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProgConfirm/getSiteConfirmList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>工地验收列表接口</h1>
		<h3>/client/prjProgConfirm/getSiteConfirmList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>操作员编号id</td>
					<td><input type="text" name="id" value="00220">String</td>
				</tr>
				<tr>
					<td>客户编号custCode</td>
