...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/updateItemPreAppStatus?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>修改预领料状态接口</h1>
		<h3>/client/itemPreApp/updateItemPreAppStatus</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="">String 1：申请(草稿)2：提交 6：取消</td>
				</tr>
				<tr>
					<td></td>
