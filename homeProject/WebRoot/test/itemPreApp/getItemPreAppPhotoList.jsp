...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/getItemPreAppPhotoList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>查看预领料图片接口</h1>
		<h3>/client/itemPreApp/getItemPreAppPhotoList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>预领料编号id</td>
					<td><input type="text" name="id" value="0000000088">String</td>
				</tr>
				<tr>
					<td></td>
