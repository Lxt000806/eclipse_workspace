...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/getItemReqList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取客户材料需求列表接口</h1>
		<h3>/client/itemPreApp/getItemReqList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>材料类型2 itemType2</td>
					<td><input type="text" name="itemType2" value="">String</td>
				</tr>
				<tr>
					<td>材料名称itemCodeDescr</td>
					<td><input type="text" name="itemCodeDescr" value="">String</td>
				</tr>
				<tr>
					<td>客户编号custCode</td>
					<td><input type="text" name="custCode" value="CT000497">String</td>
				</tr>
				<tr>
					<td>是否套餐材料isSetItem</td>
					<td><input type="text" name="isSetItem" value="0">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
