...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/getItemPreAppDetailList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>预领料明细列表接口</h1>
		<h3>/client/itemPreApp/getItemPreAppDetailList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>预领料编号id</td>
					<td><input type="text" name="id" value="IA00000005">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
