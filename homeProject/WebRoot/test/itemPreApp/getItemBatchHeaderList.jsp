...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/getItemBatchHeaderList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取材料批次列表接口</h1>
		<h3>/client/itemPreApp/getItemBatchHeaderList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>批次类型batchType</td>
					<td><input type="text" name="batchType" value="3">String 3：领料模板</td>
				</tr>
				<tr>
