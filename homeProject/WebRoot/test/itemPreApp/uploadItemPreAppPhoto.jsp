...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/uploadItemPreAppPhoto";
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>上传预领料图片接口</h1>
		<h3>/client/itemPreApp/uploadItemPreAppPhoto</h3>
		<hr noshade size="3" width=80% />
		<%
			String respString = "";
			int port = request.getServerPort();
		%>
		<form id="uploadForm" method="post" enctype="multipart/form-data" action="<%=path %>/client/itemPreApp/uploadItemPreAppPhoto">
