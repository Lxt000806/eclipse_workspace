...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemPreApp/getItemAppTempAreaDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取领料模板明细列表接口</h1>
		<h3>/client/itemPreApp/getItemAppTempAreaDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>模板号no</td>
					<td><input type="text" name="no" value="IAT00000001">String</td>
				</tr>
				<tr>
					<td>客户编号custCode</td>
					<td><input type="text" name="custCode" value="CT025391">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
