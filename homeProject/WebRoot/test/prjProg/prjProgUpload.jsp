...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProg/prjProgUpload?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>上传图片接口</h1>
		<h3>/client/prjProg/prjProgUpload</h3>
		...
		%>
		<form>
			<input type="hidden" id="photoContent" name="photoContent"/>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				bordercolorlight="#ADAAAD">
				<tr>
					<td>接入Portal类型portalType</td>
					<td><input type="text" name="portalType" value="1"></td>
				</tr>
				<tr>
					<td>图片路径url</td>
					<td><input type="text" name="url" value="E:\1381397888221.jpg">测试用，实际传的是photoContent</td>
				</tr>
				<tr>
					<td>类型type</td>
					<td>
						<input type="text" name="type" value="0">Integer 0：工程进度图片 1：其他图片
					</td>
				</tr>
				<tr>
					<td></td>
