...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProg/prjProgUploadApp";
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>上传图片接口App</h1>
		<h3>/client/prjProg/prjProgUploadApp</h3>
		<hr noshade size="3" width=80% />
		<%
			String respString = "";
			int port = request.getServerPort();
		%>
		<form id="uploadForm" method="post" enctype="multipart/form-data" action="<%=path %>/client/prjProg/prjProgUploadApp">
