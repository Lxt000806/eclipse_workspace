...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProg/getPrjProgAlarmDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>工程进度提醒模板详情接口</h1>
		<h3>/client/prjProg/getPrjProgAlarmDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>提醒日期类型dayType</td>
					<td><input type="text" name="dayType" value="">String 1：开始时间 2：结束时间</td>
				</tr>
				<tr>
					<td></td>
