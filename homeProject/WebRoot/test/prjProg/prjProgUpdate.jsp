...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProg/updatePrjProg?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>进度修改接口</h1>
		<h3>/client/prjProg/updatePrjProg</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>实际开工时间beginDate</td>
					<td><input type="text" name="beginDate" value="">Date(格式：2016-02-25 11:01:33)</td>
				</tr>
				<tr>
					<td>实际完工时间endDate</td>
					<td><input type="text" name="endDate" value="">Date(格式：2016-02-25 11:01:33)</td>
				</tr>
				<tr>
					<td></td>
