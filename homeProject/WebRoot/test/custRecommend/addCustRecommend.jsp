...
function formSubmit(){
	...
	var url = "<%=path %>/client/weChat/wxCustFastAccountCs?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>新增客户推荐</h1>
		<h3>/client/weChat/wxCustFastAccountCs</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>手机号</td>
					<td><input type="text" name="phone" value="">String</td>
				</tr>
				<tr>
					<td>推荐来源</td>
					<td><input type="text" name="recommendSource" value="">String,1:工人手工填写;2:工人小程序码;4.员工小程序码；5小程序小程序码</td>
				</tr>
				<tr>
					<td>推荐人</td>
					<td><input type="text" name="recommender" value="">String,工人填工人编号,员工填员工编号,客户填账号pk</td>
				</tr>
