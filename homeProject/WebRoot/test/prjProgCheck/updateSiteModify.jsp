...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProgCheck/updateSiteModify?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>重新整改接口</h1>
		<h3>/client/prjProgCheck/updateSiteModify</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>工地巡检编号no</td>
					<td><input type="text" name="no" value="PC00000059">String</td>
				</tr>
				<tr>
					<td>巡检说明remarks</td>
