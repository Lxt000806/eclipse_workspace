...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProgCheck/getPrjProgCheckList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>查看工地巡检列表接口</h1>
		<h3>/client/prjProgCheck/getPrjProgCheckList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>是否整改isModify</td>
					<td><input type="text" name="isModify" value="">String,旧:1 整改 ,0无整改<br/>新:2已整改,3无整改,4待整改,5待整改超时</td>
				</tr>
				<tr>
					<td>客户编号custCode</td>
