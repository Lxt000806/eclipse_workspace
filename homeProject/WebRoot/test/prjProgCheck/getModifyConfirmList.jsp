...
function formSubmit(){
	...
	var url = "<%=path %>/client/prjProgCheck/getModifyConfirmList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取整改验收列表</h1>
		<h3>/client/prjProgCheck/getModifyConfirmList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="待验收">String :默认待验收</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
