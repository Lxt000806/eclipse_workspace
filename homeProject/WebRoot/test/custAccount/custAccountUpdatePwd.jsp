...
function formSubmit(){
	...
	var url = "<%=path %>/client/custAccount/updateCustAccountPwd?"+datas;
	ajaxGet(url);
}
...
<body bgcolor="#ffffff">
	<center>
		...
		<h1>客户修改密码接口</h1>
		<h3>/client/custAccount/updateCustAccountPwd</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>旧密码oldPwd</td>
					<td><input type="text" name="oldPwd" value="">String</td>
				</tr>
				<tr>
					<td>新密码newPwd</td>
					<td><input type="text" name="newPwd" value="">String</td>
				</tr>
				<tr>
