...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppSend/getItemAppSendArrivedDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>送货到货详情接口</h1>
		<h3>/client/driverItemAppSend/getItemAppSendArrivedDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>送货编号id</td>
					<td><input type="text" name="id" value="IAS0000036019">String</td>
				</tr>
				<tr>
					<td></td>
