...
function formSubmit(){
	...
	var url = "<%=path %>/client/driverItemAppSend/getItemAppSendPhotoList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>查看送货图片接口</h1>
		<h3>/client/driverItemAppSend/getItemAppSendPhotoList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="portalType" value="1">String 1送货 2退货</td>
				</tr>
				<tr>
					<td>送货编号id</td>
					<td><input type="text" name="id" value="IAS0000000005">String</td>
				</tr>
				<tr>
					<td></td>
