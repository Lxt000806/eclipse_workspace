...
function formSubmit(){
	...
	var url = "<%=path %>/client/workerApp/updateWorkerApp?"+datas;
	ajaxGet(url);
}
...
<body bgcolor="#ffffff">
	<center>
		...
		<h1>更新工人申请信息</h1>
		<h3>/client/workerApp/updateWorkerApp</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
        		...
        		<tr>
					<td>工种分类12 workType12</td>
					<td><input type="text" name="workType12" value="">String</td>
				</tr>
        		<tr>
					<td>申请进场时间appComeDate</td>
					<td><input type="text" name="appComeDate" value="">Date</td>
				</tr>
        		<tr>
					<td>备注remark</td>
