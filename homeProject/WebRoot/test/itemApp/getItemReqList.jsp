...
function formSubmit(){
	...
	var url = "<%=path %>/client/itemApp/getItemReqList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>领料需求列表接口</h1>
		<h3>/client/itemApp/getItemReqList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					...
					<td><input type="text" name="itemType1" value="ZC">String</td>
				</tr>
				<tr>
					<td>是否服务isService</td>
					<td><input type="text" name="isService" value="0">Integer 0：否 1：是</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
