...
function formSubmit(){
	...
	var url = "<%=path %>/client/basic/getCustomerByUserCustRight?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>根据用户权限获取工地列表</h1>
		<h3>/client/basic/getCustomerByUserCustRight</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="4">String</td>
				</tr>
				<tr>
					<td></td>
