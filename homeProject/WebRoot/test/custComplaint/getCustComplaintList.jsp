...
function formSubmit(){
	...
	var url = "<%=path %>/client/custComplaint/getCustComplaintList?"+datas;
	ajaxGet(url);
}
...
<body bgcolor="#ffffff">
	<center>
		...
		<h1>获取客户投诉列表接口</h1>
		<h3>/client/custComplaint/getCustComplaintList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
        		...
        		<tr>
					<td>状态status</td>
					<td><input type="text" name="status" value="">String :1 待处理;2 已完成;</td>
				</tr>
        		<tr>
					<td>二级部门名称department2Descr</td>
					<td><input type="text" name="department2Descr" value="">String</td>
				</tr>
        		<tr>
					<td>是否包含完工客户haveGd</td>
					<td><input type="text" name="haveGd" value="">String : 0 否;1 是;</td>
				</tr>
				<tr>
					<td>每页大小pageSize</td>
