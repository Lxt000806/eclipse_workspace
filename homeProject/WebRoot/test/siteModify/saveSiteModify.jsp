...
function formSubmit(){
	...
	var url = "<%=path %>/client/siteModify/saveSiteModify?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>工地整改保存接口</h1>
		<h3>/client/siteModify/saveSiteModify</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>整改说明compRemark</td>
					<td><input type="text" name="compRemark" value="">String</td>
				</tr>
				<tr>
					<td>整改图片列表photoNameList</td>
