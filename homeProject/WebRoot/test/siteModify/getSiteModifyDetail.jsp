...
function formSubmit(){
	...
	var url = "<%=path %>/client/siteModify/getSiteModifyDetail?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>工地整改详情接口</h1>
		<h3>/client/siteModify/getSiteModifyDetail</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>巡检编号id</td>
					<td><input type="text" name="id" value="PC00000002">String</td>
				</tr>
				<tr>
					<td></td>
