...
function formSubmit(){
	...
	var url = "<%=path %>/client/customer/getCustomerItemChangeList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>客户材料变更列表接口</h1>
		<h3>/client/customer/getCustomerItemChangeList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>材料名称itemDescr</td>
					<td><input type="text" name="itemDescr" value="">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
