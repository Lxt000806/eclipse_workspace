...
function formSubmit(){
	...
	var url = "<%=path %>/client/customer/getBaseItemChgDetailList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>客户基础变更明细列表接口</h1>
		<h3>/client/customer/getBaseItemChgDetailList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>基础变更编号id</td>
					<td><input type="text" name="id" value="2013051715">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
