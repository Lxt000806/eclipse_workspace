...
function formSubmit(){
	...
	var url = "<%=path %>/client/customer/getCustomerItemChangeDetailList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>客户材料变更详情列表接口</h1>
		<h3>/client/customer/getCustomerItemChangeDetailList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>材料变更编号id</td>
					<td><input type="text" name="id" value="2013041925">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
