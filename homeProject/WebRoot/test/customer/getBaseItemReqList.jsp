...
function formSubmit(){
	...
	var url = "<%=path %>/client/customer/getBaseItemReqList?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>客户基础需求列表接口</h1>
		<h3>/client/customer/getBaseItemReqList</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>客户编号custCode</td>
					<td><input type="text" name="custCode" value="CT000291">String</td>
				</tr>
				<tr>
					<td>区域 fixAreaDescr</td>
					<td><input type="text" name="fixAreaDescr" value="">String</td>
				</tr>
				<tr>
					<td>每页条数pageSize</td>
