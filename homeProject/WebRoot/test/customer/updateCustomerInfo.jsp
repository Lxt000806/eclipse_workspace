...
function formSubmit(){
	...
	var url = "<%=path %>/client/customer/updateCustomerInfo?"+datas;
	ajaxGet(url);
}
</script>
</head>
<body bgcolor="#ffffff">
	<center>
		...
		<h1>更新客户信息表:可拓展</h1>
		<h3>/client/customer/updateCustomerInfo</h3>
		...
		<form>
			<table border="1" align="center" bordercolordark="#EBEBEB"
				...
				<tr>
					<td>新工地密码newBuildPass</td>
					<td><input type="text" name="newBuildPass" value="">String</td>
				</tr>
				<tr>
					<td></td>
