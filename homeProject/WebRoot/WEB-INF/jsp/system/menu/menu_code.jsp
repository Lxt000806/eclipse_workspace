...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			url:"${ctx}/admin/menu/goJqGrid",
			height:$(document).height()-$("#content-list").offset().top-70,
			styleUI: 'Bootstrap', 
			colModel : [
			  {name : 'menuurl',index : 'menuurl',width : 200,label:'菜单编号',sortable : true,align : "left"},
		      {name : 'menuname',index : 'menuname',width : 200,label:'菜单名称',sortable : true,align : "left"}
            ],
