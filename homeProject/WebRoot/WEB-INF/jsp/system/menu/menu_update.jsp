	...
	<div class="panel panel-info">  
        <div class="panel-body">
            <form role="form" class="form-search" id="dataForm" action="" method="post" target="targetFrame">
				...
				<input type="hidden" id="oldMenuName" name="oldMenuName" value="${menu.menuName }"/>
				<ul class="ul-form">
				<div class="validate-group row">
					<div class="col-sm-4">
					<li class="form-validate">
						<label><span class="required">*</span>菜单名称</label>
						<input type="text" style="width:160px;" id="menuName" name="menuName" value="${menu.menuName }"/>
					</li>
					</div>
					<div class="col-sm-4">
					<li class="form-validate">
						<label><span class="required">*</span>菜单类型</label>
						<house:dict id="menuType" dictCode="ABSTRACT_DICT_MENU_TYPE" value="${menu.menuType }"></house:dict>
					</li>
					</div>
					<div class="col-sm-4">
					<li class="form-validate">
				...
				<div class="validate-group row">
					...
					<li class="form-validate">
						...
						<house:dict id="openType" dictCode="ABSTRACT_DICT_MENU_OPEN" value="${menu.openType }"></house:dict>
					</li>
					</div>
					<div class="col-sm-4">
					<li class="form-validate">
						<label><span class="required" id="urlSign" style="visibility:hidden;">*</span>操作链接</label>
						<input type="text" style="width:160px;" id="menuUrl" name="menuUrl" value="${menu.menuUrl }"/>
					</li>
					</div>
					<div class="col-sm-4">
					<li class="form-validate">
						<label>排列顺序</label>
						<input type="text" style="width:160px;" id="orderNo" name="orderNo" value="${menu.orderNo }" />
					</li>
					</div>
				</div>
				<div class="validate-group row">
					...
					<li class="form-validate">
						...
						<house:dict id="sysCode" dictCode="ptdm" value="${menu.sysCode }"></house:dict>
					</li>
					</div>
					<div class="col-sm-8">
					<li class="form-validate">
						<label class="control-textarea">备注</label>
						<textarea id="remark" name="remark">${menu.remark }</textarea>
					</li>
					</div>
				</div>
				</ul>
