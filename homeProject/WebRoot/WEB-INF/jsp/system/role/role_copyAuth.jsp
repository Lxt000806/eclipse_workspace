...
<html>
	...
	function save(){
		...
		art.dialog({
			content:"确定给“待复制权限列表”用户赋予角色["+$("#roleId").val()+"]的操作权限！<br/><br/>注意：待复制权限列表原角色操作权限将失效！",
			ok:function(){
				$.ajax({
					url:"${ctx}/admin/role/doCopyRight",
					data:data,
		...
		<div class="body-box-list">
			...
			<div class="panel-body">
				<form action="" method="post" id="page_form" class="form-search">
					...
					<ul class="ul-form">
						<li><label>被复制角色</label> <input type="text" id="roleId" name="roleId" value="${role.roleId}" />
