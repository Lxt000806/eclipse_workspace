...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/authority/doSave',
		type: 'post',
...
function addTr(){
	...
	var str =  "<tr index="+seq_num+">"+
					"<td class=\"td-seq\">"+seq_num+"</label>"+
					"<td><input type=\"text\" name=\"urlStr\" style=\"width:90%;\"/></label>"+
					"<td><input type=\"text\" name=\"urlRemark\" style=\"width:90%;\"/></label>"+
					"<td style=\"text-align: center;\"><a href=\"javascript:void(0)\" onclick=\"delTr('"+seq_num+"')\">删除</a></label>"+
				"</tr>";
				...
				<house:token></house:token>
					<ul class="ul-form">
							<div class="validate-group row">
								...
								<input type="text"  id="authName" name="authName" data-bv-notempty data-bv-notempty-message="权限名称不能为空"/>
								</li>
								</div>
								<div class="col-sm-6" >
								<li class="form-validate">
								<label><span class="required">*</span>权限编码</label>
						        <input type="text"  id="authCode" name="authCode" data-bv-notempty data-bv-notempty-message="权限编码不能为空"/>
						        </li>
						        </div>
						        </div>
							...
							<div class="validate-group row">
								...
								<house:zTree nodes="${menus}" id="menuId" nodeId="menuId" nodePId="parentId" nodeName="menuName" value="${defaultMenuId }" canSelectParent="false" beforeClick="fliterMenuType" beforeLoadTree="changeMenuIcon" onClick="validateRefresh('menuId_NAME')"></house:zTree>
								</li>
								</div>
								</div>
								<div class="validate-group row">
								...
								<textarea style="width: 660px"   id="remark" name="remark"></textarea>
								</li>
								</div>
							</div>
							</ul>
				<table class="table-layout-fixed" id="fix_layout_table">
					...
					<tbody>
						<tr index="1">
							...
							<td style="text-align: center;"><a href="javascript:void(0)" onclick="delTr('1')">删除</a></td>
						</tr>
					</tbody>
				</table>
			</form>
