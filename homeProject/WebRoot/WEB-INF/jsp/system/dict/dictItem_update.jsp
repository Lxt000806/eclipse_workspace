...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/dictItem/doUpdate',
		type: 'post',
...
function refresh(){
	if(parentWin != null){
		parentWin.parent.treeFrame.location.href = "${ctx}/admin/dict/goTree?defaultId=${dictItem.dictId }&dictType=${dictType}";
		parentWin.location.href="${ctx}/admin/dictItem/goList?dictId=${dictItem.dictId }&dictType=${dictType}";
	}
}
//校验函数
$(function() {
	...
	<div class="panel panel-info">  
        <div class="panel-body">
            <form role="form" class="form-search" id="dataForm" action="" method="post" target="targetFrame">
				...
				<input type="hidden" id="status" name="status" value="${dictItem.status }"/>
				<input type="hidden" id="oldItemCode" name="oldItemCode" value="${dictItem.itemCode }"/>
				<input type="hidden" id="oldItemLabel" name="oldItemLabel" value="${dictItem.itemLabel }"/>
					<ul class="ul-form">
