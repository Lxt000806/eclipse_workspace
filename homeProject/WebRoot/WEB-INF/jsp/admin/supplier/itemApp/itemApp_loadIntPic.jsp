...
$(function() {
	...
	$.extend(gridOption,{
		url:"${ctx}/admin/custDoc/goDocJqGrid",
		postData:{custCode:'${customer.code}',docType1:'4',docType2:'8'} ,
	});
	...
	function goto_query(){
		$("#dataTable").jqGrid("setGridParam",{postData:{custCode:'${customer.code }',docType1:'4',docType1:'8'},page:1,sortname:''}).trigger("reloadGrid");
	}
</script>
</head>
	<body>
