				...
				<form action="" method="post" id="dataForm" class="form-search">
					<ul class="ul-form">
						...
						<div class="validate-group row">
							...
							<li>
							    <label>工地密码</label>
							    <input type="text" id="buildPass" name="buildPass" value="${supplJob.buildPass}"/>
							</li>
						...
						<div class="validate-group row">
							...
							<li class="form-validate" hidden="true"><label>接收时间</label> <input
						...
						<div class="validate-group row">
							<li class="form-validate" hidden="true"><label>完成时间</label> <input
							...
							<li class="form-validate"><label><span
								...
								value="<fmt:formatDate value='${supplJob.planDate}' pattern='yyyy-MM-dd '/>" />
							</li>
						</div>
						<div class="validate-group row">
