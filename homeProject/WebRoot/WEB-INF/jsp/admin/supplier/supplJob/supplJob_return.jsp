...
<script type="text/javascript"> 
	...
	$("#return").on("click", function() {
			...
			$.ajax({
				url : "${ctx}/admin/supplJob/doReturn",
				type : "post",
					...
					<ul class="ul-form">
						...
						<div class="validate-group row">
							<li class="form-validate"><label class="control-textarea"><span
								...
								<textarea id="supplRemarks" name="supplRemarks" required
									data-bv-notempty-message="供应商备注不能为空" />${supplJob.supplRemarks
								}</textarea>
							</li>
						</div>
					</ul>
