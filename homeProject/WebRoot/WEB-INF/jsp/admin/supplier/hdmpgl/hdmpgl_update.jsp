...
function validateRefresh_choice(){
	...
	$(function() {
		if(${hdmpgl.provideType}=='2'){
			...
			$('input[name=openComponent_employee_designMan]').css('background','#D4D0C8');
			$('input[name=openComponent_employee_businessMan]').css('background','#D4D0C8');
			...
			$("#businessMan").openComponent_employee({callBack:validateRefresh_choice,showValue:'${hdmpgl.businessMan }',showLabel:'${hdmpgl.businessDescr }'} );
			$("#designMan").openComponent_employee( {showValue:'${hdmpgl.designMan }',showLabel:'${hdmpgl.designDescr }'});
			$('input[name=busiManPhone]').css('background','#D4D0C8');
			$('input[name=busiManName]').css('background','#D4D0C8');
