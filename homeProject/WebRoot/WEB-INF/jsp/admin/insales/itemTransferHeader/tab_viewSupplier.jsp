...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_supplier",{
			url:"${ctx}/admin/itemTransferHeader/goOrderBySupplJqGrid",
			postData:{no:'${itemTransferHeader.no}'},
		styleUI: 'Bootstrap', 
		    height:300,
			colModel : [
				...
				{name:'allcost', index:'allcost', width:65, label:'金额', sortable:true ,align:"right"},
			],
		});
