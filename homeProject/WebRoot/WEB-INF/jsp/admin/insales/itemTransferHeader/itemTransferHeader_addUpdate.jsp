...
<title>仓库转移-新增编辑</title>
	...
	$(function() {
		...
		$("#itCode").openComponent_item({callBack:getData,showValue:"${itemTransferHeader.itCode}",showLabel:"${item.descr}",condition:{isItemTran:"1"},readonly:true});
		...
		(function getFillData(){
			$.ajax({
			    ...
			    success: function(obj){
					...
					$("#fromAfterQty").val(myRound(obj[0])-myRound("${itemTransferHeader.trfQty}"));
					$("#toAfterQty").val(myRound(obj[2])+myRound("${itemTransferHeader.trfQty}"));
				}
			});	
		})();
		function getData(data){
						...
						<ul class="ul-form">
							...
							<div  style="width:48%;height:200px ;float:left; border:1px solid #cfcfcf ;margin-top: 15px; class="container"  >
								...
								<li style="vertical-align:middle;margin-left:-17px;">
									...
									<input type="text" id="fromAfterUom" name="fromAfterUom" value="" style="width:50px; outline:none; background:transparent; border:none" readonly="true"/>
								</li>
								<div id="costDiv">
									<li style="vertical-align:middle;margin-left:-17px;">
										<label>成本单价</label>
