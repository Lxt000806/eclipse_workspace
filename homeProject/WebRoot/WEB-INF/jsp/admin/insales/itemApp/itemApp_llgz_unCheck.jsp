...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function(){
				$("#unCheckMainManCode").openComponent_employee();
			    Global.LinkSelect.initSelect("${ctx}/admin/item/itemTypeByAuthority", "unCheckItemType1", "unCheckItemType2")
				Global.JqGrid.initJqGrid("unCheckDataTable",{
					height:350,
					width:1200,
        			autowidth: false,
					url:"${ctx}/admin/itemApp/goUnCheckJqGrid",
					postData:{
						itemType1:$("#unCheckItemType1").val(),
			...
			function unCheckSearch(){
				$("#unCheckDataTable").jqGrid("setGridParam",{
					postData:{
						itemType1:$("#unCheckItemType1").val(),
						itemType2:$("#unCheckItemType2").val(),
						appDateFrom:$("#appDateFrom").val(),
		...
		<div class="query-form" style="border:0px;">
			<form action="" method="post" id="page_form" class="form-search">
				<ul class="ul-form">
					<li>
                        <label>材料类型1</label>
                        <select id="unCheckItemType1" name="unCheckItemType1"></select>
                    </li>
                    <li>
                        <label>材料类型2</label>
                        <select id="unCheckItemType2" name="unCheckItemType2"></select>
                    </li>
					<li>
						<label>申请日期</label>
					...
					<li>
						<label>主材管家</label>
						<input type="text" id="unCheckMainManCode" />
					</li>
					<li>
						<button type="button" class="btn btn-sm btn-system " onclick="unCheckSearch()">查询</button>
					</li>
				</ul>
			</form>
		</div>
		<div>
			<table id="unCheckDataTable"></table>
			<div id="unCheckDataTablePager"></div>
		</div>
	</body>
</html>
