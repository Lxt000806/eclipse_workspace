					...
					<ul class="ul-form">
						<div class="validate-group row" >
							...
							<li>
								...
								<house:xtdm id="status" dictCode="PURAPPSTAT"  value="${purchaseApp.status}" disabled="true"></house:xtdm>                     
							</li>
							<li class="form-validate">
								<label>仓库编号</label>
						...
						<div class="validate-group row">
							...
							<li>
								...
								<textarea id="remark" name="remark" rows="2">${purchaseApp.remark }</textarea>
  							</li>
						</div>
  					</ul>	
  				</form>
...
$(function(){
	...
	$("#saveBtn").on("click",function(){
		...
		Global.Form.submit("dataForm","${ctx}/admin/purchaseApp/doUpdate",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
