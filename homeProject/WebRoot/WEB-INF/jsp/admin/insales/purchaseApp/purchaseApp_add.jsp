			...
			<div class="panel panel-info" >  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" name="uomDescr" id="uomDescr" />
						<input type="hidden" name="itemType2Descr" id="itemType2Descr"/>
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<input type="text" id="qty" name="qty" style="width:160px;" value="0.0"/>
								</li>
							</div>
							<div class="validate-group row">
								<li>
