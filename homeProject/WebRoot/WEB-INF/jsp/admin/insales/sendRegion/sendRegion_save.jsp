					...
					<ul class="ul-form">
						...
						<div class="row">
							<li class="form-validate">
								...
								<input type="text" id="descr" name="descr" style="width:160px;" autofocus/>
							</li>
						</div>
						<div class="row">
							<li class="form-validate">
						...
						<div class="row">
							<li class="form-validate">
								<label>发货类型</label>
								<house:xtdm id="sendType" dictCode="ITEMAPPSENDTYPE" style="width:160px;"/>
							</li>
						</div>
						<div class="row">
							<li style="max-height: 120px;">
								<label class="control-textarea" style="top: -100px;">备注</label>
								<textarea id="remarks" name="remarks" style="height: 120px;width: 160px;"></textarea>
							</li>
						</div>
					</ul>	
				</form>
...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/sendRegion/doSave",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
