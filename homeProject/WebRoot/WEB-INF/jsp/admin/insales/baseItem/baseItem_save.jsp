...
<head>
	...
	$(function(){
		$("#baseTempNo").openComponent_basePlanTemp({callBack:function(){validateRefresh('openComponent_basePlanTemp_baseTempNo')}});
						...
						<ul class="ul-form">
							<div class="row">
								<div class="col-xs-6">
									<li>
										<label>基础项目编号</label> 
										<input type="text" id="code" name="code" style="width:160px;" value="${baseItem.code }" placeholder="保存自动生成"  readonly="readonly" />
									</li>
									...
									<li class="form-validate">
										...
										<house:xtdm id="category" dictCode="BASEITEMCAT" value="1" onchange="updateItemType(this)"></house:xtdm>
									</li>
									<li class="form-validate">
									...
									<li class="form-validate">
										<label>是否固定价</label> 
										<house:xtdm id="isFixPrice" dictCode="YESNO" value="1" ></house:xtdm>
									</li>
									<li class="form-validate">
										<label>单位</label> 
									...
									<li class="form-validate">
										<label>显示顺序</label> 
										<input type="text" id="dispSeq" name="dispSeq" style="width:160px;" onkeyup="value=value.replace(/[^\?\d]/g,'')" value="0"/>
									</li>
									<li class="form-validate">
										<label><span class="required">*</span>业绩比例</label> 
										<input type="text" id="perfPer" name="perfPer" onkeyup="value=value.replace(/[^\?\d.]/g,'')" style="width:160px;" value="1" readonly="true"/>
									</li>
									<li>
                                        <label>过期</label>
								...
								<div class="col-xs-6">
									...
									<li class="form-validate">
										...
										<house:xtdm id="prjCtrlType" dictCode="PRJCTRLTYPE" value="1" ></house:xtdm>
									</li>
									<li class="form-validate">
									...
									<li class="form-validate">
										<label>是否计算管理费</label> 
										<house:xtdm id="isCalMangeFee" dictCode="YESNO" value="1"></house:xtdm>
									</li>
									<li class="form-validate">
										<label>客户类型</label> 
									...
									<li>
									    <label>客户类型组</label>
									    <house:dict id="custTypeGroupNo" dictCode=""
									...
									<li class="form-validate">
										...
										<house:xtdm id="allowPriceRise" dictCode="YESNO" value="1"></house:xtdm>
									</li>
									<li class="form-validate">
										<label><span class="required">*</span>套餐外项目</label> 
										<house:xtdm id="isOutSet" dictCode="YESNO" value="1" ></house:xtdm>
									</li>
									<li class="form-validate" >
										<label><span class="required">*</span>是否基础套餐包</label> 
										<house:xtdm id="isBaseItemSet" dictCode="YESNO" value="0" ></house:xtdm>
									</li>
