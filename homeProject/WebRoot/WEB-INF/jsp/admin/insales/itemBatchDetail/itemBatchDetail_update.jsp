...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/itemBatchDetail/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
					...
					<tbody>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${itemBatchDetail.expired}" onclick="checkExpired(this)" ${itemBatchDetail.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
