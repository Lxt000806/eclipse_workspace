			...
			<div class="panel-body">
			  <form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
					...
					<input type="hidden" name="jsonString" value="" />
								...
								<li>
									<label id="delivWay">配送方式</label>
									<house:xtdm  id="delivWay" dictCode="DELIVTYPE" style="width:160px;" value="${purchase.delivWay }"></house:xtdm>
								</li>
								<li>
								<label>项目经理</label>
								...
								<li hidden>
									<label>是否服务产品</label>
									<house:xtdm id="isService" dictCode="YESNO" value="${purchase.isService }" disabled="true"></house:xtdm>
								</li>
								<li hidden>
									<label>原采购单号</label>
...
$("#tabs").tabs();
	...
	if("${purchase.fromPage}"=="supplierCheck"){
		...
		if("${purchase.type}" == "R"){
			$("#oldPUNo").parent().removeAttr("hidden");
		}
