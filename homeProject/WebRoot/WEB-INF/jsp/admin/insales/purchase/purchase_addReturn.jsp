			...
			<div class="panel-body">			  <form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
					...
					<input type="hidden" id="projectCost"  name="projectCost" value="${purchaseDetail.projectCost }"/>
						<ul class="ul-form">
							...
							<li>
								<label><span class="required">*</span>采购数量</label>
...
$(function(){
	...
	$("#itcode").openComponent_item({callBack: getData,condition:{itemType1:'${purchaseDetail.itemtype1}',puno:'${purchaseDetail.puno}',readonly:"1",}});
