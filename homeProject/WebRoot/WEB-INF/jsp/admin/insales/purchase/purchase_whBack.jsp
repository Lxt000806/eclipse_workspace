...
<body>
				...
				<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame">
					...
					<ul class="ul-form">
						...
						<div class="validate-group row">
							...
							<li>
								<label><span class="required">*</span>退回日期</label>
	...
	$(function() {
		if("${purchase.itemType1}"){
			...
			$("#supplier").openComponent_supplier({callBack:getData,readonly:true});
		}
	...
	$(function(){
		...
		var gridOption = {
			...
			colModel : [
				...
				{name:"beflineamount", index:"beflineamount", width:80, label:"折扣前金额",  sortable : true,align :"left"},
				...
				{name:"projectcost",index:"projectcost",width:100, label:"项目经理结算单价", 	sortable:true,align:"left",hidden:true},
		...
		$("#add").on("click",function(){
			...
			Global.Dialog.showDialog("save",{
				  ...
				  postData:{itemtype1:item1,whcode:whcode,fromPage:"whBack"},
				  height: 680,
				  width:1000,
		...
		$("#fastAdd").on("click",function(){
			...
			Global.Dialog.showDialog("save",{
				...
				postData:{itemType1:item1,supplier:supplier,whcode:whcode,m_umState:"R"},
				height: 680,
				width:1000,
				returnFun:function(data){
					if(data){
		 	...
		 	if(ret){
				Global.Dialog.showDialog("AddView",{
					...
					postData:{itcode:ret.itcode,qtyCal:ret.qtycal,sqlCodeDescr:ret.sqlcodedescr,projectCost:ret.projectcost,
							...
							whCode:whcode,markup:ret.markup,fromPage:"whBack"},
					height:700,
					width:1000,
					returnFun:function(data){
			...
			if(y==0){
				art.dialog({
					...
					ok: function () {
						...
						Global.Form.submit("page_form","${ctx}/admin/purchase/doWHBackSave",param,function(ret){
							if(ret.rs==true){
								art.dialog({
									content:ret.msg,
									time:1000,
	...
	function getItemType1(){
		...
		$("#supplier").openComponent_supplier({callBack:getData,condition:{itemType1:itemtype1,readonly:"1"}});
