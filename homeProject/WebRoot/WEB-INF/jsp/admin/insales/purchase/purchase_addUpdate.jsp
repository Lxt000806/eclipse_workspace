  			...
  			<div class="panel panel-info" >  
				<div class="panel-body">
				  <form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
						...
						<input type="hidden" id="befLinePrice"  name="befLinePrice" value="${purchaseDetail.unitPrice /purchaseDetail.markup}"/>
						<ul class="ul-form">
							<li>
								<label>材料编号</label>
							...
							<li>
								...
								<input type="text" id="markup" name="markup" style="width:160px;"
									onblur="changeAmount()"  value="${purchaseDetail.markup}" />
							</li>
							<li>
								<label>折扣前总价</label>
								<input type="text" id="befLineAmount" name="befLineAmount" style="width:160px;"
									value="${purchaseDetail.amount / purchaseDetail.markup}" readonly="true"/>
							</li>
							<li>
								<label>总价</label>
