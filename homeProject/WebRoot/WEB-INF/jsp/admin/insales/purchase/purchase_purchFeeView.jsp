			  		...
			  		<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
						...
						<ul class="ul-form">
							<div class="validate-group row" >	
								...
								<li>
									<label>发票状态</label>
									<house:xtdm id="billStatus" dictCode="BILLSTATUS" value="${purchaseFee.billStatus }" disabled="true"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row" >	
								<li>
								...
								<li>
									<label>柜号</label>
									<input type="text" id="whcode" name="whcode" style="width:160px;" value="${purchaseFee.whcode }" readonly="true"/>                                             
								</li>
							</div>
							<div class="validate-group row" >	
								<li>
