...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable_material",{
		url:"${ctx}/admin/itemPreApp/goItemPreAppPhotoListJqGrid",
		postData:{
			no:$("#no_materialPhoto").val()
		},
		height:300,
		width:250,
		styleUI:"Bootstrap",
		rowNum:10000,
		colModel:[
			{name: "itemtype1descr", index: "itemtype1descr", width: 100, label: "材料类型", sortable: true, align: "center"},
...
function getPhotoPath(photoName, from){
	...
	$.ajax({
		url:"${ctx}/admin/itemPreApp/getItemPreAppPhoto?photoName="+photoName,
		type:"post",
		dataType:"json",
		cache:false,
		error:function(obj){
		...
		success:function(obj){
			...
			$("#bigPicture").attr("src", obj.photoPath).css({
				"margin-top":0,
				"margin-left":0
			});
		}
...
function refresh(){
	$("#dataTable_material").jqGrid("setGridParam",{
		url:"${ctx}/admin/itemPreApp/goItemPreAppPhotoListJqGrid",
		postData:{
			no:$("#no_materialPhoto").val()
		},
