	...
	<head>
		...
		<script type="text/javascript">
			...
			function save(){
				...
				datas += "&status="+$("#status").val().trim();
				
			 	$.ajax({
					url:"${ctx}/admin/itemPreApp/doSave_preMeasure",
					type: "post",
					data:datas,
					dataType: "json",
					cache: false,
				...
				<div class="panel-body">
					<form action="" method="post" id="dataForm" enctype="multipart/form-data" class="form-search">
						<ul class="ul-form">		
							...
							<li>
								<label>状态</label>
								<house:xtdm id="status" dictCode="MEASURESTATUS" value="${itemPreMeasure.status }" unShowValue="${itemPreMeasure.unShowStatus }"></house:xtdm>
							</li>
