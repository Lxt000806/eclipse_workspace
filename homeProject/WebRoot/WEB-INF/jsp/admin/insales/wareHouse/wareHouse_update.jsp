                ...
                <div class="panel panel-info">
                    <div class="panel-body">
                        <form action="" method="post" id="dataForm" class="form-search">
                            <input type="text" id="lastUpdatedBy" name="lastUpdatedBy" hidden="true" value="${wareHouse.lastUpdatedBy}"/>
                            <input type="text" id="expired" name="expired" hidden="true" value="${wareHouse.expired}"/>
                            <ul class="ul-form">
                                <li class="form-validate">
                                    <label style="width:120px">仓库编号</label>
                                    <input type="text" id="code" name="code" value="${wareHouse.code}" readonly/>
                                </li>
                                <li class="form-validate">
                                ...
                                <li>
                                    ...
                                    <input type="text" id="address" name="address" style="width: 470px" value="${wareHouse.address}"/>
                                </li>
                                <li class="form-validate">
                                ...
                                <li>
                                    ...
                                    <house:xtdm id="isSupplOrder" dictCode="YESNO" value="${wareHouse.isSupplOrder}"></house:xtdm>
                                </li>
                                <li>
                                    <label style="width:120px">限定配送品类</label>
                                    <house:xtdm id="limitItemType2" dictCode="YESNO" value="${wareHouse.limitItemType2}" onchange="toggleTab(this)"></house:xtdm>
                                </li>
                                <li>
                                    <label style="width:120px">限定配送区域</label>
                                    <house:xtdm id="limitRegion" dictCode="YESNO" value="${wareHouse.limitRegion}" onchange="toggleTab(this)"></house:xtdm>
                                </li>
                                <li class="form-validate">
...
<script>
    ...
    function save() {
        ...
        $.ajax({
            url: "${ctx}/admin/wareHouse/doUpdate",
            type: "get",
            data: datas,
            dataType: "json",
            cache: false,
