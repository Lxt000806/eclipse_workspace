                ...
                <ul class="ul-form">
                    <div class="validate-group row">
                        <li class="form-validate">
                            <label><span class="required">*</span>区域</label>
                            <house:dict id="regioncode" dictCode="" value="${map.regioncode}"
                                sql="select Code SQL_VALUE_KEY, Descr SQL_LABEL_KEY from tRegion where Expired = 'F'"></house:dict>
                        </li>
                        <li>
                            <label>过期</label>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        var regiondescr = $("#regioncode").get()[0].selectedOptions[0].innerText
        data.regiondescr = regiondescr
