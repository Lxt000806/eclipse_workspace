...
<head>
	...
	function save() {
	   ...
	   if($("#itemType1").val() == 'JZ'){
	   		if($("#workType").val() == null || $("#workType").val()== undefined || $("#workType").val() == ''){
				art.dialog({
					content : "请选择工种分类1",
					width : 200,				
				});
			...
			if($("#materWorkType2").val() == null || $("#materWorkType2").val()== undefined || $("#materWorkType2").val() == ''){
				art.dialog({
					content : "请选择工种分类2",
					width : 200,				
				});
		...
		if($("#itemType1").val() == 'RZ' || $("#itemType1").val() =='JC' || $("#itemType1").val()== 'ZC' ){
	   		if($("#itemType12").val() == null || $("#itemType12").val()== undefined || $("#itemType12").val() == ''){
				art.dialog({
					content : "请选择材料分类!",
					width : 200,				
				});
				...
				<form action="" method="post" id="dataForm" class="form-search">
					<ul class="ul-form">					  
						...
						<li>
							...
							<input type="text" id="dispSeq" name="dispSeq" value="1000"/>
						</li>
						<li>
						...
						<li>
							...
							<house:xtdm id="orderType" dictCode="ORDERTYPE" value="1"></house:xtdm>				
						</li> 
					</ul>		
				</form>
			</div>
