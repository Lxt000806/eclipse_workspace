					...
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							<div class="validate-group row">					  
								...
								<li class="form-validate" >	
									<label>基装类型1名称</label>
									<input type="text" id="descr" name="descr" value="${baseItemType1.descr}" readonly="readonly"/>
								</li>
								<li class="form-validate" >	
									<label>显示顺序</label>
									<input type="text" id="dispSeq" name="dispSeq" value="${baseItemType1.dispSeq}" readonly="readonly"/>
								</li>
							</div>
