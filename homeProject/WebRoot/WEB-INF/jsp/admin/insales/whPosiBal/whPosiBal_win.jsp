				...
				<form action="" method="post" id="page_form" class="form-search">
					...
					<ul class="ul-form">
						...
						<div class="row">
							<li>
								<label>已上架数量</label>
								<input type="text" id="qtyCal" name="qtyCal" style="width:160px;" value="${whPosiBal.qtycal}" readonly="readonly" />
							</li>
						</div>
						<div class="row">
							<li>
								<label>未上架数量</label>
								<input type="text" id="qtyNo" name="qtyNo" style="width:160px;" value="${whPosiBal.qtyno}" readonly="readonly" />
							</li>
						</div>
						<div class="row">
							<li class="form-validate">
...
function doSave(){
	...
	datas.m_umState = "${wareHouse.m_umState}";
	    ...
	    success: function(obj){
	    	if(obj.rs){
				...
				$("#page_form").data("bootstrapValidator")  
					...
					.updateStatus("openComponent_item_itCode", "NOT_VALIDATED", null)
					.updateStatus("openComponent_wareHousePosi_pk", "NOT_VALIDATED", null)
					.updateStatus("qtyAdd", "NOT_VALIDATED", null);
				$("#_form_token_uniq_id").val(obj.token.token);
	    	}else{
	    		$("#_form_token_uniq_id").val(obj.token.token);
	    		art.dialog({
