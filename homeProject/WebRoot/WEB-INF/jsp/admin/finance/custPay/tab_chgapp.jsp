...
$(function(){
	...
	/**初始化表格*/
	var gridOption ={
			url:"${ctx}/admin/custPay/goChgAppJqGrid",
			...
			onSortCol:function(index, iCol, sortorder){
					var rows = $("#chgAppDataTable").jqGrid("getRowData");
		   			...
		   			Global.JqGrid.clearJqGrid("chgAppDataTable"); 
		   			$.each(rows,function(k,v){
						Global.JqGrid.addRowData("chgAppDataTable", v);
					});
				}, 
			gridComplete:function(){
				var records = $("#chgAppDataTable").jqGrid('getGridParam', 'records'); //获取数据总条数
				$("#appCount").text(records);
			}
 		};
       //初始化集成进度明细
	   Global.JqGrid.initJqGrid("chgAppDataTable",gridOption);
});
</script>
<div class="body-box-list" style="margin-top: 0px;">
    ...
    <div class="panel-body" >
			...
			<!--query-form-->
				<div id="content-list" >
					<table id="chgAppDataTable"></table>
				</div>
		</div>
