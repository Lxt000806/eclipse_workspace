					...
					<ul class="ul-form">
						<div class="row">
							...
							<li class="form-validate">
								...
								<input type="text" id="invoiceNo" name="invoiceNo" style="width:160px;" value="${custTax.invoiceNo}"/>
							</li>
						</div>
						<div class="row">
							<li class="form-validate">
								<label>发票代码</label>
								<input type="text" id="invoiceCode" name="invoiceCode" style="width:160px;" value="${custTax.invoiceCode}"/>
							</li>
							...
							</select> <input id="taxService" name="taxService" type="text" value="${custTax.taxService}">
							</li>
						</div>
						<div class="row">
							<li class="form-validate">
								<label>购买方</label>
								<input type="text" id="buyer" name="buyer" style="width:160px;" value="${custTax.buyer}"/>
							</li>
							<li class="form-validate">
						...
						<div class="row">
							<li><label>税率</label> <select style="width:160px;" id="selectTaxPer"
								...
								value="${custTax.taxPer}">
							</li>
							<li>
								<label>不含税金额</label>
								<input type="text" id="noTaxAmount" name="noTaxAmount" style="width:160px;"
									onkeyup="this.value =this.value.replace(/\s/g,'').replace(/[^\.\d]/g,'');" value="${custTax.noTaxAmount}" readonly="readonly"/>
							</li>
						</div>
						<div class="row">
							<li>
								...
								<input type="text" id="taxAmount" name="taxAmount" style="width:160px;"
									onkeyup="this.value =this.value.replace(/\s/g,'').replace(/[^\.\d]/g,'');" value="${custTax.taxAmount}" readonly="readonly"/>
							</li>
						</div>
						<div class="row">
							<li>
								<label class="control-textarea" for="remarks">备注</label>
								<textarea id="remarks" name="remarks" style="overflow-y:scroll; overflow-x:hidden; height:75px; ">${custTax.remarks}</textarea>
							</li>
						</div>
					</ul>
				</form>
