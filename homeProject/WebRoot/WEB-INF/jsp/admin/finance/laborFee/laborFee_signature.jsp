...
<title>人工费用管理——出纳签字</title>
	...
	$(function(){
		...
		$("#payCZY").openComponent_employee({showValue:"${laborFee.payCZY}",showLabel:"${payDescr}",readonly:true });
	...
	$(function(){
		...
		var gridOption = {
			...
			colModel : [
				...
				{name: "autoazf", index: "autoazf", width:85, label: "安装费(自动生成)", sortable: true, align: "right" },
	...
	function signature(){
		...
		Global.Form.submit("dataForm","${ctx}/admin/laborFee/doSignature",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
   				...
   				<div class="panel-body">
      				<div class="btn-group-xs">
						<button type="button" class="btn btn-system" style="color:#777777; cursor:default">
 						...
 						<button type="button" class="btn btn-system" id="saveBtn" onclick="signature()">
 							<span>出纳签字</span>
 						</button>
	         		...
	         		<div class="panel-body">
	         			<form role="form" class="form-search" id="dataForm" action="" method="post" target="targetFrame">
							...
							<ul class="ul-form">
								...
								<li>
									<label>付款日期</label>
									<input type="text" style="width:160px;" id="payDate" name="payDate" class="i-date" value="<fmt:formatDate value='${laborFee.payDate}' pattern='yyyy-MM-dd'/>" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
								</li>
								<li>
									<label>审核人</label>
