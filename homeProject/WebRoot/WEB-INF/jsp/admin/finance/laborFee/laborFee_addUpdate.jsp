...
<script type="text/javascript"> 
	...
	$(function() {
		var custCode="1";
		$("#appSendNo").openComponent_itemSendNo({condition:{custCode:custCode,itemType1:$.trim("${laborFee.itemType1}")}});	 
		...
		$("#custCode").openComponent_customer({callBack:getCustomer});	
...
$(function(){
	var custCode="1";
	console.log("${AftCustCode}".indexOf("${laborFee.custCode}".trim()));
	...
	$("#custCode").openComponent_customer({callBack:getCustomer,showValue:"${laborFee.custCode}"});	
	...
	$("#appSendNo").openComponent_itemSendNo({showValue:"${laborFee.appSendNo }",callBack:getIaNo,condition:{custCode:"${laborFee.custCode}",itemType1:$.trim("${laborFee.itemType1}")}});	 
					...
					art.dialog({
						content:"送货单为套餐内材料的项目经理已领、未领状态,是否保存!",
					 	...
					 	ok: function () {
							...
							var actNameReal = $.trim($("#openComponent_workCard_actName").val());
		...
		<div class="panel panel-info" >  
			<div class="panel-body">
				<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" id="isSetItem" name="isSetItem" value="${laborFee.isSetItem}" />
						...
						<input type="hidden" name="projectMan" id="projectMan" value="${laborFee.projectMan}"/>
       					<input type="hidden" name="projectManDescr" id="projectManDescr" value="${laborFee.projectManDescr}"/>
       					<input type="hidden" name="regionDescr" id="regionDescr" value="${laborFee.regionDescr}"/>
       					<input type="hidden" name="refCustAddress" id="refCustAddress" value="${laborFee.refCustAddress}"/>
						<ul class="ul-form">
							...
							<li class="form-validate">
								...
								sqlLableKey="descr" sqlValueKey="code"  value="${laborFee.feeType }" >
								</house:dict>                 
							</li>
							<li class="form-validate">
							...
							<li class="form-validate">
								<label>本单已报销</label>
								<input type="text" id="haveAmount" name="haveAmount" style="width:160px;" value="${laborFee.sendNoHaveAmount }" readonly="true"/>
							</li>
							<li class="form-validate">
								<label>已报销金额</label>
								<input type="text" id="sendNoHaveAmount" name="sendNoHaveAmount" style="width:160px;" value="${laborFee.haveAmount }" readonly="true"/>
							</li>
							<li class="form-validate">
