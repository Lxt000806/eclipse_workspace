...
<title>人工费用管理-反审核</title>
	...
	$(function(){
		...
		$("#actName").openComponent_workCard({callBack:getData,showValue:"${laborFee.actName}",showLabel:"${appCZY.nameChi}",readonly:true});
	...
	function reCheck(){
		...
		Global.Form.submit("dataForm","${ctx}/admin/laborFee/doReCancel",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
   				...
   				<div class="panel-body">
      				<div class="btn-group-xs">
						<button type="button" class="btn btn-system" style="color:#777777; cursor:default" >
 						...
 						<button type="button" class="btn btn-system" id="reCheck" onclick="reCheck()">
 							<span>反审核</span>
 						</button>	
