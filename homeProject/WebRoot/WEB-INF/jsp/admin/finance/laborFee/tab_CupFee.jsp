...
<html>
	...
	<script type="text/javascript">
		var cupInsCalTyp = "${cupInsCalTyp}";
		/**初始化表格*/
		$(function(){
			Global.JqGrid.initJqGrid("cupFeeDataTable",{
				url:"${ctx}/admin/laborFee/getCupFeeJqGrid",
				postData:{
				...
				colModel : [
					...
					{name: "cupdownhigh", index: "cupdownhigh", width: 100, label: "橱柜吊顶延米", sortable: true, align: "right",hidden:cupInsCalTyp=="2"?true:false},
					{name: "cupuphigh", index: "cupuphigh", width: 100, label: "橱柜地柜延米", sortable: true, align: "right",hidden:cupInsCalTyp=="2"?true:false},
	...
	<body>
		<div class="body-box-list">
			<div>
				<table id="cupFeeDataTable"></table>
			</div>
		</div>
	</body>
</html>
