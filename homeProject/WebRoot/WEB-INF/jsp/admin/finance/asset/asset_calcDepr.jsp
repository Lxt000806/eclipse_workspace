...
<head>
	...
	function goPeriod(){
		Global.Dialog.showDialog("goPeriod",{
			title:"选择周期",
			url:"${ctx}/admin/asset/goPeriod",
			postData:{},
			height:250,
			width:550,
			returnFun:function(data){
				$.ajax({
					url:"${ctx}/admin/asset/doCalcDepr",
					type: "post",
					data: {period:data},
					dataType: "json",
					cache: false,
		...
		<div class="panel panel-system">
		    <div class="panel-body">
		      	<div class="btn-group-xs">
					<button type="button" class="btn btn-system" id="doCount" onclick="goPeriod()">
						<span>计提折旧</span>
					</button>
				...
				<ul class="ul-form">
					...
					<li>
						...
						<input type="text" id="periodTo" name="periodTo" class="i-date" 
							style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM'})"
							value="<fmt:formatDate value='${asset.dateTo }' pattern='yyyyMM'/>"/>
					</li>
					<li>
						<label>部门</label>
