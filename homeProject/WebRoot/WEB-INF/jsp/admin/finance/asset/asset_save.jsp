...
$(function() {
	function checkValidator(){
		...
		$("#dataForm").data("bootstrapValidator")
	       .updateStatus("openComponent_assetType_assetType", "NOT_VALIDATED",null)  
	       .validateField("openComponent_assetType_assetType"); 
	}
	
	$("#department").openComponent_department({callBack:checkValidator});	
	...
	function getAssetTypeDate(data){
		...
		$("#deprType").val(data.deprtype);
		checkValidator();
	}
	$("#assetType").openComponent_assetType({callBack:getAssetTypeDate});
	$("#openComponent_assetType_assetType").attr("readonly",true);
			...
			<div class="panel panel-system" >
			    <div class="panel-body" >
			      <div class="btn-group-xs" >
						...
						<input type="checkbox"  id="quickAdd" name="quickAdd" 
							style = "margin-left:5px;margin-top:0px;zoom:130%"" onclick="chgQuickAdd()" value="0"/>连续新增
					</div>
				</div>
			</div>
			<div class="panel panel-info" >  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" name="remCode" id="remCode" value=""/>
						<ul class="ul-form">
							...
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>资产类别</label>
							...
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<house:xtdm id="addType" dictCode="ASSETADDTYPE"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
								...
								<li>
									<label>使用人</label>
									<input type="text" id="useMan" name="useMan"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>状态</label>
									<house:xtdm id="status" dictCode="ASSETSTATUS"></house:xtdm>
								</li>
								<li class="form-validate">
									<label>存放地点</label>
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" style="width:160px;" id="qty" name="qty"/>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>原值</label>
									<input type="text" style="width:160px;" id="originalValue" name="originalValue" onkeyup="getNetValue();getDeprAmountPerMonth()"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
								...
								<li class="form-validate">
									...
									<input type="text" id="totalDeprAmount" name="totalDeprAmount" style="width:160px;" onkeyup="getNetValue()"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>使用年限</label>
									<input type="text" id="useYear" name="useYear" style="width:160px;" onkeyup="getRemainDeprMonth();getDeprAmountPerMonth()"/>
								</li>
								<li class="form-validate">
									<label>折旧方法</label>
									<house:xtdm id="deprType" dictCode="ASSETDEPRTYPE" onchange="chgDeprType()"></house:xtdm>
								</li>
							</div>
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" id="deprMonth" name="deprMonth" style="width:160px;" onkeyup="getRemainDeprMonth()"/>
								</li>
								<li class="form-validate">
									<label>剩余月份</label>
									<input type="text" id="remainDeprMonth" name="remainDeprMonth" style="width:160px;" placeholder="自动计算" readonly="true"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label>净值</label>
									<input type="text" id="netValue" name="netValue" style="width:160px;" placeholder="自动计算" readonly="true"/>
								</li>
								<li class="form-validate">
									<label>月折旧额</label>
									<input type="text" id="deprAmountPerMonth" name="deprAmountPerMonth" style="width:160px;" placeholder="自动计算" readonly="true"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
