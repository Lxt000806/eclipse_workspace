...
<head>
	...
	function calcCheckAmount(){
		$("#checkAmount").val(myRound(getData("contractFee")+getData("baseChg")+getData("manageChg")+getData("mainChg")+
						getData("servChg")+getData("intChg")-getData("chgDisc"),2));
	}
	//计算扣减金额
	...
	function calcData(){
		...
		if($.trim("${map.perfexpr }") != ""){
			...
			$("#checkPerf").val(myRound(eval(perfExpr),2));
					...
					<form role="form" class="form-search" id="dataForm" action="" method="post" target="targetFrame">
						...
						<ul class="ul-form">
							...
							<div class="validate-group row" >
								...
								<li>
									<label>服务性产品增减</label>
									<input type="text" id="servChg" name="servChg" style="width:160px;" value="${map.servchg }" />
								</li>
								<li>
									<label>优惠变更</label>
							...
							<div class="validate-group row" >
								...
								<li>
									<label>结算业绩</label>
									<input type="text" id="checkPerf" name="checkPerf" style="width:160px;" value="${map.checkperf }" readonly="true"/>
								</li>
							</div>
							<div class="validate-group row" >	
								<li>
							...
							<div class="validate-group row" >
								...
								<li>
									...
									<input type="text" id="sceneDesignerCheck" name="sceneDesignerCheck" style="width:160px;" value="${map.scenedesignercheck }" readonly="true"/>
								</li>
								<li>
									<label>非现场设计师结算额</label>
									<input type="text" id="noSceneDesignerCheck" name="noSceneDesignerCheck" style="width:160px;" value="${map.noscenedesignercheck }" readonly="true"/>
								</li>
							</div>
						</ul>
					</form>	
