...
<div class="body-box-list">
            ...
            <div class="validate-group row">
                ...
                <li class="form-validate"><label style="width:200px;"><span
                    ...
                    name="custDescr" value="输入客户编号自动生成" style="width:160px;" value="0" readonly="readonly"
                    required data-bv-notempty-message="客户名称不能为空" />
                </li>
            </div>
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                        class="required">*</span>楼盘地址</label> <input type="text" id="custAddress" name="custAddress" 
                        style="width:160px;" value="输入客户编号自动生成" readonly="readonly" />
                </li>
            </div>
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                        class="required">*</span>主材毛利率</label> <input type="text" id="mainProPer"
                    name="mainProPer" style="width:160px;" value="0.5"
            ...
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                    ...
                    name="servProper" style="width:160px;" value="0.13"
            ...
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                    ...
                    name="intProPer" style="width:160px;" value="0.28"
            ...
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                    ...
                    name="softProPer" style="width:160px;" value="0.55"
            ...
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                    ...
                    name="curtainProPer" style="width:160px;" value="0.55"
            ...
            <div class="validate-group row">
                <li class="form-validate"><label style="width:200px;"><span
                    ...
                    name="furnitureProPer" style="width:160px;" value="0.55"
