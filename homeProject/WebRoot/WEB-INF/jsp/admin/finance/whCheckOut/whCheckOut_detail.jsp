...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			...
			colModel : [
			  ...
			  {name: "wcono", index: "wcono", width: 90, label: "记账单号", sortable: true, align: "left"},
              {name: "statusdescr", index: "statusdescr", width: 70, label: "状态", sortable: true, align: "left"},
              {name: "date", index: "date", width: 80, label: "申请日期", sortable: true, align: "left", formatter: formatTime},
              {name: "confirmdate", index: "confirmdate", width: 80, label: "审核日期", sortable: true, align: "left", formatter: formatTime},
              {name: "checkdate", index: "checkdate", width: 80, label: "记账日期", sortable: true, align: "left", formatter: formatTime},
              {name: "whdescr", index: "whdescr", width: 106, label: "仓库", sortable: true, align: "left"},
              {name: "wcodocumentno", index: "wcodocumentno", width: 80, label: "凭证号", sortable: true, align: "left"},
              {name: "no", index: "no", width: 85, label: "发货单号", sortable: true, align: "left"},
              ...
              {name: "sumcost", index: "sumcost", width: 80, label: "总金额", sortable: true, align: "right", sum: true},
              {name: "sumprojectamount", index: "sumprojectamount", width: 130, label: "项目经理结算总价", sortable: true, align: "right", sum: true},
              {name: "custdocumentno", index: "custdocumentno", width: 80, label: "档案号", sortable: true, align: "left"},
              ...
              {name: "expired", index: "expired", width: 70, label: "是否过期", sortable: true, align: "left", hidden: true},
           	  {name: "sendfee", index: "sendfee", width: 70, label: "配送费", sortable: true, align: "right"},
			  {name :"carryfee",index : "carryfee",width : 60,label:"搬运费", sortable: true, align: "right"},
			  {name: "whfee", index: "whfee", width: 70, label: "仓储费", sortable: true, align: "right"},
			  {name: "projectothercost", index: "projectothercost", width:95 , label: "项目经理调整", sortable: true, align: "right"},
