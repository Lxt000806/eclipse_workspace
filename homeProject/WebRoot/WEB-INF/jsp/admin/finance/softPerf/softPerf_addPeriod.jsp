...
<head>
	...
	$(function(){
		$("#saveBtn").on("click",function(){
			...
			$.ajax({
				url:"${ctx}/admin/softPerf/doSavePeriod",
				type: "post",
				data: datas,
				dataType: "json",
				cache: false,
			...
			<div class="panel-body">
				<form action="" method="post" id="dataForm" class="form-search">
					...
					<ul class="ul-form">
						...
						<li class="form-validate">
							<label>月份</label>
							<input type="text" id="mon" name="mon" class="i-date" onchange="validateRefresh()" required data-bv-notempty-message="月份不能为空" 
								style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM'})"
								value="${salaryData.mon }"/>
						</li>
						<li>
