...
<head>
	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_businessMan",{
			
			postData:{no:"${softPerf.no}",countType:"${softPerf.countType}",businessMan:"${softPerf.designMan}"},
			...
			colModel : [
			  ...
			  {name : "perfamount",index : "perfamount",width : 90,label:"销售额",sortable : true,align : "right", sum: true},
...
// 		$('#dataTable_businessManPager_left').attr('width',90);
//         $('#dataTable_businessManPager_center').attr('width','900px');
//         $('#dataTable_businessManPager_right').attr('align','left');
        $("#dataTable_businessManPager").css("width", "1088px");
	});
	</script>
</head>
	<body>
		<div class="body-box-list">
			<div id="content-list">
				<table id= "dataTable_businessMan"></table>
				<div id="dataTable_businessManPager"></div>
			</div>
		</div>
	</body>	
</html>
