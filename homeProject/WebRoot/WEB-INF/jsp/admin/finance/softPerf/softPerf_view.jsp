	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			...
			colModel : [
			  ...
			  {name : "allcost",index : "allcost",width : 60,label:"成本额",sortable : true,align : "right",sum:true},
			  ...
			  {name : "per",index : "per",width : 60,label:"发放比例",sortable : true,align : "right"},
			  {name : "profitper",index : "profitper",width : 60,label:"毛利率",sortable : true,align : "right"},
			  {name : "businessman",index : "businessman",width : 75,label:"业务员",sortable : true,align : "left"},
			  {name : "businessdept2",index : "businessdept2",width : 75,label:"业务员",sortable : true,align : "left"},
			  ...
			  {name : "buyerman",index : "buyerman",width : 75,label:"买手",sortable : true,align : "left"},
			  {name : "buyerdept2descr",index : "buyerdept2descr",width : 75,label:"买手部门",sortable : true,align : "left"},
			  {name : "designmancommiper",index : "designmancommiper",width : 75,label:"设计师抽成点数",sortable : true,align : "right"},
			  {name : "designper",index : "designper",width : 75,label:"设计师提成",sortable : true,align : "right",sum:true},
			  {name : "buyercommiper",index : "buyercommiper",width : 75,label:"买手抽成点数",sortable : true,align : "right"},
			  {name : "buyerper",index : "buyerper",width : 60,label:"买手提成",sortable : true,align : "right",sum:true},
			  {name : "isclearinvdescr",index : "isclearinvdescr",width : 60,label:"是否清库存",sortable : true,align : "right",sum:true},
