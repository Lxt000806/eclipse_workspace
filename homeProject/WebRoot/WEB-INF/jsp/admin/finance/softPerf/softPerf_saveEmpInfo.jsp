...
<head>
	...
	$(function() {
		$("#empCode").openComponent_employee({callBack:fillData});
	...
	$(function(){
		$("#saveBtn").on("click",function(){
			...
			$.ajax({
				url:"${ctx}/admin/softPerf/doSaveEmpInfo",
				type: "post",
				data: datas,
				dataType: "json",
				cache: false,
					...
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							...
							<li class="form-validate">
								...
								<input type="text" id="beginDate" name="beginDate" onchange="validateRefresh()" required data-bv-notempty-message="业绩归属开始时间不能为空" class="i-date" style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
							</li>
							<li class="form-validate">
								<label>业绩归属结束时间</label>
								<input type="text" id="endDate" name="endDate" onchange="validateRefresh()" required data-bv-notempty-message="业绩归属结束时间不能为空" class="i-date" style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
							</li>
						</ul>
					</form>
				</div>
