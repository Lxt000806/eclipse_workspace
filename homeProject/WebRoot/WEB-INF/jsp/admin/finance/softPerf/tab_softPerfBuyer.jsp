...
<head>
	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_buyer",{
			
			postData:{no:"${softPerf.no}",countType:"${softPerf.countType}",buyer:"${softPerf.designMan}"},
			...
			colModel : [
			  ...
			  {name : "buyerper",index : "buyerper",width : 70,label:"买手提成",sortable : true,align : "right", sum: true},
			  {name : "buyer2commiper",index : "buyer2commiper",width : 90,label:"买手2抽成点数",sortable : true,align : "right"},
			  {name : "buyer2per",index : "buyer2per",width : 70,label:"买手2提成",sortable : true,align : "right", sum: true},
			  {name : "designmancommiper",index : "designmancommiper",width : 90,label:"设计师抽成点数",sortable : true,align : "right"},
			  {name : "designper",index : "designper",width : 90,label:"设计师提成",sortable : true,align : "right"},
			  ...
			  {name : "per",index : "per",width : 70,label:"发放比例",sortable : true,align : "right"},
			  {name : "iano",index : "iano",width : 70,label:"领料编号",sortable : true,align : "left"},
			  ...
			  {name : "item12descr",index : "item12descr",width : 70,label:"材料分类",sortable : true,align : "left"},
			  {name : "item2descr",index : "item2descr",width : 70,label:"材料类型2",sortable : true,align : "left"},
			  {name : "checkoutdate",index : "checkoutdate",width : 70,label:"客户结算日期",sortable : true,align : "left",formatter:formatDate},
			  {name : "confirmdate",index : "confirmdate",width : 70,label:"领料审核日期",sortable : true,align : "left",formatter:formatDate},
			  {name : "businessman",index : "businessman",width : 70,label:"业务员",sortable : true,align : "left"},
			  {name : "designman",index : "designman",width : 70,label:"设计师",sortable : true,align : "left"},
			  {name : "designdept2descr",index : "designdept2descr",width : 70,label:"设计师部门",sortable : true,align : "left"},
			  ...
			  {name : "lastupdate",index : "lastupdate",width : 70,label:"最后更新时间",sortable : true,align : "left",formatter:formatDate},
			  {name : "lastupdatedby",index : "lastupdatedby",width : 70,label:"最后更新人",sortable : true,align : "left"},
...
// 			$('#dataTable_buyerPager_left').attr('width',90);
// 	        $('#dataTable_buyerPager_center').attr('width','900px');
// 	        $('#dataTable_buyerPager_right').attr('align','left');
		$("#dataTable_buyerPager").css("width", "1088px");
	});
	</script>
</head>
	<body>
		<div class="body-box-list">
			<div id="content-list">
				<table id= "dataTable_buyer"></table>
				<div id="dataTable_buyerPager"></div>
			</div>
		</div>
	</body>	
</html>
