	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			...
			colModel : [
					...
					{name: "spldescr", index: "spldescr", width: 80, label: "供应商", sortable: false, align: "left"},
					...
					{name: "amount", index: "amount", width: 80, label: "本次付款", sortable: false, align: "left", sum: true},
		...
		Global.JqGrid.initJqGrid("dataTable_dj",{
			...
			colModel : [
					...
					{name: "supplier", index: "supplier", width: 142, label: "供应商", sortable: false, align: "left",hidden: true},
					{name: "puno", index: "puno", width: 125, label: "采购单号", sortable: false, align: "left"},
					{name: "statusdescr", index: "statusdescr", width: 70, label: "状态", sortable: false, align: "left"},
					{name: "status", index: "status", width: 70, label: "状态", sortable: false, align: "left",hidden:true},
					{name: "sumamount", index: "sumamount", width: 80, label: "总金额", sortable: false, align: "left"},
					{name: "remainamount", index: "remainamount", width: 110, label: "应付余额", sortable: false, align: "left"},
					{name: "amount", index: "amount", width: 110, label: "本次付款", sortable: false, align: "left", sum: true},
					{name: "firstamount", index: "firstamount", width: 110, label: "已付定金", sortable: false, align: "left"},
...
<div class="body-box-form" >
    ...
    <div class="panel-body" >
      <div class="btn-group-xs" >
       	<button type="button" id="mark" class="btn btn-system" >出纳签字</button>
         ...
         <div class="panel-body">
             <form role="form" class="form-search" id="page_form" action="" method="post" target="targetFrame">
				...
				<ul class="ul-form">
					...
					<li>	
						<label>付款日期</label>
						<input type="text"  id="payDate" name="payDate" class="i-date" value="<fmt:formatDate value='${supplierPrepay.payDate}' pattern='yyyy-MM-dd'/>" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})" />
					</li>
					<li>	
						<label>付款人</label>
					...
					<li hidden="true">
						<input type="text" id="m_umState" name="m_umState" value="W" disabled="true"/> 
					</li>					
				</ul>
			</form>
		</div>
