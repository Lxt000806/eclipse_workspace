...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable",{
		url:"${ctx}/admin/payManage/goProcListJqGrid",
		postData:{no:"${supplierPrepay.no }"},
		height:250,
		rowNum:10000000,
		colModel : [
			{name : 'wfprocinstno',index : 'wfprocinstno',width : 150,label:'wfprocinstno',sortable : true,align : "left", hidden: true},
		  	...
		  	{name : 'itemtype1',index : 'itemtype1',width : 130,label:'材料类型1',sortable : true,align : "left",},
		  	{name : 'type',index : 'type',width : 130,label:'预支类型',sortable : true,align : "left",},
		  	{name : 'advanceamount',index : 'advanceamount',width : 70,label:'预支总额',sortable : true,align : "left",},
		  	{name : 'advanceremarks',index : 'advanceremarks',width : 200,label:'预付内容',sortable : true,align : "left",},
		...
		onSelectRow : function(id) {
        	...
        	var elMaps = {AdvanceAmount: $.trim(row.advanceamount),
           	...
           	$("#dataTable_detail").jqGrid('setGridParam',{url : "${ctx}/admin/laborFee/goProcTrackJqGrid",postData: {
           		wfProcInstNo: row.wfprocinstno,
           		actProcDefId: row.actprocdefid,
           		el: JSON.stringify(elMaps)
           	}});
