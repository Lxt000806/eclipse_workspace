...
$(function(){
	/**初始化表格*/
	var gridOption ={
			url:"${ctx}/admin/perfCycle/goCyyjjsJqGrid",
			...
			colModel : [
				...
				{name: "achievedate", index: "achievedate", width: 90, label: "业绩达标日期", sortable: true, align: "left", formatter: formatDate},
       ...
       //初始化发货明细
	   Global.JqGrid.initJqGrid("cyyjjsDataTable",gridOption);
});


</script>
<div class="body-box-list" style="margin-top: 0px;">
	<form role="form" class="form-search" id="page_form1" action=""
		...
		<ul class="ul-form">
			...
			<li>
				<button type="button" class="btn btn-sm btn-system"
					onclick="doQuery('page_form1');">查询</button>
				<button type="button" class="btn btn-sm btn-system"
					onclick="clearForm('page_form1');">清空</button>
			</li>
		</ul>
	</form>
	...
	<!--query-form-->
	<div id="content-list">
		<table id="cyyjjsDataTable"></table>
	</div>
</div>
