...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable",{
		...
		postData:{custCode:"${perfCycle.custCode}"},
		styleUI: "Bootstrap", 
		colModel : [
			...
			{name: "iscalcdiscctrl", index: "iscalcdiscctrl", width: 90, label: "计入优惠额度控制", sortable: true, align: "left",hidden:true},
			{name: "isctrldescr", index: "isctrldescr", width: 90, label: "计入优惠额度控制", sortable: true, align: "left"},
		...
		<div class="panel-body">
			<div class="query-form">
				<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
					...
					<input type="hidden" name="custCode" id="custCode" value="${perfCycle.custCode }"/>
