...
$(function(){
	...
	var gridOption ={
			...
			colModel : [
				...
				{name: "sumcontractfee", index: "sumcontractfee", width: 135, label: "合额+设计费+税金", sortable: true, align: "right",sorttype:"number", sum: true},
				{name: "contractfee", index: "contractfee", width: 115, label: "合同费+税金", sortable: true, align: "right",sorttype:"number", sum: true},
				{name: "designfee", index: "designfee", width: 115, label: "设计费", sortable: true, align: "right",sorttype:"number", sum: true},
			], 
			loadonce:true
 		};
	   Global.JqGrid.initJqGrid("sjtdDataTable",gridOption);
});
</script>
