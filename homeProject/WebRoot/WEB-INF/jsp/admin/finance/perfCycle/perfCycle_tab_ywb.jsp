...
$(function(){
	...
	var gridOption ={
			...
			colModel : [
				...
				{name: "sumrecalperf", index: "sumrecalperf", width: 107, label: "业绩", sortable: true, align: "right",sorttype:"number",sorttype:"number", sum: true},
				...
				{name: "laderdescr", index: "laderdescr", width: 91, label: "部门领导", sortable: true, align: "left"},
				{name: "posichgdate", index: "posichgdate", width: 112, label: "任命时间", sortable: true, align: "left", formatter: formatDate}
			], 
			loadonce:true
 		};
	   Global.JqGrid.initJqGrid("ywbDataTable",gridOption);
});
</script>
