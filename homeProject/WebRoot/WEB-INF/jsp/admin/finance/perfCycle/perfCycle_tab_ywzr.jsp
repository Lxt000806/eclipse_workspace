...
$(function(){
	...
	var gridOption ={
			...
			searchBtn:true,
			colModel : [
				{name: "busidrcdescr", index: "busidrcdescr", width: 91, label: "业务主任", sortable: true, align: "left"},
	   ...
	   Global.JqGrid.initJqGrid("ywzrDataTable",gridOption);
});
</script>
