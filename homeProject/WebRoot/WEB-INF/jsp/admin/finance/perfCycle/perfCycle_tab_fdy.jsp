...
$(function(){
	...
	var gridOption ={
			...
			searchBtn:true,
			colModel : [
				{name: "namechi", index: "namechi", width: 93, label: "翻单员", sortable: true, align: "left"},
				...
				{name: "againqty", index: "againqty", width: 89, label: "单数", sortable: true, align: "right",sorttype:"number", sum: true}
			], 
			loadonce:true
 		};
	   Global.JqGrid.initJqGrid("fdyDataTable",gridOption);
});
</script>
