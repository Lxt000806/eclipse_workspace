...
$(function(){
	...
	independPerf_gridOption ={
			...
			colModel : [
				...
				{name: "achievedate", index: "achievedate", width: 88, label: "达标时间", sortable: true, align: "left", formatter: formatDate},
			...
			gridComplete:function(){
	            ...
	            frozenHeightReset("independPerfDataTable");
	        },   
 		};
...
<div class="body-box-list" style="margin-top: 0px;">
	...
	<!--query-form-->
	<div id="content-list">
		<table id="independPerfDataTable"></table>
	</div>
</div>
