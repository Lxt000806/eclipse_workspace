...
$(function(){
	...
	var gridOption ={
			...
			colModel : [
				...
				{name: "followperf", index: "followperf", width: 107, label: "跟单业绩", sortable: true, align: "right",sorttype:"number", sum: true},
				{name: "nofollowperf", index: "nofollowperf", width: 107, label: "非跟单业绩", sortable: true, align: "right",sorttype:"number", sum: true},
	   ...
	   Global.JqGrid.initJqGrid("ywyDataTable",gridOption);
});
</script>
