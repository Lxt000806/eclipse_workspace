...
$(function(){
	var gridOption = {
		...
		styleUI: "Bootstrap", 
		colModel : [
		{name: "custcode", index: "custcode", width: 87, label: "编号", sortable: true, align: "left",hidden:true},
		{name: "ischecked", index: "ischecked", width: 87, label: "是否结帐", sortable: true, align: "left",hidden:true},
		...
		{name: "provideremark", index: "provideremark", width: 100, label: "发放备注", sortable: true, align: "left",editable:true},
	...
	//主项目导出到excel
	$("#exclePrjProvide").on("click",function(){
	console.log("sssd");
		doExcelNow("主项目","dataTable","dataForm");	
	}); 
	//保存 
	$("#saveBtn").on("click",function(){
		...
		console.log(param);
		Global.Form.submit("dataForm","${ctx}/admin/prjProvide/doSave",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content: ret.msg,
					/* time: 1000, */
