  ...
  <body>
    ...
    <div class="panel-body" >
      <div class="btn-group-xs" >
						...
						<button type="button" class="btn btn-system " id="checkCancel">
  							<span>审核取消</span>
						</button>
...
$(function(){
	...
	$("#check").on("click",function(){
		...
		$.ajax({
			url:'${ctx}/admin/giftCheckOut/doCheck',
			type: 'post',
			data: datas,
			dataType: 'json',
			cache: false,
	...
	$("#checkCancel").on("click",function(){
		...
		Global.Form.submit("page_form","${ctx}/admin/giftCheckOut/doCheckCancel",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
