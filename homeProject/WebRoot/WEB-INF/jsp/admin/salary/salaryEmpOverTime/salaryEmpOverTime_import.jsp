...
$(document).ready(function() {  
	...
	$("#modelDataTable").addRowData(1, {"salaryemp":"00001","times":"2","remarks":"加班辛苦了"}, "last");
    return false;  
});
//加载文件验证
function check(){
...
function loadData(){
	if(check()){
        ...
        $.ajax({
             url: "${ctx}/admin/salaryEmpOverTime/loadExcel",
             type: "POST",
             data: formData,
             contentType: false,
             processData: false,
...
function importData(){
	...
	Global.Form.submit("page_form","${ctx}/admin/salaryEmpOverTime/doSaveBatch",param,function(ret){
		if(ret.rs==true){
			art.dialog({
				content:ret.msg,
				time:1000,
	...
	<div class="body-box-form">
		<div class="btn-panel pull-left">
			<div class="btn-group-sm">
				...
				<button type="button" class="btn btn-system " onclick="doExcelNow('加班信息导入模板','modelDataTable')" style="margin-right: 15px">下载模板</button>
					<label >薪酬月份</label>
