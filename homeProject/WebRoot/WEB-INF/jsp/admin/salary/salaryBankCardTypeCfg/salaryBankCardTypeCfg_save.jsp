...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/salaryBankCardTypeCfg/doSave",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
				...
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							...
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>薪酬方案类型</label>
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<house:xtdm  id="bankCardType" dictCode="SALBANKTYPE" style="width:160px;"></house:xtdm>
								</li>
							</div>
						</ul>
					</form>
