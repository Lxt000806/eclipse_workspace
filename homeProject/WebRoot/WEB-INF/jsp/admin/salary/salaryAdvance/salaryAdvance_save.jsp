...
$(function() {
	...
	$("#salaryEmp").openComponent_salaryEmp({callBack:getEmpData});	
...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/salaryAdvance/doSave",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
					...
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<li class="form-validate">
									<label>一级部门</label>
									<input type="text" id="dept1Descr" name="dept1Descr" style="width:160px;" readonly="true"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>预领金额</label>
