                ...
                <ul class="ul-form">
                    <div class="validate-group row">
                        <li class="form-validate">
                            ...
                            <input style="width:470px;" type="text" id="descr" name="descr"/>
                        </li>
                    </div>
                    <div>
                    ...
                    <div class="validate-group row">
                        <li class="form-validate">
                            ...
                            <input type="text" id="edmInsurBaseMin" name="edmInsurBaseMin" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>养老保险最高基数</label>
                            <input type="text" id="edmInsurBaseMax" name="edmInsurBaseMax" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>养老保险个人费率</label>
                            <input type="text" id="edmInsurIndRate" name="edmInsurIndRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>养老保险单位费率</label>
                            <input type="text" id="edmInsurCmpRate" name="edmInsurCmpRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>失业保险个人费率</label>
                            <input type="text" id="uneInsurIndRate" name="uneInsurIndRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>失业保险单位费率</label>
                            <input type="text" id="uneInsurCmpRate" name="uneInsurCmpRate" value="0.0"/>
                        </li>
                    </div>
                    <div>
                        <hr style="margin: 10px 0 20px 0">
                    ...
                    <div class="validate-group row">
                        <li class="form-validate">
                            ...
                            <input type="text" id="medInsurBaseMin" name="medInsurBaseMin" value="0.0" onkeyup="setBirthInsurBaseMin()"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>医保最高基数</label>
                            <input type="text" id="medInsurBaseMax" name="medInsurBaseMax" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>医保个人费率</label>
                            <input type="text" id="medInsurIndRate" name="medInsurIndRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>医保单位费率</label>
                            <input type="text" id="medInsurCmpRate" name="medInsurCmpRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>生育保险单位费率</label>
                            <input type="text" id="birthInsurCmpRate" name="birthInsurCmpRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>生育保险最低基数</label>
                            <input type="text" id="birthInsurBaseMin" name="birthInsurBaseMin" value="0.0"/>
                        </li>
                    </div>
                    <div>
                        <hr style="margin: 10px 0 20px 0">
                    ...
                    <div class="validate-group row">
                        <li class="form-validate">
                            ...
                            <input type="text" id="houFundBaseMin" name="houFundBaseMin" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>公积金最高基数</label>
                            <input type="text" id="houFundBaseMax" name="houFundBaseMax" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>公积金个人费率</label>
                            <input type="text" id="houFundIndRate" name="houFundIndRate" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>公积金单位费率</label>
                            <input type="text" id="houFundCmpRate" name="houFundCmpRate" value="0.0"/>
                        </li>
                    </div>
                    <div>
                        <hr style="margin: 10px 0 20px 0">
                    ...
                    <div class="validate-group row">
                        <li class="form-validate">
                            ...
                            <input type="text" id="injuryInsurBaseMin" name="injuryInsurBaseMin" value="0.0"/>
                        </li>
                        <li class="form-validate">
                            <label><span class="required">*</span>工伤保险费率</label>
                            <input type="text" id="injuryInsurRate" name="injuryInsurRate" value="0.0"/>
                        </li>
                    </div>
                    <div>
                        <hr style="margin: 10px 0 20px 0">
                    ...
                    <div class="validate-group row">
                        <li>
                            ...
                            <textarea type="text" id="remarks" name="remarks"></textarea>
                        </li>
                    </div>
                </ul>
            </form>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajax({
            url: "${ctx}/admin/socialInsurParam/doSave",
            type: "POST",
            data: data,
            dataType: "json",
            error: function(obj) {
    ...
    function setBirthInsurBaseMin(){
    	var medInsurBaseMin = $("#medInsurBaseMin").val();
    	$("#birthInsurBaseMin").val(medInsurBaseMin);
    }
