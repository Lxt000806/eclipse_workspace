            ...
            <form role="form" action="" method="post" id="page_form" class="form-search" target="targetFrame">
                <ul class="ul-form">
                    <div class="validate-group row">
                        <li>
                            <label>企业名称</label>
                            <input style="width:448px;" type="text" id="descr" name="descr"/>
                        </li>
                        <li class="form-validate">
                        	<label>
                        	<span class="required">*</span>银行</label> 
							<house:xtdm id="bankType" dictCode="SALBANKTYPE"></house:xtdm>
						</li>
						<li class="form-validate">
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajax({
            url: "${ctx}/admin/salarySettleCmp/doSave",
            type: "POST",
            data: data,
            dataType: "json",
            error: function(obj) {
