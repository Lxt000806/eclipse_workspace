...
function goFilterFormula(){
	...
	Global.Dialog.showDialog("FilterFormula",{
		title:"条件公式设置",
		postData:{filterFormulaShow:filterFormulaShow, filterFormula:filterFormula},
		url:"${ctx}/admin/salaryItem/goFilterFormula",
		height:480,
		width:920,
        resizable: true,
			...
			<div class="panel panel-info" >  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" id="filterFormula" name="filterFormula" value=""/>
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<li class="form-validate">
									<label>分账名称</label>
									<input type="text" id="descr" name="descr" style="width:160px;" value="${map.descr }" readonly="true"/>
								</li>
							</div>
							<div class="validate-group row">
								<li>
									...
									<house:dict id="payMode" dictCode="" 
										 ...
										 sqlValueKey="code" sqlLableKey="descr" value="${map.paymode }" disabled="true"></house:dict>
								</li>
								<li class="form-validate">
									<label>分账序号</label>
									<input type="text" id="seqNo" name="seqNo" style="width:160px;" value="${map.seqno }" readonly="true"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">分账说明</label>
									<textarea id="remarks" name="remarks" rows="3" readonly="true">${map.remarks }</textarea>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">条件公式</label>
									<textarea id="filterFormulaShow" name="filterFormulaShow" rows="3" readonly="true">${map.filterformulashow }</textarea>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									...
									<house:dict id="realPaySalaryItem" dictCode="" 
										 ...
										 sqlValueKey="code" sqlLableKey="descr" value="${map.realpaysalaryitem }" disabled="true"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">报表数据</label>
									<textarea id="salaryItemList" name="salaryItemList" rows="3" readonly="true">${map.salaryitemlist }</textarea>
								</li>
							</div>
						</ul>
					</form>
