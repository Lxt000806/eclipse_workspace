...
$(function() {
	...
	var gridOption = {	
		...
		colModel : [
			...
			{name:"salaryitem", index:"salaryitem", width:80, label:"项目编号", sortable:false ,align:"left",},
			...
			{name:"dispseq", index:"dispseq", width:80, label:"序号", sortable:false ,align:"right",},
			...
			{name:"rptdispseq", index:"rptdispseq", width:80, label:"工资单序号", sortable:false ,align:"right",editable:true},
		],
		...
		gridComplete:function(){
			...
			for(var i=1;i<=ids.length;i++){
				var isrptshow =	$.trim($("#dataTable").jqGrid("getCell",i,"isrptshow"));
				if(isrptshow == "" || isrptshow == "0"){
					$("#dataTable").jqGrid("setCell", i, "rptdispseq", "", "not-editable-cell");
				}
			}
						...
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" id="descr" name="descr" style="width:160px;" value="${salaryScheme.descr }"/>
								</li>
								<li class="form-validate">
									...
									<house:dict id="salarySchemeType" dictCode="" sql="select Code+' '+descr descr,code from tSalarySchemeType where expired = 'F'" 
												sqlValueKey="code" sqlLableKey="descr" value="${salaryScheme.salarySchemeType }"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" id="beginMon" name="beginMon" class="i-date" 
										...
										value="${salaryScheme.beginMon }"/>
								</li>
								<li>
									<label>结束时间</label>
									<input type="text" id="endMon" name="endMon" class="i-date" 
										style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM'})"
										value="${salaryScheme.endMon }"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									...
									<house:xtdm  id="status" dictCode="SALENABLESTAT" style="width:160px;"
										 value="${salaryScheme.status }"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">方案说明</label>
									<textarea id="remarks" name="remarks" rows="3">${salaryScheme.remarks }</textarea>
								</li>
							</div>
						</ul>
					</form>
