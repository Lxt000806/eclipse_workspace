						...
						<ul class="ul-form">
							...
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<input type="text" id="seqNo" name="seqNo" style="width:160px;" value="0"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<house:dict id="realPaySalaryItem" dictCode="" 
												...
												where a.SalaryScheme = '${salaryScheme.pk}' " 
										 sqlValueKey="code" sqlLableKey="descr"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									...
									<textarea id="salaryItemList" name="salaryItemList" rows="3"></textarea>
								</li>
							</div>
						</ul>
					</form>
