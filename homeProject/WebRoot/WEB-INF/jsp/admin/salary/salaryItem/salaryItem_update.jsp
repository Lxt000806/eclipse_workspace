...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/salaryItem/doUpdate",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
						...
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<input type="text" id="descr" name="descr" style="width:160px;" value="${salaryItem.descr }"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>系统保留项目</label>
									<house:xtdm  id="isSysRetention" dictCode="YESNO" style="width:160px;" value="${salaryItem.isSysRetention}"></house:xtdm>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>支持手动修改</label>
									<house:xtdm  id="isAdjustable" dictCode="YESNO" style="width:160px;" value="${salaryItem.isAdjustable}"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
								...
								<li class="form-validate">
									<label>薪酬项目分组</label>
									<house:xtdm  id="itemGroup" dictCode="SALITEMGROUP" style="width:160px;" value="${salaryItem.itemGroup}"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>状态</label>
									<house:xtdm  id="status" dictCode="SALENABLESTAT" style="width:160px;" value="${salaryItem.status}"></house:xtdm>
								</li>
								<li class="form-validate">
									...
									<house:dict id="precision" dictCode="" sql="select p.number code ,p.number descr from master..spt_values p 
												...
												sqlValueKey="code" sqlLableKey="descr" value="${salaryItem.precision }"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>统计属性</label>
									<house:xtdm  id="type" dictCode="SALITEMTYPE" style="width:160px;" value="${salaryItem.type }"></house:xtdm>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>加减项</label>
									<house:xtdm  id="plusMinus" dictCode="SALAPLUSMINUS" style="width:160px;" value="${salaryItem.plusMinus }"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">薪酬说明</label>
									<textarea id="remarks" name="remarks" rows="3">${salaryItem.remarks }</textarea>
								</li>
							</div>
						</ul>
					</form>
