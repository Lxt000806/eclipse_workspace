...
$(function() {
	...
	$("#filterFormula").openComponent_salaryEmp({callBack:validateRefresh,showValue:"${salaryItemStatCfg.filterFormula }",showLabel:"${salaryItemStatCfg.empName }"});
...
function doSave(){
	...
	datas+="&formula="+formula;
	datas+= "&formulaShow="+formulaShow;
				...
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							...
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>条件公式</label>
									<input id="filterFormula" name="filterFormula" type="text" value="${salaryItemStatCfg.filterFormula }"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<house:xtdm  id="calcMode" dictCode="SALCALCMODE" disabled="true" style="width:160px;" value="${salaryItemStatCfg.calcMode }"></house:xtdm>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>计算优先级</label>
									<house:dict id="filterLevel" dictCode="" sql="select 0 code ,0 descr" disabled="true"
