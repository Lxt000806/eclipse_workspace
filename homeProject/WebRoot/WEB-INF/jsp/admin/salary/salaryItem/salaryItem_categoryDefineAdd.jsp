						...
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									<label>薪酬代码</label>
									<input type="text" id="salaryItem" name="salaryItem" style="width:160px;" value="${salaryItem.code }" readonly="true"/>
								</li>
								<li class="form-validate">
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<textarea id="filterRemarks" name="filterRemarks" rows="3"></textarea>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">筛选条件公式</label>
									<textarea id="filterFormulaShow" name="filterFormulaShow" rows="3" readonly="true"></textarea>
								</li>
							...
							<div class="validate-group row">
								<li>
									<label>计算方式</label>
									<house:xtdm  id="calcMode" dictCode="SALCALCMODE" style="width:160px;" value="1" disabled="true"></house:xtdm>
								</li>
								<li class="form-validate">
