...
$(function(){
	var realPayGridOption ={
			//url:"${ctx}/admin/salaryCompareAnalyse/goRealPayJqGrid",
			//postData:{},
			...
			colModel : [
				...
				{name: "realpaysalary", index: "realpaysalary", width: 120, label: "实发", sortable: true, align: "right", formatter: formatRound},
				{name: "comparerealpaysalary", index: "comparerealpaysalary", width: 124, label: "上月实发", sortable: true, align: "right", formatter: formatRound},
				{name: "chgrealpaysalary", index: "chgrealpaysalary", width: 124, label: "变动金额", sortable: true, align: "right", formatter: formatRound},
				{name: "chgper", index: "chgper", width: 124, label: "变动百分比", sortable: true, align: "right",formatter: formatPer},
			], 
 		};
       //初始化送货申请明细
	   Global.JqGrid.initJqGrid("realPayDataTable",realPayGridOption);
...
<div class="body-box-list" style="margin-top: 0px;border:1px solid #ddd;">
	<div class="pageContent">
		<table id="realPayDataTable"></table>
		<div id="realPayDataTablePager"></div>
	</div>
</div>
