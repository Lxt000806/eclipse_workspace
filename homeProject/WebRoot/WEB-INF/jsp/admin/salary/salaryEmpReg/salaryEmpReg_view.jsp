...
$(function() {
	$("#salaryEmp").openComponent_salaryEmp({callBack:validateRefresh,showLabel:"${salaryEmpReg.empName}",showValue:"${salaryEmpReg.salaryEmp}",readonly:true});	
...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/salaryEmpReg/doUpdate",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
			...
			<div class="panel panel-info" >  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" id="pk" name="pk" style="width:160px;" value="${salaryEmpReg.pk }"/>
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<house:dict id="socialInsurParam" dictCode="" sql="select pk code ,descr from tSocialInsurParam " 
											 disabled="true"	sqlValueKey="code" sqlLableKey="descr" value="${salaryEmpReg.socialInsurParam }"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">备注</label>
									<textarea id="remarks" name="remarks" rows="3" readonly="true">${salaryEmpReg.remarks }</textarea>
								</li>
							</div>
