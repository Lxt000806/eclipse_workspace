...
$(function() {
	$("#salaryEmp").openComponent_salaryEmp({callBack:validateRefresh,showLabel:"${salaryEmpReg.empName}",showValue:"${salaryEmpReg.salaryEmp}"});	
							...
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<house:dict id="socialInsurParam" dictCode="" sql="select pk code ,descr from tSocialInsurParam " 
												sqlValueKey="code" sqlLableKey="descr" value="${salaryEmpReg.socialInsurParam }"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label class="control-textarea">备注</label>
									<textarea id="remarks" name="remarks" rows="3">${salaryEmpReg.remarks }</textarea>
								</li>
							</div>
