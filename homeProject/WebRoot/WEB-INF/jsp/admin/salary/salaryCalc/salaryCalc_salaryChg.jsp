...
$(function() {
	...
	$("#salaryEmp").openComponent_salaryEmp({showValue:"${salaryEmp.empCode}",showLabel:"${salaryEmp.empName}",callBack:getEmpData});	

	if("${salaryData.calcAll}"==""){
		$("#calcAll").val(0);
	}
...
function doChgEmpSalary(){
	...
	$.ajax({
		url:"${ctx}/admin/salaryCalc/doChgEmpSalary",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
						...
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" id="salaryEmp" name="salaryEmp" style="width:160px;" value="${salaryScheme.salaryEmp }"/>
								</li>
								<li class="form-validate">
									<label>部门</label>
							...
							<div class="validate-group row">
								<li class="form-validate">
									<label>金额</label>
									<input type="text" id="adjustValue" name="adjustValue" style="width:160px;" value="0.0"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
