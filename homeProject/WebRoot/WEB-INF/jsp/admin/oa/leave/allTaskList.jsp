...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			url:"${ctx}/admin/oa/leave/goJqGridAll",
			...
			colModel : [
		      ...
		      {name : 'key_',index : 'key_',width : 70,label:'key_',sortable : true,align : "left",hidden:true}
		    ]
		});
...
function del(){
	var url = "${ctx}/admin/oa/leave/doDelete?flag=all";
	beforeDel(url,"leaveid");
}
</script>
</head>
<body>
	<div class="body-box-list">
		...
		<div class="btn-panel">
			 <div class="btn-group-sm">
			 	<house:authorize authCode="taskAll_view">
