...
function save(){
    ...
    $.ajax({
        url:'${ctx}/admin/saleCust/doUpdate',
        type: 'post',
        data: datas,
        dataType: 'json',
        cache: false,
            ...
            <div class="panel panel-info">
                <div class="panel-body">
                    <form action="" method="post" id="dataForm" class="form-search">
                        ...
                        <input type="hidden" name="expired" id="expired" value="${saleCust.expired}" />
                        <ul class="ul-form">
                           ...
                           <li class="form-validate">
	                           ...
	                           <textarea id="remarks" name="remarks" rows="4" style="width:450px;">${saleCust.remarks}</textarea>
                           </li>
                           <li class="form-validate">
	                           <label>过期</label>
	                           <input type="checkbox" onclick="checkExpired(this)" ${saleCust.expired.equals('T')?'checked':''} />
                           </li>
                        </ul>
                    </form>
                </div>
