...
<html>
	...
	<body>
		...
		<div class="panel panel-system" >
		    <div class="panel-body" >
		    <li hidden="true">
				<input type="text" id="dateFrom" name="dateFrom" class="i-date" style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd '})" value="<fmt:formatDate value='${signIn.dateFrom}' pattern='yyyy-MM-dd hh:MM:ss'/>" />
				<input type="text" id="dateTo" name="dateTo" class="i-date" style="width:160px;" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd '})" value="<fmt:formatDate value='${signIn.dateTo}' pattern='yyyy-MM-dd hh:MM:ss'/>" />
			</li>
