...
$(function(){
	...
	/**初始化表格*/
	var gridOption ={			
		url:"${ctx}/admin/prjRole/goJqGridPrjWork?prjRole="+"${prjRole.code}",				
	          styleUI: 'Bootstrap',
		height:300,			
		colModel : [		
		...
		afterSaveCell:function(rowId,name,val,iRow,iCol){
		    var rowData = $("#dataTable_workType").jqGrid("getRowData",rowId);
		 	if(("<%=czylb %>"=="2")&&(($.trim($("#m_umState").val())=="A")||($.trim($("#m_umState").val())=="M"))){
	   		...
	   		Global.JqGrid.updRowData("dataTable_workType",rowId,rowData);
	  	}
