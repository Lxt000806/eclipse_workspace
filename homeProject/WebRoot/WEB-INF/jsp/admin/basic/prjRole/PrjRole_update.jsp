	...
	<div class="panel panel-info" >  
             ...
             <form role="form" class="form-search" id="dataForm"  action="" method="post" target="targetFrame">
				...
				<ul class="ul-form">
					...
					<li class="form-validate">	
						...
						<input type="text" id="code" name="code"   value="${prjRole.code}"  readonly="true"/>
					</li>
					<li class="form-validate">	
					...
					<li class="form-validate" hidden="true">	
						<label><span class="required">*</span>名称</label>
						<input type="text" id="descr1" name="descr1"   value="${prjRole.descr}" />
					</li>
					</div>
					<li hidden="true">
	    ...
	    <div class="tab-content">  
			<div id="tab_itemAppSend"  class="tab-pane fade in active"> 
		    	<jsp:include page="PrjRole_WorkType12_update.jsp"></jsp:include>
			</div>  
			<div id="tab_salesInvoice"  class="tab-pane fade "> 
	         	<jsp:include page="PrjRole_PrjItem_update.jsp"></jsp:include>
			</div>
		</div>	
	</div>	
    ...
    if (ret) {
      Global.Dialog.showDialog("carryRuleUpdate",{
		  ...
		  postData:{prjRole:ret.prjrole,
                    ...
                    unSelected: prjRoleJson["fieldJson"]
                    },		 			 		  
		  height:600,
		  width:1000,
		   returnFun:function(data){
...
$("#updateitem").on("click",function(){
    ...
    if (ret) {
        Global.Dialog.showDialog("carryRuleUpdate",{
		  ...
		  postData:{prjRole:ret.prjrole,prjRoleDescr:ret.prjroledescr,prjItem:ret.prjitem,prjItemDescr:ret.prjitemdescr,unSelected: prjRoleJson["fieldJson"]},	                 			 		 
		  height:600,
		  width:1000,
		   returnFun:function(data){
