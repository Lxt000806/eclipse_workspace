...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/position/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
                    ...
                    <ul class="ul-form">
                        <div class="validate-group row">
                            <li class="form-validate"><label style="width:100px;"><span
                                    class="required">*</span>职位编号</label> <input type="text" id="code" name="code" readonly="readonly"
                                    style="width:160px;" value="${position.code}" />
                            </li>
