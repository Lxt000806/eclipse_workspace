...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/workSignAlarm/doSave',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
...
function getPrjItem2ListByPrjItem1(prjItem1){
	$.ajax({
				...
				<form action="" method="post" id="dataForm" class="form-search">
					<ul class="ul-form">
						...
						<div class="validate-group">
							...
							<li class="form-validate">
								<label><span class="required">*</span>阶段是否完成</label> 
						 ...
						 <div id="mission">
							 <div class="validate-group">
							  	...
							  	<li class="form-validate">
									<label><span class="required">*</span>是否判断需求</label> <house:xtdm
