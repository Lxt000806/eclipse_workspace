...
<script type="text/javascript">
	...
	$(function() {
		$("#saveBtn").on("click", function() {
			...
			$.ajax({
				url : "${ctx}/admin/profitPerf/doUpdate",
				type : "post",
				data : datas,
				dataType : "json",
				cache : false,
				...
				<form action="" method="post" id="dataForm" class="form-search">
					...
					<ul class="ul-form">
						<div class="validate-group row">
							<input type="hidden" id="pk" name="pk" value="${profitPerf.pk }" />
							<li class="form-validate"><label><span
									class="required">*</span>材料类型</label> <house:dict
									...
									value="${profitPerf.itemType12 }">
								</house:dict>
							</li>
							<li class="form-validate"><label><span
									class="required">*</span>是否滞销品</label> <house:xtdm
									id="isClearInv" dictCode="YESNO"
									value="${profitPerf.isClearInv }"></house:xtdm>
							</li>
						</div>
						<div class="validate-group row">
							<li class="form-validate"><label><span
									class="required">*</span>设计师提成点数</label> <input
								type="text" id="designCommiPer" name="designCommiPer"
								style="width:160px;" value="${profitPerf.designCommiPer}" />
							</li>
							<li class="form-validate"><label><span
									class="required">*</span>买手提成点数</label> <input
