...
<head>
    ...
    <script type="text/javascript">
		...
		function save() {
		    ...
		    if (carrytype == "") {
		        art.dialog({content: "搬运类型不能为空！", width: 200});
		        return false;
		    }
		    ...
		    var param = {
		        "itemAppsendDetailJson": JSON.stringify(detailJson1),
		        "salesInvoiceDetailJson": JSON.stringify(detailJson)
		    };
		    Global.Form.submit("dataForm",
		        "${ctx}/admin/CarryRule/docarryRuleSave",
		        param,
		        function(ret) {
		            if (ret.rs == true) {
		                art.dialog({
        ...
        $(function() {
            ...
            $("#supplCode").openComponent_supplier({
                showValue: '${carryRule.supplCode}', showLabel: '${carryRule.supplDescr}', condition: {ReadAll: "1"},
                callBack: function() {
    ...
    <div class="panel panel-info">
        <div class="panel-body">
            <form role="form" class="form-search" id="dataForm" action="" method="post" target="targetFrame">
                ...
                <input type="hidden" id="m_umState" name="m_umState" value="C"/>
                <input type="hidden" id="fieldJson" name="fieldJson"/>
                <ul class="ul-form">
                    <div class="validate-group">
                        <li>
                            <label><span class="required">*</span>编号</label>
                            <input type="text" id="no" name="no" readonly="true" placeholder="保存时生成"/>
                        </li>
