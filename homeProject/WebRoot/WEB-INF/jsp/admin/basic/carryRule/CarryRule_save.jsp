...
function save(){
	...
	Global.Form.submit("dataForm","${ctx}/admin/CarryRule/docarryRuleSave",param,function(ret){
		if(ret.rs==true){
			art.dialog({
				content: ret.msg,
				time: 1000,
...
$("#additem").on("click",function(){	
	...
	Global.Dialog.showDialog("carryRuleItemadd",{			
		...
		postData:{no:no,itemType1:itemtype1,itemType2:itemtype2,detailJosn: itemcode1["fieldJson"]},		  		  		 
	    height: 600,
		width:1000,
		returnFun: function(data){       	
       		if(data){    	 	
    ...
    if (ret) {
        Global.Dialog.showDialog("carryRuleUpdate",{
		    title:"修改材料页面",
		  	...
		  	postData:{no:no,itemType1:itemType1,itemType2:itemtype2,itemType3:ret.itemtype3,
		  			  itemType3Descr:ret.itemtype3descr,detailJosn:itemcode1["fieldJson"]},	                 			 		 
		  	height:600,
		  	width:1000,
		   	returnFun:function(data){
