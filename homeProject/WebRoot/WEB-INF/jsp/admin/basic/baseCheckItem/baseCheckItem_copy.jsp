...
$(function(){
	...
	function copy(){
		...
		$.ajax({
			url : "${ctx}/admin/baseCheckItem/doCopy",
			type : "post",
			data : datas,
			dataType : "json",
			cache : false,
				...
				<form action="" method="post" id="dataForm" class="form-search">
					<ul class="ul-form">
						...
						<input type="text" id="lastUpdatedBy" name="lastUpdatedBy" value="${baseCheckItem.lastUpdatedBy}" hidden="true"/>			  				  
					   	<input type="text" id="actionLog" name="actionLog" value="${baseCheckItem.actionLog}" hidden="true" />
					    <li>
							<label>编号</label>
							<input type="text" id="code" name="code" placeholder="自动生成" readonly="readonly"/>
						</li>
