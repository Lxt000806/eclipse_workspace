...
$(function() {
	...
	if ($("#positionType").val()=='6'||$("#secondPositionType").val()=='6'){
...
function copy(){
	...
	if(!$("form").data("bootstrapValidator").isValid()) return;//表单校验
    ...
    if($.trim($("#nameChi").val())=="" || $.trim($("#department1").val())==""
	...
	$.ajax({
		url:"${ctx}/admin/employee/uploadCpEmpImg",
		type:"POST",
		data:formData,
		contentType:false,
		processData:false,
...
$(function() {
	$("form").bootstrapValidator({
		...
		fields: {  
			...
			openComponent_applicant_applicantPK: {
				validators : {
					notEmpty : {
						message : '应聘序号不能为空',
					}
	...
	<div class="panel panel-system">
	    <div class="panel-body">
	    	<div class="btn-group-xs">
				<button type="button" class="btn btn-system" onclick="copyNew()">保存</button>
				...
				<ul class="ul-form">
					<div class="validate-group">
						<li>
							...
							<input type="text" id="number" name="number" placeholder="保存时自动生成"/>
						</li>
						<li>
							<label>参考编号</label>
  			...
  			<div id="tab_employeeSaveMain" class="tab-pane fade in active">
						    ...
						    <div style=" width: 300px; float: left">
								<ul class="ul-form">
									...
									<div class="validate-group row">
										...
										<li>
											<label>性别</label>
											<house:xtdm id="gender" dictCode="GENDER"></house:xtdm>		
										</li>
										<li>
											<label>出生日期</label>
											<input type="text" id="birth" name="birth" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
										</li>
									</div>	
								</ul>
							</div>
							...
							<div style="width: 750px; float: left;">
								<ul class="ul-form">
									<div class="validate-group row">
										<li>
											<label>家庭住址</label>
											<input type="text" id="address" name="address" style="width: 450px;"/>
										</li>
									</div>	
									<div class="validate-group row">	
										<li class="form-validate">
											<label>身份证号</label>
											<input type="text" id="idnum" name="idnum" maxlength="18"/>
										</li>
										<li><label><span class="required">*</span>所属部门</label>
										    <input type="text" style="width:160px;" id="department" name="department"/>
										</li>
									</div>
									<div class="validate-group row">	
										<li>
											<label>身份证有效期</label>
											<input type="text" id="idValidDate" name="idValidDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
										</li>
										<li class="form-validate">
											<label>一级部门</label>
									...
									<div class="validate-group row">
										...
										<li>
											<label>籍贯</label>
											<input type="text" id="birtPlace" name="birtPlace"/>
										</li>
										<li>
											<label>三级部门</label>
										...
										<li>
											<label>文化程度</label>
											<house:xtdm id="edu" dictCode="EDU"></house:xtdm>
										</li>	
										<li>
											<label>副职编号</label>
										...
										<li>
											<label>毕业日期</label>
											<input type="text" id="graduationDate" name="graduationDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
										</li>						
										<li>
											<label>是否部门领导</label>
											<house:xtdm id="isLead" dictCode="YESNO" value="${employee.isLead}"></house:xtdm>
										</li> 
										<li>
											<label>毕业院校</label>
										...
										<li>
											<label>领导级别</label>
											<house:xtdm id="leadLevel" dictCode="LEADLEVEL" value="${employee.leadLevel}"></house:xtdm>
										</li> 
										<li>
											<label>专业</label>
											<input type="text" id="schDept" name="schDept"/>
										</li>
										<li>
											<label><span class="required">*</span>方案设计师</label>
											<house:xtdm id="isSchemeDesigner" dictCode="YESNO" value="${employee.isSchemeDesigner}"></house:xtdm>
										</li>
										<li>
										...
										<li>
											<label>状态</label>
											<house:xtdm id="status" dictCode="EMPSTS" value="${employee.status}"></house:xtdm>
										</li>
										<li>
											<label id="chagel" style="color:#777777">离开日期</label>
											<input type="text" id="leaveDate" name="leaveDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" disabled="true"/>
										</li>
										<li>
											<label id="chager" style="color:#777777">返岗日期</label>
											<input type="text" id="reTurnDate" name="reTurnDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" disabled="true"/>
										</li>
										<li>
											<label>转正日期</label>
											<input type="text" id="regularDate" name="regularDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" />
										</li>	
										<li>
											<label>工龄</label>
										...
										<li>
											<label>人事调岗时间</label>
										    <input type="text" id="personChgDate" name="personChgDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" />
										</li> 
										<li>
											<label>合同开始时间</label>
										    <input type="text" id="conBeginDate" name="conBeginDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
										</li>
										<li>
											<label>合同截止时间</label>
										    <input type="text" id="conEndDate" name="conEndDate" class="i-date" onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
										</li> 	
										<li>
											<label>项目经理星级</label>
										...
										<li>
											...
											<house:xtdm dictCode="EMPTYPE" id="type" unShowValue="3" value="${employee.type}"></house:xtdm>
										</li>																
										<li>
							...
							<form action="" method="post" id="page_form_2" class="form-search">
								<ul class="ul-form" style="height: 450px;">
									<li>
										...
										<input type="text" id="connMan" name="connMan"/>
									</li>
									<li>
									...
									<li class="form-validate">
										...
										<input type="text" id="connPhone" name="connPhone" maxlength="11"/>
									</li>
									<li>
									...
									<li class="form-validate" hidden="true">
										...
										<input type="text" id="basicWage" value="0" name="basicWage"/>
									</li>
									<li>
										...
										<house:dict id="isPreTrain" dictCode="" sql="select cbm,cbm+' '+note note from tXTDM a where a.ID='YESNO' " 
										 sqlValueKey="cbm" sqlLableKey="note"  disabled="true"></house:dict>							
									</li>
									<li class="form-validate">
										<label style="width: 120px;" for="isPubReturn">培训课程期数名称</label>
										<input type="text" id="courseCode" name="courseCode" readonly="readonly"/>
									</li>
									<li>
									...
									<li>
										...
										<textarea id="chgRemarks" name="chgRemarks" rows="8" style="width: 470px"></textarea>
									</li>
								</ul>
							</form>
							...
							<form action="" method="post" id="page_form_3" class="form-search">
								<ul class="ul-form" style="height: 450px;">
									<li>
 									...
 									<li>
										<label style="width: 160px;" for="oldDepartment1">原一级部门</label>
									...
									<li>
										...
										<house:xtdm id="perfBelongMode" dictCode="PERFBELONGMODE"></house:xtdm>
									</li>
								</ul>
							</form>	
						</div>
		    	...
		    	<div id="tab_employeeSaveWork"  class="tab-pane fade"> 
		    		...
		    		<div class="panel panel-info" style="height:450px; width:700px; overflow-y:hidden;">  
						<div id="content-list" style="width:1006px;">
...
function copyNew() {
    ...
    if ($.trim($("#nameChi").val()) == ""
        ...
        if ($.trim($("#department").val()) == "" && $.trim($("#position").val()) != "") {
            art.dialog({content: "请填入完整信息，所属部门未选择"})
        } else {
            art.dialog({content: "请填入完整信息"})
        }
...
function doCopyNew(data) {
    $.ajax({
        url: "${ctx}/admin/employee/doCopyNew",
        type: "POST",
        data: data,
        dataType: "json",
        error: function(obj) {
