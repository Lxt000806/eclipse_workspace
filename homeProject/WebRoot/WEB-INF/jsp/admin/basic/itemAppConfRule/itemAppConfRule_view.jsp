			...
			<form action="" method="post" id="dataForm" class="form-search" target="targetFrame">
				...
				<ul class="ul-form">	
					<div class="validate-group">		  
						<li>
							<label>批次号</label>
							<input type="text" id="no" name="no" value="${itemAppConfRule.no}" readonly="readonly"/>
						</li>
						...
						<li>
							<label>付款类型</label>
							<house:xtdm id="payType" dictCode="TIMEPAYTYPE" value="${itemAppConfRule.payType}" disabled="true"></house:xtdm>
						</li>
					</div>
					<div class="validate-group">	
						<li>
							...
							<house:dict id="custType" dictCode="" sql="select convert(int,code) code,code+' '+desc1 fd from tCusttype a  order by a.code" 
											 sqlValueKey="code" sqlLableKey="fd" value="${itemAppConfRule.custType}" disabled="true"></house:dict>	
						</li>
						<li class="form-validate">
							<label>优先级</label>
					...
					<div class="validate-group">
						...
						<li class="form-validate">
							<label>付款期数</label>
							<house:xtdm id="payNum" dictCode="PAYNUM" value="${itemAppConfRule.payNum}" disabled="true"></house:xtdm>
						</li>
						<li class="form-validate">	
							<label>材料成本</label>
							<input id="itemCost" nam="itemCost" value="${itemAppConfRule.itemCost}" readonly="readonly"/>
						</li>
					</div>
					<div class="validate-group">	
						<li>
							<label class="control-textarea">备注</label>
							<textarea id="remarks" name="remarks" readonly="readonly">${itemAppConfRule.remarks}</textarea>
						</li>
						<li>
