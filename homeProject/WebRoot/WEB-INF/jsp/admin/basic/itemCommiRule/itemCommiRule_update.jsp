		...
		<div class="panel panel-info" style="margin: 0px;">
			<div class="panel-body">
				<form role="form" class="form-search" id="page_form" action=""
					...
					<input type="hidden" id="pk" name="pk" value="${itemCommiRule.pk}"/>
					<ul class="ul-form">
...
<script type="text/javascript" defer>
	...
	function doSave() {
		...
		$.ajax({
			url : "${ctx}/admin/itemCommiRule/doUpdate",
			type : "post",
			data : datas,
			dataType : "json",
			cache : false,
