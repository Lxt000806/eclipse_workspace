...
<script type="text/javascript">
	$(function() {
		...
		$("#saveBtn").on("click", function() {
			...
			$.ajax({
				url : "${ctx}/admin/itemProm/doUpdate",
				type : "post",
		...
		<div class="body-box-form">
			...
			<div class="panel panel-info">
				<div class="panel-body">
					...
					<input type="hidden" name="pk" value="${itemProm.pk }" />
					<ul class="ul-form">
						<div class="validate-group row">
							<li><label>材料编码</label> <input type="text" id="itemCode"
								name="itemCode" value="${itemProm.itemCode }"/>
							</li>
							<li><label>材料名称</label> <input type="text" id="itemDescr"
								name="itemDescr" style="width:160px;" value="${itemProm.itemDescr }" readonly/>
							</li>
						</div>
						<div class="validate-group row">
							<li><label>现价</label> <input type="text" id="itemPrice"
								name="itemPrice" style="width:160px;" value="${itemProm.itemPrice }" readonly
								/>
							</li>
							<li><label>成本价</label> <input type="text" id="itemCost"
								name="itemCost" style="width:160px;" value="${itemProm.itemCost }" readonly
								/>
							</li>
						</div>
					</ul>
									...
									<ul class="ul-form">
										...
										<div class="validate-group row">
											<li><label style="width:145px;">过期</label> <input type="checkbox"
												id="expired" name="expired" value="${itemProm.expired }"
													${itemProm.expired!='F' ?'checked':'' } onclick="changeExpired()">
											</li>
										</div>
									</ul>
								</form>
