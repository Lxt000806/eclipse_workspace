...
function add(){
	Global.Dialog.showDialog("containBaseItemAdd",{
		  title:"添加ContainBaseItem",
		  url:"${ctx}/admin/containBaseItem/goSave",
		  height: 600,
		  width:1000,
...
function update(){
    ...
    if (ret) {
      Global.Dialog.showDialog("containBaseItemUpdate",{
		  title:"修改ContainBaseItem",
		  url:"${ctx}/admin/containBaseItem/goUpdate?id="+ret.PK,
		  height:600,
		  width:1000,
		  returnFun: goto_query
		});
...
function copy(){
	var ret = selectDataTableRow();
    if (ret) {
      Global.Dialog.showDialog("containBaseItemCopy",{
		  title:"复制ContainBaseItem",
		  url:"${ctx}/admin/containBaseItem/goSave?id="+ret.PK,
		  height:600,
		  width:1000,
		  returnFun: goto_query
		});
...
function view(){
	var ret = selectDataTableRow();
    if (ret) {
      Global.Dialog.showDialog("containBaseItemView",{
		  title:"查看ContainBaseItem",
		  url:"${ctx}/admin/containBaseItem/goDetail?id="+ret.PK,
		  height:600,
		  width:1000
		});
    } else {
...
function del(){
	var url = "${ctx}/admin/containBaseItem/doDelete";
	beforeDel(url);
}
//导出EXCEL
function doExcel(){
	$.form_submit($("#page_form").get(0), {
		"action": "${ctx}/admin/containBaseItem/doExcel"
	});
}
/**初始化表格*/
$(function(){
...
<body>
	<div class="body-box-list">
						...
						<tr>
							<td colspan="6" class="td-btn">
								<div class="sch_qk_con"> 
									<input type="checkbox" id="expired_show" name="expired_show" value="${containBaseItem.expired}" onclick="hideExpired(this)" ${containBaseItem.expired!='T'?'checked':'' }/>隐藏过期记录&nbsp;
		...
		<div class="pageContent">
			...
			<div class="panelBar">
            	<ul>
            	<house:authorize authCode="CONTAINBASEITEM_ADD">
                	<li>
				...
				<house:authorize authCode="CONTAINBASEITEM_COPY">
                	<li>
				...
				<house:authorize authCode="CONTAINBASEITEM_UPDATE">
                	<li>
                ...
                <house:authorize authCode="CONTAINBASEITEM_DELETE">
                	<li>
				 ...
				 <house:authorize authCode="CONTAINBASEITEM_VIEW">
                	<li>
