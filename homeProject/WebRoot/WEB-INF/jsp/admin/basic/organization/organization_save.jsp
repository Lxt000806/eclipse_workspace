...
$(function() {
	...
	if("${organization.m_umState}"=="M"){
		$("#idNumber,#thirdPartyUserId").attr("disabled",true);
	}
...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/organization/doSave",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
					...
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							...
							<div class="validate-group row">
								...
								<li class="form-validate">
									<label>机构证件号</label>
									<input type="text" id="idNumber" name="idNumber" style="width:160px;" value="${organization.idNumber }"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
							...
							<%-- <div class="validate-group row">
								<li class="form-validate">
		                            <label>是否认证</label>
		                            <house:xtdm id="isIdentified" dictCode="YESNO" value="${organization.isIdentified}"></house:xtdm>
		                        </li>
								<li class="form-validate">
									<label>认证Url</label>
									<input type="text" id="identifyUrl" name="identifyUrl" style="width:160px;" value="${organization.identifyUrl }"/>
								</li>
							</div> --%>
							<%-- <div class="validate-group row">
								<li class="form-validate">
		                            <label>是否静默签署</label>
		                            <house:xtdm id="isSilenceSign" dictCode="YESNO" value="${organization.isSilenceSign}"></house:xtdm>
		                        </li>
							</div> --%>
						</ul>
					</form>
