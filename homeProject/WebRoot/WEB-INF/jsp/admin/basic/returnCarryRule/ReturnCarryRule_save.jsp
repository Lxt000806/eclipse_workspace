...
$(function(){
	...
	var returnCarryRuleItemDetail= $('#dataTable').jqGrid("getRowData");	
		...
		Global.Form.submit("dataForm","${ctx}/admin/ReturnCarryRule/doreturnCarryRuleSave",param,function(ret){				
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
			...
			<form action="" method="post" id="dataForm" class="form-search" target="targetFrame">
				<input type="hidden" name="jsonString" value="" />
					...
					<li class="form-validate">
						...
						<house:xtdm id="calType" dictCode="ReCarryCalType"></house:xtdm>													
					</li>
					</div>
					<div class="validate-group">
					<li class="form-validate">
