            ...
            <form role="form" action="" method="post" id="page_form" class="form-search" target="targetFrame">
                ...
                <ul class="ul-form">
                    <div class="validate-group row">
                        ...
                        <li>
                            <label>成员编号</label>
                            <input type="text" id="code" name="code" placeholder="自动生成" readonly/>
                        </li>
                        ...
                        <li class="form-validate">
                            ...
                            <house:xtdm id="isheadman" dictCode="YESNO" value="0" disabled="true"></house:xtdm>
                        </li>
                        <li class="form-validate">
                        ...
                        <li class="form-validate">
                            ...
                            <input type="text" id="cardid" name="cardid" placeholder="建行卡"/>
                        </li>
                        <li class="form-validate">
                        ...
                        <li class="form-validate">
                            <label>卡号2</label>
                            <input type="text" id="cardid2" name="cardid2"/>
                        </li>
                        <li class="form-validate">
                            <label>开户行及支行2</label>
                        ...
                        <li class="form-validate">
                            ...
                            <input type="text" id="salaryratio" name="salaryratio"/>
                        </li>
                    </div>
                </ul>
            </form>
