...
<div class="body-box-list">
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					name="descr" style="width:160px;" value="0" required
			...
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
						...
						sqlValueKey="Code" sqlLableKey="fd" value="02">
					</house:dict>
				</li>
			</div>
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					name="posId" style="width:160px;" value="0" required
			...
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					name="compName" style="width:160px;" value="0" required
			...
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					name="minFee" style="width:160px;" value="0" required
			...
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					name="maxFee" style="width:160px;" value="0" required
			...
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					name="feePerc" style="width:160px;" value="0" required
			...
			<div class="validate-group row">
				<li class="form-validate"><label style="width:200px;"><span
					...
					value="0" required data-bv-notempty-message="收单服务费百分比不能为空" />
				</li>
			</div>
			<div class="row">
				<li>
					<label for="cardAttr" style="width:200px;">卡性质</label>
					<house:xtdm id="cardAttr" dictCode="CARDATTR" style="width:160px;"/>
				</li>
			</div>
			<div class="row">
				<li>
					<label style="width:200px;">卡类型</label>
					<house:xtdm id="cardType" dictCode="POSCARDTYPE" style="width:160px;"/>
				</li>
			</div>
</div>
