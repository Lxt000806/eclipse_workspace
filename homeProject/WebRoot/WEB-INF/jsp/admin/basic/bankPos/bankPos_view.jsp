					...
					<ul class="ul-form">
						<div class="validate-group row">
							<li class="form-validate"><label style="width:185px;"><span
								...
								name="code" style="width:160px;" readonly
								value="${bankPos.Code}" required
								data-bv-notempty-message="编号不能为空" />
							</li>
						</div>
					</ul>
				</div>
				...
				<ul class="ul-form">
					<div class="tab-content">
						<div id="tab_info" class="tab-pane fade in active">
							<jsp:include page="bankPos_viewTab.jsp"></jsp:include>
						</div>
					</div>
				</ul>
			</div>
