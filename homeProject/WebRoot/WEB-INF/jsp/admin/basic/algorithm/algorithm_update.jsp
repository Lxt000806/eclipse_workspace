						...
						<div class="validate-group row">
							<li class="form-validate">
								...
								<input type="text" id="code" name="code" style="width:160px;"
									value="${algorithm.code}" readonly="readonly" />
							</li>
							<li class="form-validate">
								<label>名称</label> 
							...
							<li>
								...
								<input type="checkbox" id="expired" name="expired" value="${algorithm.expired}" 
									onclick="checkExpired(this)" ${algorithm.expired=="T"?"checked":""}/>
							</li>
						</div>
					</ul>
				</div>
...
$(function() {
	...
	Global.JqGrid.initJqGrid("dataTable",{
		url:"${ctx}/admin/algorithm/goDetailJqGrid",
		postData:{code:"${algorithm.code}"},
...
/*	if(param.datas.length == 0){
		art.dialog({content: "请输入算法适用材料",width: 220});
		return;
	}*/
