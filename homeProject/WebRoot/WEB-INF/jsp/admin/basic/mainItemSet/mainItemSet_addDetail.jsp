    ...
    <div class="panel panel-info">
        <div class="panel-body">
            <form role="form" class="form-search" id="dataForm" action="" method="post" target="targetFrame">
                <input type="hidden" id="itemdescr" name="itemdescr"/>
                <input type="hidden" name="expired" value="F"/>
                <input type="hidden" name="actionlog" value="ADD">
                ...
                <ul class="ul-form">
                    ...
                    <li class="form-validate">
                        <label>算法系数</label>
                        <input type="text" id="algorithmper" name="algorithmper" value="1.0"/>
                    </li>
                    <li class="form-validate">
                        <label>算法扣除数</label>
                        <input type="text" id="algorithmdeduct" name="algorithmdeduct" value="0.0"/>
                    </li>
                    <li class="form-validate">
                        <label>数量</label>
                    ...
                    <li class="form-validate">
                        <label>切割类型</label>
                        <select id="cuttype" name="cuttype"></select>
                    </li>
                    <li class="form-validate">
                        <label><span class="required">*</span>材料类型说明</label>
                        <house:xtdm id="itemtypecode" dictCode="ITEMTYPEDESCR"></house:xtdm>
                    </li>
                </ul>
                <ul class="ul-form">
                    <li>
