...
$(function() {
    ...
    $("#childCode").openComponent_roll({
                        callBack:validateRefresh,
                        showValue:"${roll.childCode}"
                    });
