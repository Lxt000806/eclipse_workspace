...
$(function() {
	...
	$("#saveBtn").on("click",function(){
		...
		$.ajax({
			url:"${ctx}/admin/guideTopic/doUpdate",
			type: "post",
			...
			<div class="panel panel-info">  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" id="pk" name="pk" value="${guideTopic.pk}"/>
						...
						<ul class="ul-form">
							...
							<div class="validate-group row">
								<li class="form-validate">
									<label>关键字</label>
									<input type="text" id="keyWords" name="keyWords" style="width:448px;" value="${guideTopic.keyWords.trim() }" placeholder="支持多个关键字，空格隔开"/>
								</li>
							</div>
						</ul>
					</form>
