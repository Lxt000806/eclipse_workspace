...
<title>付款规则添加规则</title>
	...
	$(function() {
		$("#saveBtn").on("click",function(){
            ...
            $("#isCalcCommiDescr").val($("#isCalcCommi option:checked").text().split(/ +/)[1]);
            $("#isCalcSceneDesignCommiDescr").val($("#isCalcSceneDesignCommi option:checked").text().split(/ +/)[1]);
            $("#isCalcDesignFeeCommiDescr").val($("#isCalcDesignFeeCommi option:checked").text().split(/ +/)[1]);
            $("#isCalcDrawFeeCommiDescr").val($("#isCalcDrawFeeCommi option:checked").text().split(/ +/)[1]);
            $("#isCalcMainCommiDescr").val($("#isCalcMainCommi option:checked").text().split(/ +/)[1]);
            $("#isCalcIntCommiDescr").val($("#isCalcIntCommi option:checked").text().split(/ +/)[1]);
            var selectRows = [];
			...
			<div class="panel panel-info">  
				<div class="panel-body">
					<form role="form" class="form-search" id="dataForm"  action="" method="post" target="targetFrame">
						<input type="hidden" id="paynums" name="paynums" style="width:160px;" value="${paynums }"/>
						...
						<ul class="ul-form">
                                ...
                                <li class="form-validate">
                                    ...
                                    <input type="text" id="tipAddDays" name="tipAddDays" value="0"/>
                                </li>
								...
								<li class="form-validate">
									...
									<input type="text" id="businessCommiProvidePer" name="businessCommiProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>业务补贴发放比例</label>
									<input type="text" id="businessSubsidyProvidePer" name="businessSubsidyProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" "/>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>业务倍数发放比例</label>
									<input type="text" id="businessMultipleProvidePer" name="businessMultipleProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0"/>
								</li>
								
								<li class="form-validate">
									<label><span class="required">*</span>设计提成发放比例</label>
									<input type="text" id="designCommiProvidePer" name="designCommiProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								<li class="form-validate">
								...
								<li class="form-validate">
									...
									<input type="text" id="designSubsidyProvidePer" name="designSubsidyProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								
								<li class="form-validate">
									<label><span class="required">*</span>设计倍数发放比例</label>
									<input type="text" id="designMultipleProvidePer" name="designMultipleProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								<li class="form-validate">
								...
								<li class="form-validate">
									...
									<input type="text" id="sceneDesignProvidePer" name="sceneDesignProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								...
								<li class="form-validate">
									...
									<input type="text" id="businessMainCommiProvidePer" name="businessMainCommiProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								<li class="form-validate">
								...
								<li class="form-validate">
									...
									<input type="text" id="businessIntCommiProvidePer" name="businessIntCommiProvidePer" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" value="0" />
								</li>
								<li class="form-validate">
