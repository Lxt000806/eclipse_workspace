...
$(function() {
	...
	$("#saveBtn").on("click",function(){
		...
		Global.Form.submit("page_form","${ctx}/admin/payRule/doUpdate",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
		...
		<div class="body-box-form">
			...
			<div class="panel panel-info">  
				<div class="panel-body">
					<form action="" method="post" id="page_form" class="form-search">
						...
						<input type="hidden" id="expired" name="expired"  value="${payRule.expired}"/>
						<ul class="ul-form">
							<li>
								<label>规则编号</label>
								<input type="text" id="no" name="no" style="width:160px;" value="${payRule.no }" readonly="readonly"/>
							</li>
							<li class="form-validate">>
								<label><span class="required">*</span>客户类型</label>
								<house:custType id="custType" value="${payRule.custType }" ></house:custType>
							</li> 
			...
			<div class="container-fluid">  
				<ul class="nav nav-tabs"> 
			        <li class="active">
			        	<a href="#tab_detail" data-toggle="tab">规则明细</a>
			        </li>
			    </ul> 
				<div id="content-list">
