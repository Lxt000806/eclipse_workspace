            ...
            <div class="panel panel-system">
                <div class="panel-body">
                    <div class="btn-group-xs">
                        <button type="button" class="btn btn-system" id="saveBtn" onclick="saveTeamEmp()">
                            <span>保存</span>
                        </button>
                    ...
                    <ul class="ul-form">
                        <div class="validate-group row">
                            <li class="form-validate">
                                ...
                                <input type="text" id="number" maxlength="10" name="number" style="width:150px;" />
                            </li>
                            <!-- 
                            <li class="form-validate">
