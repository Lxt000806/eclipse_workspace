	   ...
	   <ul class="ul-form">
			<div class="validate-group row" style="min-height:200px;">
			    <li class="form-validate">
			       ...
			       <input type="text" id="desc1" name="desc1" value="${team.desc1}" disabled="disabled" />
			    </li>
			    <li>
					<label>是否计算业绩</label>
			    ...
			    <li class="form-validate">
		           ...
		           <textarea id="remark" name="remark" rows="8" style="width:300px;" disabled="disabled">${team.remark}</textarea>
		        </li>
