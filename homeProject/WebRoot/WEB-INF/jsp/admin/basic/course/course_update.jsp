...
function goLoadExcel(){
    ...
    $(function() {
        ...
        $("#saveBtn").on("click", function() {
            ...
            $.ajax({
                url : "${ctx}/admin/course/doUpdateCourse",
                type : "post",
                data : datas,
                dataType : "json",
                cache : false,
...
$(function(){
    Global.JqGrid.initJqGrid("dataTable", {
            ...
            rowNum:-1,
            colModel : [
                    {name:"number", index:"number", width:100, label:"员工编号", align:"left"},
                    {name: "namechi", index: "nameChi", width: 70, label: "姓名", align: "left"},
                    {name: "gender", index: "gender", width: 70, label: "性别", align: "left"},
                    {name: "department1descr", index: "department1Descr", width: 80, label: "一级部门", align: "left"},
                    {name: "department2descr", index: "department2Descr", width: 80, label: "二级部门", align: "left"},
                    {name: "department3descr", index: "department3Descr", width: 80, label: "三级部门", align: "left"},
                    {name: "positionname", index: "positionName", width: 80, label: "职位", align: "left"},
                    {name: "joindate", index: "joinDate", width: 120, label: "加入日期", align: "left", formatter:formatTime},
                    {name: "phone", index: "phone", width: 80, label: "电话", align: "right"},
                    {name: "score", index: "score", width: 60, label: "成绩", align: "right"},
                    {name: "ispass", index: "isPass", hidden:true},
                    {name: "ispassdescr", index: "isPassDescr", width: 70, label: "是否毕业", align: "left"},
                    {name: "ismakeup", index: "isMakeUp", hidden:true},
                    {name: "ismakeupdescr", index: "isMakeUpDescr", width: 70, label: "是否补考", align: "left"},
                    {name: "makeupscore", index: "makeUpScore", width: 70, label: "补考成绩", align: "right"},
                    {name: "remark", index: "remark", width: 150, label: "备注", align: "left"}
            ]
    });
});
</script>
                    ...
                    <ul class="ul-form">
                        <div class="validate-group">
                            ...
                            <li class="form-validate">
                                ...
                                <input type="text" id="descr" name="descr" value="${course.descr}"/>
                            </li>
                            ...
                            <li class="form-validate">
                                ...
                                <input type="text" id="nums" name="nums" value="${course.nums}"/>
                            </li>
                         </div>
                         <div class="validate-group">
                            <li class="form-validate">
                                ...
                                <input type="text" id="beginDate" name="beginDate" class="i-date"
                                    ...
                                    value="<fmt:formatDate value='${course.beginDate}' type='DATE' pattern="yyyy-MM-dd" />" />
                            </li>
                            ...
                            <li class="form-validate">
                                ...
                                <input type="text" id="endDate" name="endDate" class="i-date"
                                    onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"
                                    value="<fmt:formatDate value='${course.endDate}' type='DATE' pattern="yyyy-MM-dd" />" />
                            </li>
                            <li class="form-validate">
                                <label class="control-textarea">备注</label>
                                <textarea id="remark" name="remark" style="width:160px;">${course.remark}</textarea>
                            </li>
                            <li class="form-validate">
