	...
	<div class="validate-group row">
		<div class="col-xs-6">
			<li><label style="width:145px;">套餐主材是否发包</label> <house:xtdm
				id="isSetMainCtrl" dictCode="YESNO"
				></house:xtdm>
			</li>
			<li>
			...
			<li><label style="width:145px;">水电材料发包工人</label> <house:xtdm
					id="isWaterItemCtrl" dictCode="YESNO"></house:xtdm>
			</li>
			<li><label style="width:145px;">是否参与业绩计算</label> <house:xtdm
				id="isCalcPerf" dictCode="YESNO" ></house:xtdm>
			</li>
			...
			<li><label style="width:145px;">集成套内金额计算方式</label> <house:xtdm
				id="intSaleAmountCalcType_Set" dictCode="INTAMTCALCTYPE" ></house:xtdm>
			</li>
			...
			<li><label style="width:145px;">发包方式</label> <house:xtdm
				id="prjCtrlType" dictCode="CustPrjCtrlType" ></house:xtdm>
			</li>
			<li>
			...
			<li><label style="width:145px;">是否参与提成计算</label> <house:xtdm
				id="isCalcCommi" dictCode="YESNO" value="0"></house:xtdm>
			</li>
		</div>
		<div class="col-xs-6">
			<li><label style="width:145px;">发包价公式</label> <input type="text"
				id="ctrlExpr" name="ctrlExpr" style="width:495px;"/>
			</li>
			...
			<li><label style="width:145px;">业绩公式</label> 
				<input type="text" id="perfExpr" name="perfExpr" style="width:495px;" />
			</li>
			<li><label style="width:145px;">增减业绩公式</label> <input type="text"
				id="perfExpr" name="chgPerfExpr" style="width:495px;"  />
			</li>
			...
			<li style="max-height: 120px;">
				...
				<textarea id="chgPerfExprRemarks" name="chgPerfExprRemarks" style="height: 50px;width: 495px;"></textarea>
			</li>
		</div>
	</div>
</div>
