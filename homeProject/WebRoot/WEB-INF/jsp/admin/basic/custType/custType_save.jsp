				...
				<ul class="ul-form">
					<div class="tab-content">
						<div id="tab_info" class="tab-pane fade in active">
							<jsp:include page="custType_saveTab.jsp"></jsp:include>
						</div>
						<div id="tab_manage" class="tab-pane fade>
							<jsp:include page="custType_saveManageTab.jsp"></jsp:include>
						</div>
						<div id="tab_perf" class="tab-pane fade>
							<jsp:include page="custType_savePerfTab.jsp"></jsp:include>
						</div> 
					</div>
				</ul>
			</div>
