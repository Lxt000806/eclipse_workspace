					...
					<ul class="ul-form">
						<div class="validate-group row">
							...
							<li class="form-validate">
								...
								<input type="text" id="descr" name="descr" style="width:160px;" value="${appItemTypeBatch.descr}"/>
							</li>
						</div>
						<div class="validate-group row">
							<li class="form-validate">
								<label><span class="required">*</span>是否套餐材料</label>
								<house:xtdm id="isSetItem" dictCode="YESNO" style="width:160px;" value="${appItemTypeBatch.isSetItem}"/>
							</li>
							<li class="form-validate">
								<label><span class="required">*</span>提示一起下单</label>
								<house:xtdm id="infoAppAll" dictCode="YESNO" style="width:160px;" value="${appItemTypeBatch.infoAppAll}"/>
							</li>
						</div>
						<div class="validate-group row">
							<li class="form-validate">
								...
								<input type="text" id="dispSeq" name="dispSeq" style="width:160px;"
									...
									value="${appItemTypeBatch.dispSeq}"/>
							</li>
							<li>
								<label>过期</label>
...
$(function() {
	...
	function doSave(){
		...
		$.ajax({
			url:"${ctx}/admin/appItemTypeBatch/doUpdate",
			type: "post",
			data: param,
			dataType: "json",
			cache: false,
...
function update(){
	...
	Global.Dialog.showDialog("detailUpdate",{
		title:"下单材料类型批次明细——编辑",
		url:"${ctx}/admin/appItemTypeBatch/goDetailSave",
		postData:{code:$("#code").val(),confItemType:ret.ConfItemType,dispSeq:ret.DispSeq,expired:ret.Expired,m_umState:"M",keys:keys},
		height:310,
		width:450,
		returnFun : function(data){
			if(data){
