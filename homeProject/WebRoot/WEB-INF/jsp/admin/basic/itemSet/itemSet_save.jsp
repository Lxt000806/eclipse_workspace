...
function add(){
	...
	Global.Dialog.showDialog("itemSetadd",{			
		...
		postData:{itemtype1:item1,custType:$.trim($("#custType").val())},		 
		height: 600,
		width:1000,
...
function update(){
    ...
    if (ret) {
		...
		postData:{itemcode:ret.itemcode,unitprice:ret.unitprice,itemDescr:ret.itemcodedescr,itemtype1:item1,custType:$.trim($("#custType").val())},		 			 		  
		height:600,
		width:1000,
		returnFun:function(data){
...
function save(){
	...
	console.log(a);
	Global.Form.submit("dataForm","${ctx}/admin/itemSet/doitemSetSave",param,function(ret){
		if(ret.rs==true){
			art.dialog({
				content:ret.msg,
				time:1000,
