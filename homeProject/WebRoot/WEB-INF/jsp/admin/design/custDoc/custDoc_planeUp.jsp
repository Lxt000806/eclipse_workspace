	...
	<script type="text/javascript"> 
		$(function() {
			...
			$.extend(gridOption,{
				...
				postData:{custCode:"${customer.code}",docType1:"2",docType2:"3",custDocExpired:"F",type:"${type}"} ,
			});
			...
			$("#download").on("click",function(){
				...
				window.open("${ctx}/admin/custDoc/download?docNameArr="+docNameArr+"&docType2Descr="+"平面布置图JPG"+"&custCode="+custCode);
			});
		});

		function goto_query(){
			$("#dataTable").jqGrid("setGridParam",{postData:{custCode:"${customer.code}",docType1:"2",docType2:"3",custDocExpired:"F"},page:1,sortname:""}).trigger("reloadGrid");
		}
	</script>
</body>	
</html>
