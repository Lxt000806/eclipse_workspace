...
$(function() {
 			...
 			$.ajax({
			    ...
			    success: function(obj){
					if(obj==true){
						...
						$("#dataTable").jqGrid("setGridParam",{postData:{custCode:'${customer.code }',docType1:'3'},page:1,sortname:''}).trigger("reloadGrid");
						art.dialog({
							content:obj.msg,
							time:1500,
						});
	...
	$.extend(gridOption,{
		url:"${ctx}/admin/custDoc/goDocJqGrid",
		postData:{custCode:'${customer.code}',docType1:'3'} ,
	});
	...
	$("#download").on("click",function(){
		...
		window.open("${ctx}/admin/custDoc/download?docNameArr="+docNameArr+"&docType2Descr="+'软装资料'+"&custCode="+custCode);
	});
					...
					<input type="hidden" id="url" name="url" value="${url}" />
						...
						<ul class="ul-form">
							...
							<li>
								...
								<textarea id="remarks" name="remarks"  readonly="true" rows="2">${confirmRemark }</textarea>
	 						</li>
						</ul>	
				</form>
				</div>
