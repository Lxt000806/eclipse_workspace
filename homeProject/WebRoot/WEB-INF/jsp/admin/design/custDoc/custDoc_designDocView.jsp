				...
				<form action="" method="post" id="dataForm" class="form-search">
					...
					<input type="hidden" id="url" name="url" value="${url}" />
						<ul class="ul-form">
	                        ...
	                        <li>
	                            <label>效果图类型</label>
	                            <house:xtdm id="isFullColorDraw" dictCode="DRAWTYPE" value="${designPicPrg.isFullColorDraw}"
	                                        disabled="true"></house:xtdm>
	                        </li>
	                        <li>
	                            <label>普通效果图数量</label>
	                            <input type="text" id="drawQty" name="drawQty" value="${designPicPrg.drawQty}" readonly/>
	                        </li>
	                        <li>
	                            <label>3D效果图数量</label>
	                            <input type="text" id="draw3dQty" name="draw3dQty" value="${designPicPrg.draw3DQty}" readonly/>
	                        </li>
	                        <li>
	                           <label>图纸审核日期</label>
	                           <input type="text" name="confirmDate" value='<fmt:formatDate value="${designPicPrg.confirmDate}" pattern="yyyy-MM-dd HH:mm:ss"/>' readonly/>
	                        </li>
	                        <li>
	                           <label>图纸无变更</label>
	                           <house:xtdm id="drawNoChg" dictCode="YESNO" value="${designPicPrg.drawNoChg}" disabled="true"></house:xtdm>
	                        </li>
	                        <li>
	                           <label>图纸无变更日期</label>
	                           <input type="text" name="confirmDate" value='<fmt:formatDate value="${designPicPrg.drawNoChgDate}" pattern="yyyy-MM-dd HH:mm:ss"/>' readonly/>
	                        </li>
							<li>
