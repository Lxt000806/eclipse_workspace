...
$(function() {
 			...
 			$.ajax({
			    ...
			    success: function(obj){
					if(obj==true){
						...
						$("#dataTable").jqGrid("setGridParam",{postData:{custCode:'${customer.code }',docType1:'1'},page:1,sortname:''}).trigger("reloadGrid");
						art.dialog({
							content:obj.msg,
							time:1500,
						});
	...
	$("#download").on("click",function(){
		...
		window.open("${ctx}/admin/custDoc/download?docNameArr="+docNameArr+"&docType2Descr='合同资料'"+"&custCode="+custCode);
	});	
