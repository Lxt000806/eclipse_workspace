...
$(function() {
	...
	$("#code").openComponent_customer({callBack:getData,condition:{laborFeeCustStatus:"1,2,5",designChgDoc:"1"}});
	...
	$.extend(gridOption,{
		...
		postData:{custCode:"-1",docType1:"2",type:"${type}"} ,
	});
	...
	$("#add").on("click",function(){
		...
		Global.Dialog.showDialog("Add",{
			...
			postData:{custCode:$.trim($("#code").val()),docType1:'2',type:"${type }"},
			height:550,
			width:950,
	...
	$("#commitCheck").on("click",function(){
		...
		$.ajax({
			...
			type: 'post',
			data:{custCode:$.trim($("#code").val()),type:$.trim("${type }")},
			dataType: 'json',
			cache: false,
			error: function(obj){
				showAjaxHtml({"hidden": false, "msg": '保存数据出错~'});
				...
				<form action="" method="post" id="dataForm" class="form-search">
					...
					<ul class="ul-form">
						<li>
							...
							<input type="text" id="code" name="code" style="width:160px;" readonly="readonly"/>
						</li>
						<li >
							<label>楼盘</label>
							<input type="text" id="address" name="address" readonly="true" style="width:160px;" value=""/>
						</li>
					</ul>	
				</form>
			</div>
