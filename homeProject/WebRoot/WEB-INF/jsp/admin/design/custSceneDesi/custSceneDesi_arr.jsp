...
<head>
	...
	$(function(){
		...
		$("#custSceneDesi").openComponent_employee({showValue:"${customer.custSceneDesi}",showLabel:"${customer.custSceneDesiDescr}",condition:{SceneDesiCustCount:"1" ,department1:"${department1}",department2:"${department2}"}});	
		...
		$("#saveBtn").on("click",function(){
			...
			$.ajax({
				url:"${ctx}/admin/custSceneDesi/doSave",
				type: "post",
				data: {code:code,custSceneDesi:custSceneDesi},
				dataType: "json",
				cache: false,
				error: function(obj){
