...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable",{
		...
		colModel : [
			...
			{name: "descr", index: "descr", width: 90, label: "优惠项目标题", sortable: true, align: "left"},
			...
			{name: "discconfirmremarks", index: "discconfirmremarks", width: 190, label: "优惠审核说明", sortable: true, align: "left"},
	...
	$("#btnDiscConfirmRemarks").on("click",function(){
		var ret = selectDataTableRow();
		if (ret) {	
			Global.Dialog.showDialog("view",{ 
				title:"赠品项目——录入优惠审批说明",
				url:"${ctx}/admin/customerSghtxx/goDiscConfirmRemarks",
				postData:{pK:ret.pk,custCode:"${custCode}"},
				height: 300,
        	  	width:700,
				returnFun:goto_query
			...
			ok: function () {
				$.ajax({
					...
					success:function(obj){
						...
						$("#dataTableAll").jqGrid("setGridParam",{url:"${ctx}/admin/itemPlan/goCustGiftAllJqGrid",postData:$("#page_form_custGift").jsonForm(),page:1}).trigger("reloadGrid");
	...
	window.goto_query = function(){
		console.log($("#page_form").jsonForm());
	...
	<body>
		<div class="panel-body">
			<div class="query-form">
				<form role="form" class="form-search" id="page_form_custGift"  action="" method="post" target="targetFrame" >
		...
		<div class="btn-panel" >
    		<div class="btn-group-sm"  >
    			<house:authorize authCode="SGHTXX_DISCCONFIRMREMARKS">
						<button type="button" id="btnDiscConfirmRemarks" class="btn btn-system">录入优惠审批说明</button>
	             </house:authorize>
