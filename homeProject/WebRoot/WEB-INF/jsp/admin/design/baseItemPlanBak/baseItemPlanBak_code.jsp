	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			...
			colModel : [
				...
				{name :"basetempno",index : "basetempno",width : 80,label:'模板',sortable : true,align : "left"},
				{name :"basetempdescr",index : "basetempdescr",width : 80,label:'模板名称',sortable : true,align : "left"},
	...
	<div class="body-box-list">
		<div class="query-form">
			<form role="form" class="form-search" id="page_form" action="" method="post" target="targetFrame">
				...
				<input type="hidden" id="custCode" name="custCode"  value="${baseItemPlanBak.custCode}" />
				<input type="hidden" id="custType" name="custType"  value="${baseItemPlanBak.custType}" />
				<input type="hidden" id="isOutSet" name="isOutSet" value="${baseItemPlanBak.isOutSet}" />
				<ul class="ul-form">
					...
					<li class="search-group"><input type="checkbox" id="expired" name="expired"
						value="${baseItemPlanBak.expired}" onclick="hideExpired(this)" ${baseItemPlanBak.expired!='T' ?'checked':'' }/>
						<p>隐藏过期</p>
