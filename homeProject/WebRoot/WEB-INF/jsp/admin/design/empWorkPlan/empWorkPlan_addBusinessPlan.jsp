...
$(function() {
	...
	Global.JqGrid.initEditJqGrid("dataTable",{
		...
		colModel : [		
	      ...
	      {name : 'planaddcust',index : 'planaddcust',width : 120,label:'计划添加客户数',sortable : true,align : "right",editable:true,edittype:'text',editrules:{number:true,required:true},sum:true},	
	      {name : 'plancontactcust',index : 'plancontactcust',width : 120,label:'计划联系客户数',sortable : true,align : "right",editable:true,edittype:'text',editrules:{number:true,required:true},sum:true},	
...
function reloadJqGrid(){
	...
	var dataList = [
       {"id": "1", "date": planBeginDate, "week": "0","weekdescr": "星期一","planaddcust":"0","plancontactcust":"0","planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
       {"id": "2", "date": getAddDate(planBeginDate,1), "week": "1","weekdescr": "星期二","planaddcust":"0","plancontactcust":"0", "planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
       {"id": "3", "date": getAddDate(planBeginDate,2), "week": "2","weekdescr": "星期三","planaddcust":"0","plancontactcust":"0", "planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
       {"id": "4", "date": getAddDate(planBeginDate,3), "week": "3","weekdescr": "星期四","planaddcust":"0","plancontactcust":"0", "planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
       {"id": "5", "date": getAddDate(planBeginDate,4), "week": "4","weekdescr": "星期五","planaddcust":"0","plancontactcust":"0", "planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
       {"id": "6", "date": getAddDate(planBeginDate,5), "week": "5","weekdescr": "星期六","planaddcust":"0","plancontactcust":"0", "planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
       {"id": "7", "date": getAddDate(planBeginDate,6), "week": "6","weekdescr": "星期日","planaddcust":"0","plancontactcust":"0", "planmeasure": "0", "planarrive": "0", "planset": "0", "plansign": "0"},
	];
						...
						<ul class="ul-form">
							<div class="form-validate row">
								<li class="form-validate">
									<label >计划人类型</label>
									<house:xtdm id="planCzyType" dictCode="PLANCZYTYPE" value="1" disabled="true"></house:xtdm>                     
								</li>
								<li class="form-validate">
									<label >计划周</label>
									<select id="weekType" >
