...
<script type="text/javascript">
 //校验函数
$(function() {	
	$("#custCode").openComponent_customer({showLabel:"${custLoan.custDescr}",showValue:"${custLoan.custCode}",disabled:true, callBack: getData});
...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/custLoan/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
