...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTableAll",{
		...
		styleUI: 'Bootstrap', 
		colModel : [
			{name: "itemType1", index: "itemType1", width: 120, label: "优惠分类", sortable: true, align: "left",hidden:true},
			{name: "descr", index: "descr", width: 120, label: "优惠分类", sortable: true, align: "left"},
				...
				<form role="form" class="form-search" id="dataForm"  action="" method="post" target="targetFrame" >
					...
					<ul class="ul-form">
						...
						<li>
							...
							<input type="text" id="swzsyjkj" name="swzsyjkj" style="width:160px;"/>
						</li>
						<li>
							<label>软装券业绩扣减</label>
							<input type="text" id="rzqyjkj" name="rzqyjkj" style="width:160px;"/>
						</li>
						<li>
							<label>使用优惠额度</label>
