					...
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							...
							<div class="validate-group row">
								<li class="form-validate">
									<label>长</label>
									<input type="text" id="length" name="length" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" style="width:160px;" value="0"/>
								</li>
								<li class="form-validate">
									<label>高</label>
									<input type="text" id="height" name="height" onkeyup="value=value.replace(/[^\-?\d.]/g,'')" style="width:160px;" value="2.1"/>
								</li>
							</div>
						</ul>
					</form>
