...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable",{
		url:"${ctx}/admin/itemPlan/goProcListJqGrid",
		...
		colModel : [
			{name : 'wfprocinstno',index : 'wfprocinstno',width : 150,label:'wfprocinstno',sortable : true,align : "left", hidden: true},
		  	{name : 'empcode',index : 'empcode',width : 120,label:'员工编号',sortable : true,align : "left", hidden: true},
		  	...
		  	{name : 'starttime',index : 'starttime',width : 130,label:'申请时间',sortable : true,align : "left", formatter: formatTime},
		  	{name : 'address',index : 'address',width : 130,label:'楼盘地址',sortable : true,align : "left",},
		  	{name : 'contractfee',index : 'contractfee',width : 70,label:'工程造价',sortable : true,align : "left",},
		  	{name : 'discountremarks',index : 'discountremarks',width : 200,label:'优惠说明',sortable : true,align : "left",},
		  	{name : 'manageritems',index : 'manageritems',width : 200,label:'总经理审批条款',sortable : true,align : "left",},
		  	{name : 'presidentitems',index : 'presidentitems',width : 200,label:'总裁审批条款',sortable : true,align : "left",},
		  	{name : 'remarks',index : 'remarks',width : 200,label:'备注',sortable : true,align : "left",},
		  	{name : 'approveline',index : 'approveline',width : 200,label:'审批人',sortable : true,align : "left", hidden: true},
		...
		onSelectRow : function(id) {
        	...
        	var elMaps = {ApproveLine: $.trim(row.approveline)};
