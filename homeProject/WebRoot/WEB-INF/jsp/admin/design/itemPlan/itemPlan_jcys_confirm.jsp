...
function loadFee(rowData,baseFeeComp){
	...
	var manageFee=myRound(manageFeeBase+${customer.manageFeeMain}*${customer.containMain}+${customer.manageFeeInt}*${customer.containInt}
				+${customer.manageFeeServ}*${customer.containMainServ}+${customer.manageFeeSoft}*${customer.containSoft}+${customer.manageFeeCup}*${customer.containCup});//管理费
...
function add(isInsert){
	...
	var url="${ctx}/admin/itemPlan/goJzysQuickSave?custCode=${customer.code}&itemType1=JZ&custTypeType=1&m_umState=C&custType=${customer.custType}&canUseComBaseItem=${custType.canUseComBaseItem}"+baseItemType1Str;
	if(ret) url="${ctx}/admin/itemPlan/goJzysQuickSave?custCode=${customer.code}&itemType1=JZ&custTypeType=1&m_umState=C&custType=${customer.custType}&canUseComBaseItem=${custType.canUseComBaseItem}&fixAreaPk="+ret.fixareapk+baseItemType1Str;
...
function edit(){
    ...
    if (rowId) {
       Global.Dialog.showDialog("jcys_detailViewEdit",{
		   title:"基础预算--编辑",
		   url:"${ctx}/admin/itemPlan/goItemPlan_jcys_detailViewEdit?itemType1=JZ&custCode=${customer.code}&custTypeType=1&m_umState=C&custType=${customer.custType}&canUseComBaseItem=${custType.canUseComBaseItem}&rowId="+rowId,
		   height:600,
		   width:1000,
		   resizable:false, 
		   returnFun: function(data){
...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable",{
		...
		colModel : [
			...
			{name: "isoutsetdescr", index: "isoutsetdescr", width: 0.01, label: "套外", sortable: true, align: "left"},
...
//基础预算从模板导入
 function goBaseFromTemp(){
	    Global.Dialog.showDialog("baseitemPlan_baseFromTemp",{
		title:"基础预算--从模板导入",
	...
	<div class="body-box-form">
		...
		<div class="btn-panel">
			<div class="btn-group-sm">
				...
				<button type="button" id="baseFromTempBtn" class="btn btn-system " onclick="goBaseFromTemp()" >从模板导入</button>
