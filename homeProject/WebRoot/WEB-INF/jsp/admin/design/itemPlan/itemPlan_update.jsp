...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/itemPlan/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
				...
				<table cellspacing="0" cellpadding="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${itemPlan.expired}" onclick="checkExpired(this)" ${itemPlan.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
