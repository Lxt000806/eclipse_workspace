...
<html>
<head>
	<title>修改ItemPlanTempDetail</title>
...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/itemPlanTempDetail/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
				...
				<table cellspacing="0" cellpadding="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${itemPlanTempDetail.expired}" onclick="checkExpired(this)" ${itemPlanTempDetail.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
