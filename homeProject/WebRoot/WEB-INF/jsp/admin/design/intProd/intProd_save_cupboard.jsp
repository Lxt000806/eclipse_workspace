...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#descr").focus();
		onFixAreaChange($("#fixAreaPk").get(0));
	});
	            ...
	            <ul class="ul-form">
	                <div class="validate-group row">
	                    <div class="col-sm-4">
	                        <li class="form-validate ">
	                            ...
	                            <house:DataSelect id="fixAreaPk"
	                                              className="FixArea" keyColumn="pk" valueColumn="descr"
	                    ...
	                    <div class="col-sm-4">
	                        <li class="form-validate ">
	                            <label>集成成品名称 </label>
	                            <input type="text" id="descr" name="descr" value="${intProd.descr}"/>
	                        </li>
	                    </div>
	                    <div class="col-sm-4">
                            <li class="form-validate">
