...
$(function() {
	...
	Global.LinkSelect.setSelect({firstSelect:'source',firstValue:'3',});
						...
						<ul class="ul-form">
							...
							<div class="validate-group row" >
								...
								<li class="form-validate">
                                    ...
                                    <house:xtdm id="custKind" dictCode="CUSTKIND" value="" unShowValue="0"></house:xtdm>      
                                </li>
							</div>
							<div class="validate-group row" >
								<li class="form-validate">
							...
							<div class="validate-group row" >
								...
								<li class="form-validate">
									<label>派单时间</label>
									<input type="text" id="dispatchDate" name="dispatchDate" class="i-date" value="<fmt:formatDate value='${resrCust.crtDate}' pattern='yyyy-MM-dd HH:mm:ss' />" readonly/>
								</li>
								<li class="form-validate">
									<label>创建人</label>
