...
$(function(){
	...
	$("#saveBtn").on("click",function(){
	    ...
	    $.ajax({
			...
			type:'post', 
			data:{dataStering:json.detailJson,showType:$("#showType").val(),stakeholder:$("#newStakeholder").val()},
			dataType:'json',
			cache:false,
			error:function(obj){
					...
					<ul class="ul-form">
						<li>
							...
							<select id="showType" name="showType" style="width:160px">
								<option value="1" selected>设计师</option>
						...
						<li>
							<label>客户状态</label>
							<house:xtdmMulit id="status" dictCode="" sql="select cbm SQL_VALUE_KEY,note SQL_LABEL_KEY from tXTDM where ID='CUSTOMERSTATUS'   " ></house:xtdmMulit>
						</li>
						<li>
							<label>改后干系人</label>
