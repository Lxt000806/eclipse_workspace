...
<head>
	...
	$(function() {
		$("#custCode").openComponent_customer({callBack:validateRefresh,showValue:"${custStakeholder.custCode}",showLabel:"${customer.descr}"});	
		$("#empCode").openComponent_employee({callBack:validateRefresh,showValue:"${custStakeholder.empCode}",showLabel:"${employee.nameChi}"});	
		$("#role").openComponent_roll({callBack:validateRefresh,showValue:"${custStakeholder.role}",showLabel:"${roll.descr}"});	
	...
	$(function(){
		...
		$("#saveBtn").on("click",function(){
			...
			$.ajax({
				url:"${ctx}/admin/custStakeholder/doCopy",
				type: "post",
				data: datas,
				dataType: "json",
				cache: false,
