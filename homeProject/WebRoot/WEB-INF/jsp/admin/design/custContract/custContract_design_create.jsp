					...
					<input type="hidden" id="pk" name="pk" style="width:160px;" value="${data.pk}"/>
						<ul class="ul-form">
							...
							<div class="validate-group row" >
								<li class="form-validate">
									<label>业务员</label>
									<input type="text" style="width:160px;" id="businessMan" name="businessMan" value="${data.businessMan }" readonly/>
								</li>
								<li class="form-validate">
									<label>翻单员</label>
									<input type="text" style="width:160px;" id="againMan" name="againMan" value="${data.againMan }" readonly/>
								</li>
							</div><br>
							...
							<div class="validate-group row" >
								<li class="form-validate">
									<label><span class="required">*</span>设计定金</label>
									<input type="text"  id="prepay" name="prepay" value="${data.prePay }" />
								</li>
								<li>
							...
							<div class="validate-group row" >
								<li>
									<label>出平面方案天数</label>
									<input type="text"  id="planeDrawDay" name="planeDrawDay" value="${data.planeDrawDay }" 
									onkeyup="this.value =this.value.replace(/\s/g,'').replace(/[^\.\d]/g,'');"/>
								</li>
								<li>
									<label>出完整图纸天数</label>
									<input type="text"  id="fullDrawDay" name="fullDrawDay" value="${data.fullDrawDay }" 
									onkeyup="this.value =this.value.replace(/\s/g,'').replace(/[^\.\d]/g,'');"/>
								</li>
							</div> 
							<div class="validate-group row" >
								<li>
									<label>设计风格</label>
									<house:xtdm id="designStyle" dictCode="DESIGNSTYLE" value="${data.designStyle }" ></house:xtdm>                     
								</li>
								<li>
									<label>施工方式</label>
									<house:xtdm id="constructType" dictCode="CONSTRUCTTYPE" value="${data.constructType }" ></house:xtdm>                     
								</li>
							</div> 
							<div class="validate-group row" >
								<li>
								...
								<li>
									<label>入住时间</label>
									<input type="text" id="expectMoveIntoDate" name="expectMoveIntoDate" class="i-date" 
										value="<fmt:formatDate value='${data.expectMoveIntoDate}' pattern='yyyy-MM-dd'/>"  
										onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
								</li>
							</div> 
							<div class="validate-group row" >
								<li>
									<label>意向造价</label>
									<input type="text"  id="planAmount" name="planAmount" value="${data.planAmount }" 
									style="width:135px"
									onkeyup="this.value =this.value.replace(/\s/g,'').replace(/[^\.\d]/g,'');"/>万元
								</li>
							</div>
						</ul>
				</form>
