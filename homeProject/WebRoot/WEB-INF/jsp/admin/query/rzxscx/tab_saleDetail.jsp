...
$(function(){
	...
	var gridOption = {
		url:"${ctx}/admin/rzxscx/goSaleDetailJqGrid",
		postData:postData,
		...
		colModel : [
			...
			{name: "intproddescr", index: "intproddescr", width: 75, label: "集成成品", sortable: true, align: "left",hidden:'JC'!='${itemChg.itemType1}'?true:false},
		...
		gridComplete:function(){
			var total=0;
			var markup = Global.JqGrid.allToJson("dataTable_saleDetail","markup");
			arr = markup.fieldJson.split(",");	
			for(var i = 0;i < arr.length; i++){
				total=total+parseInt(arr[i]);
			}
			if(total>=0){
	   	  		$("#dataTable_saleDetail").footerData("set",{"markup":total/arr.length+"%"},false);
			}
		}
		
	};
	Global.JqGrid.initJqGrid("dataTable_saleDetail",gridOption);
...
<div class="body-box-list" style="margin-top:0px;">
	<div id="content-list">
		<table id="dataTable_saleDetail" style="overflow: auto;"></table>
	</div>
</div>
