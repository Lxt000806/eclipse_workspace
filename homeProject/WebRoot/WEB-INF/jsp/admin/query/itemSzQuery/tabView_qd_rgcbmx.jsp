...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_rgcbmx_qd",{
        autowidth: false,
        height:510,
		width:1259, 
		styleUI: 'Bootstrap',
		...
		colModel : [
			...
			{name: "remarks", index: "remarks", width: 200, label: "请款说明", sortable: true, align: "left"},
			{name: "confirmremark", index: "confirmremark", width: 200, label: "审批说明", sortable: true, align: "left"},
			...
			{name: "iscalprojectcostdescr", index: "iscalprojectcostdescr", width: 90, label: "计项目经理成本", sortable: true, align: "left"},
...
<table id="dataTable_rgcbmx_qd"></table>
