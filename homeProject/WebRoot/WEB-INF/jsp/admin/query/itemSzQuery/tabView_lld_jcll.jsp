...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_lld_jcll",{
		url:"${ctx}/admin/itemSzQuery/goLldJqGrid",
		postData:{custCode:$("#code").val(),type:"JC"},
        autowidth: false,
        height:205,
		width:1300, 
		styleUI: 'Bootstrap',
		...
		colModel : [
			...
			{name: "isCupboardDescr", index: "isCupboardDescr", width: 60, label: "橱柜", sortable: true, align: "left"},
			...
			{name: "projectothercost", index: "projectothercost", width: 124, label: "项目经理其它费用", sortable: true, align: "right", sum: true},
        ...
        beforeSelectRow:function(rowid, e){
			var ret = $("#dataTable_lld_jcll").jqGrid("getRowData",rowid);
			if(ret){
...
<table id="dataTable_lld_jcll"></table>
