...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_lld_zcll",{
		url:"${ctx}/admin/itemSzQuery/goLldJqGrid",
		postData:{custCode:$("#code").val(),type:"ZC"},
        autowidth: false,
        height:205,
		width:1300, 
		styleUI: 'Bootstrap',
		...
		colModel : [
			...
			{name: "projectothercost", index: "projectothercost", width: 119, label: "项目经理其它费用", sortable: true, align: "right", sum: true},
        ...
        beforeSelectRow:function(rowid, e){
			var ret = $("#dataTable_lld_zcll").jqGrid("getRowData",rowid);
			if(ret){
				$("#dataTable_lld_llmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goLldLlmxJqGrid",postData:{custCode:$("#code").val(),no:ret.no,},page:1}).trigger("reloadGrid");
			}
        }
...
<table id="dataTable_lld_zcll"></table>
