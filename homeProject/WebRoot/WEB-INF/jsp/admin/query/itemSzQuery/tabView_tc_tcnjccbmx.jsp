...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_tcnjccbmx",{
		url:"${ctx}/admin/itemSzQuery/goTcnclcbmxJqGrid",
		postData:{custCode:$("#code").val(),itemType1:"JC"},
        autowidth: false,
        height:220,
		width:1259, 
		styleUI: 'Bootstrap',
		...
		colModel : [
			...
			{name: "amount", index: "amount", width: 90, label: "材料成本", sortable: true, align: "right", sum: true}
        ],
        gridComplete:function(){	
        	var id = $("#dataTable_tcnjccbmx").jqGrid("getGridParam", "selrow");
		    if (id) {
		      var ret = $("#dataTable_tcnjccbmx").jqGrid("getRowData",id);
        ...
        beforeSelectRow:function(rowid, e){
        	var ret = $("#dataTable_tcnjccbmx").jqGrid("getRowData",rowid);
        	$("#dataTable_llmx_tcnjccbmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goLlmxJqGrid",postData:{no:ret.no.trim(),custCode:$("#code").val()},page:1}).trigger("reloadGrid");
        }
	});
});
...
<table id="dataTable_tcnjccbmx"></table>

<jsp:include page="tabView_llmx.jsp">
	<jsp:param value="tcnjccbmx" name="fromTcnjccbmx"/>
</jsp:include>
