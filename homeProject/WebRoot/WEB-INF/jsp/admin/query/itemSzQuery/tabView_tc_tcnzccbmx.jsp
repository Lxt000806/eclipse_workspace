...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_tcnzccbmx",{
		url:"${ctx}/admin/itemSzQuery/goTcnclcbmxJqGrid",
		postData:{custCode:$("#code").val(),itemType1:"ZC"},
        autowidth: false,
        height:220,
		width:1259, 
		styleUI: 'Bootstrap',
        ...
        gridComplete:function(){	
        	var id = $("#dataTable_tcnzccbmx").jqGrid('getGridParam', 'selrow');
		    if (id) {
		      var ret = $("#dataTable_tcnzccbmx").jqGrid("getRowData",id);
        ...
        beforeSelectRow:function(rowid, e){
        	var ret = $("#dataTable_tcnzccbmx").jqGrid("getRowData",rowid);
        	$("#dataTable_llmx_tcnzccbmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goLlmxJqGrid",postData:{no:ret.no.trim(),custCode:$("#code").val()},page:1}).trigger("reloadGrid");
        }
	});
});
...
<table id="dataTable_tcnzccbmx"></table>

<jsp:include page="tabView_llmx.jsp">
	<jsp:param value="tcnzccbmx" name="fromTcnzccbmx"/>
</jsp:include>
