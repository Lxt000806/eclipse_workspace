...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_clzj_jczj",{
        ...
        gridComplete:function(){
			...
			var ret = selectDataTableRow("dataTable_clzj_jczj");
			if(ret){
        ...
        beforeSelectRow:function(rowid, e){
			var ret = $("#dataTable_clzj_jczj").jqGrid("getRowData",rowid);
			if(ret){
				$("#dataTable_clzj_zjmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goClzjZjmxJqGrid",postData:{no:ret.no,},page:1}).trigger("reloadGrid");
			}
        }
...
<table id="dataTable_clzj_jczj"></table>
