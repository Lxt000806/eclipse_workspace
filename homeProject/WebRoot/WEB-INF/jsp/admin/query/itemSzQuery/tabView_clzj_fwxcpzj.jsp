...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_clzj_fwxcpzj",{
		url:"${ctx}/admin/itemSzQuery/goClzjJqGrid",
		postData:{custCode:$("#code").val(),type:"FWXCP"},
        autowidth: false,
        height:205,
		width:1300, 
		styleUI: 'Bootstrap',
        ...
        gridComplete:function(){
			...
			var ret = selectDataTableRow("dataTable_clzj_fwxcpzj");
			if(ret){
        ...
        beforeSelectRow:function(rowid, e){
			var ret = $("#dataTable_clzj_fwxcpzj").jqGrid("getRowData",rowid);
			if(ret){
				$("#dataTable_clzj_zjmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goClzjZjmxJqGrid",postData:{no:ret.no,},page:1}).trigger("reloadGrid");
			}
        }
...
<table id="dataTable_clzj_fwxcpzj"></table>
