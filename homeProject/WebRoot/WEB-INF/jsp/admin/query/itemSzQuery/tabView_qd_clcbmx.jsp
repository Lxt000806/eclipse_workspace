...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_clcbmx",{
        autowidth: false,
        height:220,
		width:1259, 
		styleUI: 'Bootstrap',
        ...
        gridComplete:function(){	
        	var id = $("#dataTable_clcbmx").jqGrid('getGridParam', 'selrow');
		    if (id) {
		      var ret = $("#dataTable_clcbmx").jqGrid("getRowData",id);
		      $("#dataTable_llmx_clcbmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goLlmxJqGrid",postData:{no:ret.no.trim(),custCode:$("#code").val()},page:1}).trigger("reloadGrid");
		       	
		    }
        },
        beforeSelectRow:function(rowid, e){
        	var ret = $("#dataTable_clcbmx").jqGrid("getRowData",rowid);
        	$("#dataTable_llmx_clcbmx").jqGrid("setGridParam",{url:"${ctx}/admin/itemSzQuery/goLlmxJqGrid",postData:{no:ret.no.trim(),custCode:$("#code").val()},page:1}).trigger("reloadGrid");
        }
	});
});
...
<table id="dataTable_clcbmx"></table>

<jsp:include page="tabView_llmx.jsp">
	<jsp:param value="clcbmx" name="fromClcbmx"/>
</jsp:include>
