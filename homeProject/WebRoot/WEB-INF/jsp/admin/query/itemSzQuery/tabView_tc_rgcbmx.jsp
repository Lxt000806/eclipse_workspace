...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_rgcbmx_tc",{
        autowidth: false,
        height:510,
		width:1259, 
		styleUI: 'Bootstrap',
		...
		colModel : [
			...
			{name: "confirmremark", index: "confirmremark", width: 170, label: "审批说明", sortable: true, align: "left"},
...
<table id="dataTable_rgcbmx_tc"></table>
