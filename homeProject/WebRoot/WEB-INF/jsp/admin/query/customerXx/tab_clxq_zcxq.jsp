...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_clxq_${param.itemType1}_${param.isService}",{
			...
			colModel : [
					...
					{name : 'supplpromdescr',index : 'supplpromdescr',width : 75,label:'促销活动',sortable : true,align : "left"},
...
function goto_query_zcxq(tableId){
	...
	$("#"+tableId).jqGrid("setGridParam",{postData:{itemType2:itemType2,fixareadescr:fixareadescr,itemdescr:itemdescr,intproddescr:intproddescr},page:1}).trigger("reloadGrid");
}
//查看小计
