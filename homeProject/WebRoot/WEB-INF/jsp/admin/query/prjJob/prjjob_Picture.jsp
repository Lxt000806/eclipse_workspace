...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable_material",{
		url:"${ctx}/admin/prjJob/gojcclPictureListJqGrid",
		postData:{prjJobNo:$("#no").val()},
		height:200,
		width:250,
		styleUI:'Bootstrap',
		rowNum:10000,
...
function refresh(){
	$("#dataTable_material").jqGrid("setGridParam",{url:"${ctx}/admin/prjJob/gojcclPictureListJqGrid",postData:{no:$("#no").val()},page:1}).trigger("reloadGrid");
}
function next(){
	var arry = getPhotoNameList();
