...
function doExcel(){
    if ($("ul li a[href='#tab1']").parent().hasClass("active")){
			var url = "${ctx}/admin/dispatchCenterKPI/doExcelBeginDetail";
	    doExcelAll(url,'beginDataTable');
	}else if  ($("ul li a[href='#tab2']").parent().hasClass("active")){
			var url = "${ctx}/admin/dispatchCenterKPI/doExcelCheckDetail";
	    doExcelAll(url,'checkDataTable');
	}	
...
$(function(){ 
	...
	Global.JqGrid.initJqGrid("beginDataTable",{
			url:"${ctx}/admin/dispatchCenterKPI/goJqGridBeginDetail",
	 ...
	 Global.JqGrid.initJqGrid("checkDataTable",{
			url:"${ctx}/admin/dispatchCenterKPI/goJqGridCheckDetail",
			postData:$("#page_form").jsonForm(),
			height:500-$("#content-list2").offset().top-70,
			styleUI: 'Bootstrap',
			autowidth:false,
			...
			colModel : [
			  ...
			  {name : 'rzcheckamount',index : 'rzcheckamount',width : 90,label:'软装结算额',sortable : true,align : "right"},
	...
	<div class="body-box-form">
		...
		<div  class="container-fluid" >  
		     <ul class="nav nav-tabs" >
		        ...
		        <li id="tab2_li"  class=""><a href="#tab2" data-toggle="tab">结算明细</a></li>
		    ...
		    <div class="tab-content">  
				...
				<div id="tab2"  class="tab-pane fade " > 
					<div id="content-list2">
					  <table id= "checkDataTable" ></table>
					   <div id="checkDataTablePager"></div>
				   </div> 
				</div>
			</div>	
		</div>
