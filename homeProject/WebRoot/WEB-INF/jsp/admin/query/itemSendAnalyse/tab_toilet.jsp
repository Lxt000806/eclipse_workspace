...
$(function(){
	postData.itemType="4";
	Global.JqGrid.initJqGrid("dataTable_toilet",{
		...
		gridComplete:function(){
			var needSum1 = $("#dataTable_toilet").getCol("allweight",false,"sum");
			$("#dataTable_toilet").footerData("set",{"allweight":myRound(needSum1,2)});
		}
	});
...
<body>
	<div class="body-box-list">
		<div id="content-list">
			<table id= "dataTable_toilet"></table>
		</div>
	</div>
</body>	
</html>
