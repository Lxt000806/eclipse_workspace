...
$(function(){
	...
	postData.itemType="1";
	Global.JqGrid.initJqGrid("dataTable_tile",{
		...
		gridComplete:function(){
			var needSum = $("#dataTable_tile").getCol("qty",false,"sum");
			$("#dataTable_tile").footerData("set",{"qty":myRound(needSum,2)});
			var needSum1 = $("#dataTable_tile").getCol("allweight",false,"sum");
			$("#dataTable_tile").footerData("set",{"allweight":myRound(needSum1,2)});
		}
	});
