...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable_floor",{
		...
		gridComplete:function(){
			var needSum1 = $("#dataTable_floor").getCol("allweight",false,"sum");
			$("#dataTable_floor").footerData("set",{"allweight":myRound(needSum1,2)});
			var needSum2 = $("#dataTable_floor").getCol("qty",false,"sum");
			$("#dataTable_floor").footerData("set",{"qty":myRound(needSum2,2)});
		}
	});
