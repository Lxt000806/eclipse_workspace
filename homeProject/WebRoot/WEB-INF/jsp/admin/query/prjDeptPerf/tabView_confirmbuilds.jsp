...
$(function(){
	Global.JqGrid.initJqGrid("dataTable_confbuilds",{
		url:"${ctx}/admin/PrjDeptPerf/goConfBuildsJqGrid",
		postData:{empCode:$("#empCode").val(),dateFrom:$("#dateFrom").val(),dateTo:$("#dateTo").val(),custType:$("#custType").val()},
        autowidth: false,
        rowNum:10000000,
        height:400,
		width:800, 
...
<table id="dataTable_confbuilds"></table>
