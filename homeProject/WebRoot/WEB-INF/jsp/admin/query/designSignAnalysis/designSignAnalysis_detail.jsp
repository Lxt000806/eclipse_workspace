...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_clzj",{
			url:"${ctx}/admin/designSignAnalysis/goDetailJqGrid",
			postData:{
				designMan:'${customer.designMan}',
			...
			colModel : [
				...
				{name: "DesignSignTimes", index: "DesignSignTimes", width: 100, label: "应签到天数", sortable: true, align: "right", sum: true},
            ...
            onSelectRow : function(id) {
            	...
            	$("#dataTable_clzj_mx").jqGrid('setGridParam',{url : "${ctx}/admin/designSignAnalysis/goDetailDetailJqGrid?code="+row.CustCode+"&prjItem="+row.PrjItem});
