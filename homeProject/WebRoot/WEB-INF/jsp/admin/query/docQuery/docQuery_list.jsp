...
$(function(){
	...
	Global.JqGrid.initJqGrid("dataTable",{
		...
		colModel : [
			...
			{name: "filedczydescr", index: "filedczydescr", width: 70, label: "归档人", sortable: true, align: "left"},
			{name: "fileddate", index: "fileddate", width: 75, label: "归档时间", sortable: true, align: "left",formatter:formatDate},
			...
			{name: "isneednoticedescr", index: "isneednoticedescr", width: 68, label: "消息通告", sortable: true, align: "left",hidden:true},
	...
	$("#update").on("click",function(){
		...
		Global.Dialog.showDialog("goUpdate",{
			title:"档案管理——编辑",
			postData:{pk:ret.pk},
			url:"${ctx}/admin/docQuery/goUpdate",
			height:720,
			width:1230,
	...
	$("#viewFiledDoc").on("click",function(){
		...
		Global.Dialog.showDialog("viewFiledDoc",{
			title:"档案管理——查看归档文档",
			postData:{pk:ret.pk},
			url:"${ctx}/admin/docQuery/goViewFiledDoc",
			height:740,
			width:1150,
			returnFun:goto_query
		});		
				...
				<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
					...
					<ul class="ul-form">
						...
						<li >
							...
							<house:xtdm id="status" dictCode="DOCSTATUS" style="width:120px;"></house:xtdm>
						</li>
		...
		<div class="pageContent" style="width:83%;float:right;border-left:1px solid rgb(224,231,234)">
			<div class="btn-panel">
				<div class="btn-group-sm">
					<house:authorize authCode="DOCQUERY_DEPRLIST">
						<button type="button" class="btn btn-system" id="viewFiledDoc">
							<span>查看已归档文档</span>
						</button>
					</house:authorize>
					<house:authorize authCode="DOCQUERY_EXCEL">
