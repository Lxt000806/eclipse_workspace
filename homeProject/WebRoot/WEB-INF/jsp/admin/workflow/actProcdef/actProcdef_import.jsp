...
$(function(){
	$("#easyContainer").easyUpload({
		...
		url: "${ctx}/admin/actProcdef/importProcdef",//上传文件地址
...
<div class="body-box-form" >
	...
	<div class="panel panel-info" >  
		<div class="panel-body"> 
			<form id="uploadForm" role="form" class="form-search" >
				<house:token></house:token>
				<div>
				    <ul class="ul-form">
                        <li>
                            <label>部署说明</label>
                            <input type="text" id="deploymentName" name="deploymentName" style="width: 500px;"/>
                        </li>
                    </ul>
				</div>
