...
$(function() {
	...
	$("#saveBtn").on("click",function(){
		...
		$.ajax({
			url:"${ctx}/admin/fixArea/insertFixArea",
			type: "post",
			data: datas,
			dataType: "json",
			cache: false,
			...
			<div class="panel panel-info">  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" name="dispSeq" id="dispSeq" value="${baseItemChg.dispSeq }"/>
						<input type="hidden" name="prePlanAreaDescr" id="prePlanAreaDescr" value=""/>
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required" id= "prePlanAreaDescr">*</span>对应空间</label>
									<input type="text" id="prePlanAreaPK" name="prePlanAreaPK" style="width:160px;"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required" id= "prePlanAreaDescr">*</span>区域名称</label>
