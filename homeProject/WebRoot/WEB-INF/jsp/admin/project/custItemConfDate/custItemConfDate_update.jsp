...
<html>
<head>
	<title>修改CustItemConfDate</title>
...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/custItemConfDate/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
				...
				<table cellspacing="0" cellpadding="0" width="100%">
					...
					<tbody>
						<tr>	
							...
							<td class="td-value">
							<input type="text" id="custCode" name="custCode" style="width:160px;"  value="${custItemConfDate.custCode}" readonly="readonly"/>
							</td>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${custItemConfDate.expired}" onclick="checkExpired(this)" ${custItemConfDate.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
