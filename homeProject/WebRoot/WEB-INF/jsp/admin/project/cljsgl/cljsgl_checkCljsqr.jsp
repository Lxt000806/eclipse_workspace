...
<head>
	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			...
			colModel : [
			  	{name: "itemtype1descr", index: "itemtype1descr", width: 80, label: "材料类型1", sortable: true,align:"left",count:true},
				{name: "itemtype12", index: "itemtype12", width: 80, label: "材料分类编码", sortable: true, align: "left", hidden: true},
				{name: "itemtype12descr", index: "itemtype12descr", width: 80, label: "材料分类", sortable: true, align: "left"},
		...
		<div class="panel panel-system" >
		    <div class="panel-body" >
		      <div class="btn-group-xs" >
		      	<button type="button" id="saveBtn" class="btn btn-system" onclick="save()">结算确认</button>
