      ...
      <div class="btn-group-xs" >
		...
		<div class="container-fluid" >  
			<ul class="nav nav-tabs" > 
		        <li class="active"><a href="#tab_prjProg" data-toggle="tab">工程进度</a></li>
		        <li class=""><a href="#tab_prjJD" data-toggle="tab">工种施工进度</a></li>
<!-- 		        <li class=""><a href="#tab_constructionPicture" data-toggle="tab">施工图片</a></li>
 -->		    <li class=""><a href="#tab_PictureXJ" data-toggle="tab">工地巡检</a></li>
		        <li class=""><a href="#tab_PictureYS" data-toggle="tab">工地验收</a></li>
		        <li class=""><a href="#tab_prjBuilderRep" data-toggle="tab">工地报备</a></li>
		        <li class=""><a href="#tab_CustComplaint" data-toggle="tab">客户投诉</a></li>
		    </ul> 
