...
<body>
      ...
      <div class="btn-group-xs" >
         ...
         <div class="panel-body">
			...
			<input type="hidden" name="m_umState" id="m_umState" value="A"/>
							...
							<li>
								<label>客户评分</label>
								<input type="text" id="custScoreConfirm" name="custScoreConfirm" style="width:160px;" value="${prjProgCheck.custScoreCheck}"  readonly="readonly"/>
							</li>
							<li>
								<label class="control-textarea">客户评价</label>
								<textarea id="custRemarks" style="width:160px" name="custRemarks" rows="2">${prjProgCheck.custRemarks }</textarea>
 							</li>
							<li>
	...
	<div style="width:58%; height:560px ; float: right;margin-left: apx; " >
		<div class="container-fluid">  
			<ul class="nav nav-tabs"  > 
		        <li class="active"><a href="#tab_xjPicture" data-toggle="tab">巡检图片</a></li>
		        <li class=""><a href="#tab_zgPicture" data-toggle="tab">整改图片</a></li>
		    </ul> 
		    <div class="tab-content" >  
		        <div id="tab_xjPicture" class="tab-pane fade in active"> 
		         	<jsp:include page="tab_xjPicture.jsp"></jsp:include>
		        </div> 
		        <div id="tab_zgPicture" class="tab-pane fade"> 
