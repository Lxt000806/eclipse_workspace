...
var x=-1;
	...
	/**初始化表格*/
        ...
        $("#viewPicture_ys").on("click",function(){
			...
			if(ret){
			Global.Dialog.showDialog("viewPicture",{
				title:"施工图片",
				url:"${ctx}/admin/prjProg/goPicture?photoName="+ret.photoname,
				height:700,
				width:1000,
			});
			}else{
		 ...
		 //查看图片
        $("#viewPicture_zg").on("click",function(){
