...
function add(){
	Global.Dialog.showDialog("confItemTypeDtAdd",{
		  title:"添加ConfItemTypeDt",
		  url:"${ctx}/admin/confItemTypeDt/goSave",
		  height: 600,
		  width:1000,
...
function update(){
    ...
    if (ret) {
      Global.Dialog.showDialog("confItemTypeDtUpdate",{
		  title:"修改ConfItemTypeDt",
		  url:"${ctx}/admin/confItemTypeDt/goUpdate?id="+ret.PK,
		  height:600,
		  width:1000,
		  returnFun: goto_query
		});
...
function copy(){
	var ret = selectDataTableRow();
    if (ret) {
      Global.Dialog.showDialog("confItemTypeDtCopy",{
		  title:"复制ConfItemTypeDt",
		  url:"${ctx}/admin/confItemTypeDt/goSave?id="+ret.PK,
		  height:600,
		  width:1000,
		  returnFun: goto_query
		});
...
function view(){
	var ret = selectDataTableRow();
    if (ret) {
      Global.Dialog.showDialog("confItemTypeDtView",{
		  title:"查看ConfItemTypeDt",
		  url:"${ctx}/admin/confItemTypeDt/goDetail?id="+ret.PK,
		  height:600,
		  width:1000
		});
    } else {
...
function del(){
	var url = "${ctx}/admin/confItemTypeDt/doDelete";
	beforeDel(url);
}
//导出EXCEL
function doExcel(){
	$.form_submit($("#page_form").get(0), {
		"action": "${ctx}/admin/confItemTypeDt/doExcel"
	});
}
/**初始化表格*/
$(function(){
		Global.JqGrid.initJqGrid("dataTable",{
			url:"${ctx}/admin/confItemTypeDt/goJqGrid",
			multiselect: true,
			...
			colModel : [
		      ...
		      {name : 'itemtype2',index : 'itemtype2',width : 100,label:'itemType2',sortable : true,align : "left"},
		      {name : 'itemtype3',index : 'itemtype3',width : 100,label:'itemType3',sortable : true,align : "left"},
...
<body>
	<div class="body-box-list">
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					...
					<tbody>
						<tr class="td-btn">	
							...
							<td class="td-label">itemType2</td>
							<td class="td-value">
						...
						<tr>
							<td colspan="6" class="td-btn">
								<div class="sch_qk_con"> 
									<input type="checkbox" id="expired_show" name="expired_show" value="${confItemTypeDt.expired}" onclick="hideExpired(this)" ${confItemTypeDt.expired!='T'?'checked':'' }/>隐藏过期记录&nbsp;
		...
		<div class="pageContent">
			...
			<div class="panelBar">
            	<ul>
            	<house:authorize authCode="CONFITEMTYPEDT_ADD">
                	<li>
				...
				<house:authorize authCode="CONFITEMTYPEDT_COPY">
                	<li>
				...
				<house:authorize authCode="CONFITEMTYPEDT_UPDATE">
                	<li>
                ...
                <house:authorize authCode="CONFITEMTYPEDT_DELETE">
                	<li>
				 ...
				 <house:authorize authCode="CONFITEMTYPEDT_VIEW">
                	<li>
