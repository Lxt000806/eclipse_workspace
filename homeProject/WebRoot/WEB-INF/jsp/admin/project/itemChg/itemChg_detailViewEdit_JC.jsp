          ...
          condition: {
            ...
            $("#intprodpk").openComponent_intProd({
              condition: {
                ...
                itemType1: '${itemChg.itemType1}',
                fixAreaPk: data.PK
              }, showValue: ret.intprodpk + "|" + ret.intproddescr, callBack: function () {
                validateRefresh('openComponent_intProd_intprodpk');
              }
            });
          }
        });
          ...
          <div class="validate-group">
            ...
            <li class="form-validate">
              ...
              <input type="text" id="unitprice"
                     name="unitprice" disabled="disabled" style="width:160px;"
                />
            </li>
          </div>
          <div class="validate-group">
