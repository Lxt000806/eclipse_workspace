...
<head>
	...
	$(function(){
		Global.JqGrid.initJqGrid("dataTable",{
			...
			styleUI: "Bootstrap", 
			postData:{custCode:"${customer.code}",itemType12:"16"},
			colModel : [
	...
	function doSave(){
		...
		if(!ret){
	 	...
	 	Global.Dialog.returnData = ret.qty;
		closeWin();
	}
	</script>
</head>
		...
		<div class="panel panel-system">
			<div class="panel-body">
				<div class="btn-group-xs">
					<button type="button" class="btn btn-system" id="closeBut" onclick="doSave()">
						<span>读取数量</span>
					</button>
			...
			<div class="query-form">
				<form role="form" class="form-search" id="page_form" action="" method="post" target="targetFrame">
					...
					<ul class="ul-form">
						<li>
							<label>楼盘</label>
							<input type="text" id="address" name="address" style="width:160px;" value="${customer.address }" readonly/>
						</li>
					</ul>
				</form>
			</div>
