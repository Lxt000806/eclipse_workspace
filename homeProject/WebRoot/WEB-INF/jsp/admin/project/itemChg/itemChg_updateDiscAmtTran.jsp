...
$(function() {
	...
	$("#saveBtn").on("click",function(){
		...
		$.ajax({
			url:"${ctx}/admin/itemChg/doUpdateDiscAmtTran",
			type:"post",
			data:datas,
			dataType:"json",
			cache:false,
				...
				<div class="panel panel-info" >  
					<div class="panel-body">
			  			<form role="form" class="form-search" id="dataForm"  action="" method="post" target="targetFrame" >
							...
							<input type="hidden" name="custCode" id="custCode" value="${discAmtTran.custCode }" />
							<input type="hidden" name="pk" id="pk" value="${discAmtTran.pk }" />
							...
							<div class="validate-group row" >
								<li class="form-validate">
									...
									<house:xtdm  id="type" dictCode="DISCAMTTRANTYPE" style="width:160px;" 
										value="${discAmtTran.type }" ></house:xtdm>
								</li>
								<li class="form-validate">
									<label>总优惠余额</label>
							...
							<div class="validate-group row" >
								<li class="form-validate">
									...
									<input type="text" id="amount" name="amount" style="width:160px;" value="${discAmtTran.amount }"/>
								</li>
								<li class="form-validate" >
									<label><span class="required">*</span>是否额外赠送</label>
									<house:xtdm  id="isExtra" dictCode="YESNO" style="width:160px;" 
										value="${discAmtTran.isExtra }" ></house:xtdm>
								</li>
							</div>
							<div class="validate-group row" hidden="true">
								<li class="form-validate">
									...
									<house:xtdm  id="isRiskFund" dictCode="YESNO" style="width:160px;" 
										value="${discAmtTran.isRiskFund }" ></house:xtdm>
								</li>
							</div>
							<div class="validate-group row" >
								<li>
									<label class="control-textarea">备注</label>
									<textarea id="remarks" name="remarks" rows="2">${discAmtTran.remarks }</textarea>
	  							</li>
							</div>
						</form>
					</div>
