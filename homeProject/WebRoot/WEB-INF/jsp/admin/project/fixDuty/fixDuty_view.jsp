		...
		<div class="panel panel-system">
			<div class="panel-body">
				<div class="btn-group-xs">
					<c:if test="${map.m_umState!='goView' && map.m_umState!='goConfirm' && map.m_umState!='goViewHistory'}">
						<button type="button" class="btn btn-system" onclick="submit()">
							<span>${map.content}</span>
						</button>
					</c:if>
					<c:if test="${map.m_umState=='goConfirm'}">
			...
			<div class="panel-body">
				<form action="" method="post" id="page_form" class="form-search">
					...
					<ul class="ul-form">
						...
						<li><label>项目经理确认时间</label> <input type="text"
							id="prjconfirmdate" name="prjconfirmdate" style="width:160px;"
							readonly="readonly" value="${map.prjconfirmdate}">
						</li>
						<li><label>确认项目经理</label> <input type="text" id="prjmandescr"
							name="prjmandescr" style="width:160px;" readonly="readonly"
							value="${map.prjmandescr}">
						</li>
						<li>
							<label>项目经理承担</label> <!-- add by zb on 20190703 -->
							<house:xtdm id="isPrjAllDuty" dictCode="YESNO" value="${map.isprjallduty}"></house:xtdm>
						</li>
						<li><label>金额确认日期</label> <input type="text" id="cfmdate"
							name="cfmdate" style="width:160px;" readonly="readonly"
							value="${map.cfmdate}">
						</li>
						<li><label>金额确认人</label> <input type="text" id="cfmmandescr"
							name="cfmmandescr" style="width:160px;" readonly="readonly"
							value="${map.cfmmandescr}">
						</li>
						<li><label>项目经理确认说明</label> <input type="text" id="prjremark"
							name="prjremark" style="width:451px;" readonly="readonly"
							value="${map.prjremark}">
						</li>
						<li><label>确认人工金额</label> <input type="text" id="cfmofferprj"
							name="cfmofferprj" style="width:160px;" readonly="readonly"
							value="${map.cfmofferprj}">
						</li>
						<li><label>确认材料金额</label> <input type="text" id="cfmmaterial"
							name="cfmmaterial" style="width:160px;" readonly="readonly"
							value="${map.cfmmaterial}">
						</li>
						<li id="dutydate_li"><label>定责时间</label> <input type="text" id="dutydate"
							name="dutydate" style="width:160px;" readonly="readonly"
							value="${map.dutydate}">
						</li>
						<li id="dutymandescr_li"><label>定责人</label> <input type="text" id="dutymandescr"
							name="dutymandescr" style="width:160px;" readonly="readonly"
							value="${map.dutymandescr}">
						</li>
						<li><label>专员确认说明</label> <input type="text" id="cfmremark"
							name="cfmremark" style="width:451px;" readonly="readonly"
							value="${map.cfmremark}">
						</li>
						<li id="managecfmdate_li"><label>经理审批时间</label> <input type="text"
							id="managecfmdate" name="managecfmdate" style="width:160px;"
							readonly="readonly" value="${map.managecfmdate}">
						</li>
						<li id="managecfmmandescr_li"><label>经理审批人</label> <input type="text"
							id="managecfmmandescr" name="managecfmmandescr"
							style="width:160px;" readonly="readonly"
							value="${map.managecfmmandescr}">
						</li>
						<li id="providedate_li"><label>发放时间</label> <input type="text" id="providedate"
							name="providedate" style="width:160px;" readonly="readonly"
							value="${map.providedate}">
						</li>
						<li id="providemandescr_li"><label>发放人</label> <input type="text"
							id="providemandescr" name="providemandescr" style="width:160px;"
							readonly="readonly" value="${map.providemandescr}">
						</li>
						<li id="cancelremark_li"><label>取消说明</label> <input type="text" id="cancelremark"
							name="cancelremark"style="width:451px;" ${map.m_umState=='goCancel'?'':'readonly'}
							value="${map.cancelremark}">
						</li>
						<li><label>定责说明</label> <input type="text" id="cfmReturnRemark"
							name="cfmReturnRemark" style="width:451px;"
							value="${map.cfmreturnremark}"${map.m_umState=='goConfirm'?'':'readonly'}>
						</li>
					</ul>
				</form>
			</div>
