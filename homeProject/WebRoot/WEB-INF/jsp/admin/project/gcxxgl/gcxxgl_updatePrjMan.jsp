...
$(function(){
	$("#projectMan").openComponent_employee({showValue:"${customer.projectMan}",showLabel:"${employee.nameChi}",condition:{prjManCustCount:'1',"onlyPrjMan":"1"}});
	...
	$("#saveBtn").on("click",function(){
		...
		$.ajax({
			url:'${ctx}/admin/gcxxgl/doUpdatePrjMan',
			type: 'post',
			data: datas,
			dataType: 'json',
			cache: false,
