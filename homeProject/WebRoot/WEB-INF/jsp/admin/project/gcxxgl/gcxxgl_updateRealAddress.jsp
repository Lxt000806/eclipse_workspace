...
$(function(){
	$("#saveBtn").on("click",function(){
		...
		$.ajax({
			url:'${ctx}/admin/gcxxgl/doUpdateRealAddress',
			type: 'post',
			data: datas,
			dataType: 'json',
			cache: false,
			  ...
			  <form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
					<input type="hidden" name="jsonString" value="" />
						<ul class="ul-form">
							...
							<li>
								<label><span class="required">*</span>实际地址</label>
								<input type="text" id="realAddress" name="realAddress" style="width:160px;" value="${customer.realAddress }" />
							</li>
						</ul>
				</form>
				</div>
