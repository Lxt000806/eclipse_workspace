...
<body>
		...
		<div class="panel panel-info" style="margin: 0px;">  
			<div class="panel-body">
				<form role="form" class="form-search" id="page_form" action="" method="post" target="targetFrame">
					...
					<input type="hidden" name="code" value="${workType12.worktype12}">
					<input type="hidden" name="oldWorkerClassify" value="${workType12.workerclassify}">
					<ul class="ul-form">
						<div class="row">
							<li class="form-validate">
								<label><span class="required">*</span>工人分类</label>
								<house:xtdm id="workerClassify" dictCode="WORKERCLASSIFY" value="${workType12.workerclassify}"/>
							</li>
						</div>
						<div class="row">
							<li class="form-validate">
	...
	<script type="text/javascript" defer>
		...
		function saveAjax(datas) {
			$.ajax({
				url:"${ctx}/admin/workType12/doUpdateQlt",
				type: "post",
				data: datas,
				dataType: "json",
				cache: false,
