...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/itemSetDetail/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
	...
	<div class="content-form">
		...
		<div class="edit-form">
			<form action="" method="post" id="dataForm">
				...
				<input type="hidden" id="expired" name="expired" value="${itemSetDetail.expired}" />
					...
					<tbody>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${itemSetDetail.expired}" onclick="checkExpired(this)" ${itemSetDetail.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
