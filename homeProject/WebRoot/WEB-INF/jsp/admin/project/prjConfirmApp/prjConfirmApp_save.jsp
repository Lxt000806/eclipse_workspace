  ...
  <head>
	...
	<script src="${resourceRoot}/pub/component_customer.js?v=${v}" type="text/javascript"></script>
  	<script type="text/javascript">
  			...
  			//校验函数
		$(function() {
   			$("#custCode").openComponent_customer({showValue:"${prjConfirmApp.custCode}",condition:{Status:'4'},callBack:fillData});	
   			$("#appDate").val(new Date().format("yyyy-MM-dd hh:mm:ss")); 
		...
		function clearForm(){
  		...
  		function save(){
			...
			$.ajax({
				url:'${ctx}/admin/PrjConfirmApp/doSave',
				type: 'post',
				data: datas,
				dataType: 'json',
				cache: false,
 				...
 				<house:token></house:token>
					<ul class="ul-form">
						...
						<div class="validate-group">
							...
							<li>								
								<label>申请时间</label>
								<input type="text" id="appDate" name="appDate" name="appDate" value="value="<fmt:formatDate value='${prjConfirmApp.appDate}' pattern='yyyy-MM-dd HH:mm:ss'/>" readonly="true"/>
							</li>
						</div>
						<div class="validate-group">
							<li class="form-validate">								
								<label class="control-textarea" >备注</label>
								<textarea id="remarks" name="remarks" value="${prjConfirmApp.remarks}" ></textarea>
							</li>
						</div>
					</ul>
				</form>
