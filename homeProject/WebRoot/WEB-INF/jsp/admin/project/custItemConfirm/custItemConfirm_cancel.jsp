...
//验证
	...
	$.ajax({
		url:'${ctx}/admin/custItemConfirm/doCancel',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
...
<div class="body-box-form" >
	 <div class="panel panel-system">
	    <div class="panel-body" >
	      ...
	      <button type="button" class="btn btn-system"  onclick="doCancel()">保存</button>
				...
				<ul class="ul-form">
					...
					<div class="validate-group row">
						<div class="col-sm-12" >
							<li class="form-validate" >
							<label>施工材料分类 </label>
							<house:DictMulitSelect id="confItemType"  dictCode="" sql="SELECT code,Descr  FROM tConfItemType  WHERE Code  IN (SELECT ConfItemType FROM  dbo.tCustItemConfirm WHERE CustCode='${custItemConfDate.custCode}' AND  ItemConfStatus in('2','3')) and ItemType1 = 'ZC' " sqlLableKey="descr" sqlValueKey="code" onCheck="validateRefresh('confItemType_NAME')"></house:DictMulitSelect>
						</li>
						</div>
						</div>	
						<div class="validate-group row">
