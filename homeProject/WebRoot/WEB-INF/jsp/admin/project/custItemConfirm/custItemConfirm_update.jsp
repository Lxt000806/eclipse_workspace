...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/custItemConfirm/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
	...
	<div class="content-form">
		...
		<div class="edit-form">
			<form action="" method="post" id="dataForm">
				...
				<input type="hidden" id="expired" name="expired" value="${custItemConfirm.expired}" />
					...
					<tbody>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${custItemConfirm.expired}" onclick="checkExpired(this)" ${custItemConfirm.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
