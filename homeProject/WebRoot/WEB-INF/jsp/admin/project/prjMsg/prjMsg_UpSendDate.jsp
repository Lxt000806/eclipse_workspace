	...
	<div class="body-box-list">
				...
				<form role="form" class="form-search" id="dataForm" action=""
					...
					<ul class="ul-form">
						<li><label>楼盘</label> <input type="text" id="address"
							name="address" value="${personMessage.address }" readonly="true" />
						</li>
						<li><label>部门</label> <input type="text"
							id="department2descr" name="department2descr"
							value="${personMessage.department2Descr }" readonly="true" />
						</li>
						<li><label>执行人</label> <input type="text" id="rcvCzy"
							name="rcvCzy" style="width:79px;"
							value="${personMessage.rcvCzy }" readonly="true" /> <input
							type="text" id="rcvCzyDescr" name="rcvCzyDescr"
							style="width:79px;" value="${personMessage.rcvCzyDescr }"
							readonly="true" />
						</li>
						<li><label>是否超时</label> <input type="text" id="deal"
							name="deal" Value="${personMessage.deal}" readonly="true" />
						</li>
						<li><label>状态</label> <house:xtdm id="RcvStatus"
								dictCode="PERSRCVSTATUS" value="${personMessage.rcvStatus}"
								disabled="true"></house:xtdm>
						</li>
						<li><label>触发日期</label> <input type="text" id="sendDate"
							name="sendDate" class="i-date"
							onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"
							value="<fmt:formatDate value='${personMessage.sendDate}' pattern='yyyy-MM-dd'/>"
							readonly="true" />
						</li>
						<li><label>接收日期</label> <input type="text" id="revDate"
							name="revDate" Value="${personMessage.rcvDate}" readonly="true" />
						</li>
						<li><label>标题</label> <input type="text" id="title"
							name="title" value="${personMessage.title}" readonly="true" />
						</li>
						<li hidden="true"><input type="text" id="pk" name="pk"
							value="${personMessage.pk}" readonly="true" />
						</li>
						<li class="form-validate"><label class="control-textarea">任务描述：</label>
							<textarea id="remarks" name="remarks" readonly="true">${personMessage.msgText }</textarea>
						</li>
						<li class="form-validate"><label class="control-textarea">延后原因：</label>
							<textarea id="delayRemarks" name="delayRemarks" ></textarea>
						</li>
					</ul>
				</form>
			</div>
 	...
 	<div class="container-fluid">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#reason" data-toggle="tab">延后记录</a>
			</li>
		</ul>
