...
$(function(){
    //初始化表格
	Global.JqGrid.initJqGrid("dataTableByWorkType12",{
		url:"${ctx}/admin/prjMsg/goJqGridByWorkType12",
		postData:{msgRelCustCode:"${personMessage.msgRelCustCode }",workType12:"${personMessage.workType12 }",pk:"${personMessage.pk}"},
		height:180,
		styleUI: 'Bootstrap',
		rowNum:1000000,
		colModel : [
...
<body >
	<div class="body-box-list">
		<div class="pageContent">
			<div id="content-list">
				<table id= "dataTableByWorkType12"></table>
			</div>
		</div>
	</div>
</body>
