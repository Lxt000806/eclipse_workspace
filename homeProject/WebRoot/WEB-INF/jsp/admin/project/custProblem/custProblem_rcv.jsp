...
<script type="text/javascript"> 
	...
	$("#rcv").on("click", function() {
			...
			$.ajax({
				...
				type : "post",
				data : {planDealDate:$("#planDealDate").val(),pk:$("#pk").val(),dealRemarks:$("#dealRemarks").val()},
				dataType : "json",
				cache : false,
				error : function(obj) {
					showAjaxHtml({
					...
					<ul class="ul-form">
						<div class="validate-group row">
							...
							<li class="form-validate"><label><span
									class="required">*</span>计划处理时间</label> <input type="text"
								id="planDealDate" name="planDealDate" class="i-date"
								style="width:160px;" onchange="validateRefresh()" required
								data-bv-notempty-message="计划处理时间不能为空"
