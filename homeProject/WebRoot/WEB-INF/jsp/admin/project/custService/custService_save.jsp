		...
		<div class="panel panel-info" style="margin: 0px;">  
			<div class="panel-body">
				<form action="" method="post" id="page_form" class="form-search">
					...
					<input type="hidden" name="isFromCustProblem" value="${isFromCustProblem }"/>
					<input type="hidden" name="custProblemPK" value="${custProblem.pk }"/>
					<ul class="ul-form">
						<div class="row">
							<div class="col-xs-6">
								...
								<li>
									...
									<input type="text" id="mobile1" name="mobile1" style="width:160px;" readonly="readonly">
								</li>
								<li>
								...
								<li>
									...
									<input type="text" id="department2" name="department2" style="width:160px;" readonly="readonly">
								</li>
								<li class="form-validate">
							...
							<div class="col-xs-6">
								<li class="form-validate">
									...
									<input type="text" id="repDate" name="repDate" class="i-date" style="width:160px;" 
										onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"
										value="<fmt:formatDate value='${repDate}' pattern='yyyy-MM-dd HH:mm:ss'/>" disabled="disabled"/>
								</li>
								<li>
								...
								<li>
									...
									<input type="text" id="dealMan" name="dealMan" style="width:160px;"/>
								</li>
								<li>
								...
								<li>
									...
									<house:xtdm id="status" dictCode="CUSTSRVSTATUS" value="1" disabled="true"></house:xtdm>
								</li>
								<li class="form-validate">
									<label for="undertaker"><span class="required">*</span>承担方</label>
									<house:xtdm id="undertaker" dictCode="CUSTSRVUNTKER" value=""></house:xtdm>
								</li>
							</div>
							<div class="col-xs-12">
								<li style="max-height: 120px;">
									...
									<textarea id="remarks" name="remarks" 
										style="height: 100px;width: 520px;">${custService.remarks}${custComplaint.remarks }</textarea>
								</li>
							</div>
						</div>
					</ul>	
...
$(function() {
	...
	$("#custCode").openComponent_customer({
		...
		showValue:"${custProblem.custCode}",
		showLabel:"${custProblem.custDescr}",
		condition:{
			status:"5",
	...
	$("#repMan").openComponent_employee({
		callBack: validateRepManRefresh,
	...
	function doSave(){
		...
		$.ajax({
			url:"${ctx}/admin/custService/doSave",
			type: "post",
			data: datas,
			dataType: "json",
			cache: false,
...
// 报备人验证刷新
function validateRepManRefresh(){
	$("#page_form").data("bootstrapValidator")  
