	...
	<div class="body-box-form">
		...
		<div class="panel panel-info" style="margin-bottom: 10px;">  
			<div class="panel-body">
			  <form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame" >
					...
					<input type="hidden" name="m_umState" id="m_umState" value="I">
					<input type="hidden" name="cupUpHigh" id="cupUpHigh" value="${specItemReq.cupUpHigh}">
					<input type="hidden" name="cupDownHigh" id="cupDownHigh" value="${specItemReq.cupDownHigh}">
					<input type="hidden" name="cupLastupdatedBy" id="cupLastupdatedBy" value="${specItemReq.cupLastupdatedBy}">
					<input type="hidden" name="cupLastUpdate" id="cupLastUpdate" value="<fmt:formatDate value='${specItemReq.cupLastUpdate}' pattern='yyyy-MM-dd HH:mm:ss'/>">
					<input type="hidden" name="hasStove" id="hasStove" value="${specItemReq.hasStove}">
					<input type="hidden" name="isSelfMetal_Cup" id="isSelfMetal_Cup" value="${specItemReq.isSelfMetal_Cup}">
					<input type="hidden" name="isSelfSink" id="isSelfSink" value="${specItemReq.isSelfSink}">
					<ul class="ul-form">
						<li>
							<label>客户编号</label>
						...
						<li class="form-validate">
							<label><span class="required">*</span>浴室地柜延米</label>
						...
						<li class="form-validate">
							<label><span class="required">*</span>浴室吊柜延米</label>
		...
		<div class="container-fluid" >  
			<ul class="nav nav-tabs" >
			    <li class="active"><a href="#specItemReq_tabView_int" data-toggle="tab">衣柜解单数据</a></li>  
			</ul>
		    <div class="tab-content">  
				<div id="specItemReq_tabView_int"  class="tab-pane fade in active"> 
		         	<div class="body-box-list">
						<div class="btn-panel">
							<div class="btn-group-sm" style="padding-top: 5px;">
								...
								<button type="button" class="btn btn-system" id="outExcel" onclick="doExcelNow('衣柜拆单主表明细')">
									<span>导出Excel</span>
								</button>
							</div>
						</div>
...
$(function() {
	...
	var gridOption = {
		...
		postData:{custCode:"${specItemReq.custCode}",iscupboard:"0"},
		sortable: true,
	...
	// 先删除窗口的关闭按钮，再去添加关闭事件
	var titleCloseEle = parent.$("div[aria-describedby=dialog_intSpec]").children(".ui-dialog-titlebar");
