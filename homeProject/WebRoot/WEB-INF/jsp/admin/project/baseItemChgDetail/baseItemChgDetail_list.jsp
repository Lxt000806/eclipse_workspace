...
<html>
<head>
	<title>BaseItemChgDetail列表</title>
...
function add(){
	Global.Dialog.showDialog("baseItemChgDetailAdd",{
		  title:"添加BaseItemChgDetail",
		  url:"${ctx}/admin/baseItemChgDetail/goSave",
		  height: 600,
		  width:1000,
...
function update(){
    ...
    if (ret) {
      Global.Dialog.showDialog("baseItemChgDetailUpdate",{
		  title:"修改BaseItemChgDetail",
		  url:"${ctx}/admin/baseItemChgDetail/goUpdate?id="+ret.PK,
		  height:600,
		  width:1000,
		  returnFun: goto_query
		});
...
function copy(){
	var ret = selectDataTableRow();
    if (ret) {
      Global.Dialog.showDialog("baseItemChgDetailCopy",{
		  title:"复制BaseItemChgDetail",
		  url:"${ctx}/admin/baseItemChgDetail/goSave?id="+ret.PK,
		  height:600,
		  width:1000,
		  returnFun: goto_query
		});
...
function view(){
    ...
    if (ret) {
      Global.Dialog.showDialog("baseItemChgDetailView",{
		  title:"查看BaseItemChgDetail",
		  url:"${ctx}/admin/baseItemChgDetail/goDetail?id="+ret.PK,
		  height:600,
		  width:1000
		});
    } else {
...
function del(){
	var url = "${ctx}/admin/baseItemChgDetail/doDelete";
	beforeDel(url);
}
//导出EXCEL
function doExcel(){
	$.form_submit($("#page_form").get(0), {
		"action": "${ctx}/admin/baseItemChgDetail/doExcel"
	});
}
/**初始化表格*/
$(function(){
	...
	<div class="body-box-list">
		<div class="query-form">
			<form action="" method="post" id="page_form" >
				<input type="hidden" id="expired" name="expired" value="${baseItemChgDetail.expired}" />
						...
						<tr>
							<td colspan="6" class="td-btn">
								<div class="sch_qk_con"> 
									<input type="checkbox" id="expired_show" name="expired_show" value="${baseItemChgDetail.expired}" onclick="hideExpired(this)" ${baseItemChgDetail.expired!='T'?'checked':'' }/>隐藏过期记录&nbsp;
		...
		<div class="pageContent">
			...
			<div class="panelBar">
            	<ul>
            	<house:authorize authCode="BASEITEMCHGDETAIL_SAVE">
                	<li>
				...
				<house:authorize authCode="BASEITEMCHGDETAIL_COPY">
                	<li>
				...
				<house:authorize authCode="BASEITEMCHGDETAIL_UPDATE">
                	<li>
                ...
                <house:authorize authCode="BASEITEMCHGDETAIL_DELETE">
                	<li>
				 ...
				 <house:authorize authCode="BASEITEMCHGDETAIL_VIEW">
                	<li>
