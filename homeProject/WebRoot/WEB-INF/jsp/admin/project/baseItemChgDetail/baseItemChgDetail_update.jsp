...
<html>
<head>
	<title>修改BaseItemChgDetail</title>
...
function save(){
	...
	$.ajax({
		url:'${ctx}/admin/baseItemChgDetail/doUpdate',
		type: 'post',
		data: datas,
		dataType: 'json',
		cache: false,
					...
					<tbody>
						...
						<tr>
							...
							<td class="td-value" colspan="3">
								<input type="checkbox" id="expired_show" name="expired_show" value="${baseItemChgDetail.expired}" onclick="checkExpired(this)" ${baseItemChgDetail.expired=="T"?"checked":"" }>
							</td>
						</tr>
					</tbody>
				</table>
