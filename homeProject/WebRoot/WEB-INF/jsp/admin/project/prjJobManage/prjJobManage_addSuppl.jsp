...
<head>
	...
	$(function() {
		$("#supplCode").openComponent_supplier({callBack:validateRefresh,condition:{supplJob:"${prjJob.no }",custCode:"${prjJob.custCode}",itemType1:"${prjJob.itemType1}",jobType:"${prjJob.jobType}",from:"prjJobManage"}});	
	...
	$(function(){
		...
		$("#saveBtn").on("click",function(){
			...
			$.ajax({
				url:"${ctx}/admin/prjJobManage/doSaveSuppl",
				type: "post",
				data:postData,
				dataType: "json",
				cache: false,
			...
			<div class="panel panel-info">  
				<div class="panel-body">
					<form action="" method="post" id="page_form" class="form-search">
						...
						<input type="hidden" name="prjJobNo" id="prjJobNo" value="${prjJob.no }"/>
						<input type="hidden" name="custCode" id="custCode" value="${prjJob.custCode }"/>
						<input type="hidden" name="itemType1" id="itemType1" value="${prjJob.itemType1 }"/>
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<li>
									<label>状态</label>
									<house:xtdm id="status" dictCode="SUPPLJOBSTS" value="0" disabled="true"></house:xtdm>                     
								</li>
							</div>
							<div class="validate-group row">
								<li>
