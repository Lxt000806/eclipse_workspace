		...
		<div class="panel panel-info" style="height: 482px;">  
       		<div class="panel-body" style="height: 480px;">
		  		<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame">
					...
					<input type="hidden" name="custCode" id="custCode" value="${workerProblem.custcode }"/>
					<ul class="ul-form" style="height: 450px">
						<li class="form-validate">
							<label>是否橱柜</label>
							<house:xtdm  id="isCupboard" dictCode="YESNO" style="width:160px;" value="${workerProblem.isCupboard }"></house:xtdm>
						</li>
						<li style="height: 100px;">
							<label class="control-textarea" style="width: 60px;">确认说明：</label>
							<textarea id="confirmRemark" name="confirmRemark" style="width: 250px;" 
								rows="10" >${workerProblem.confirmRemark}</textarea>
						</li>
					</ul>	
				</form>
			</div>
...
$(function(){
	...
	$("#saveBut").on("click",function(){
		...
		$.ajax({
			url:"${ctx}/admin/workerProblem/doSaveReplenish",
			type: "post",
			data:{no:"${workerProblem.no}",confirmRemark:$("#confirmRemark").val(),isCupboard:$("#isCupboard").val(),custCode:"${workerProblem.custcode }"},
			dataType: "json",
			cache: false,
			error: function(obj){
