		  		...
		  		<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame">
					...
					<ul class="ul-form" style="height: 450px">
						<li class="form-validate">
							<label>长期停工</label>
							<house:xtdm  id="cwStatus" dictCode="CUSTWKSTATUS" style="width:160px;" value="${workerProblem.cwstatus }"></house:xtdm>
						</li>
...
$(function(){
	...
	$("#saveBut").on("click",function(){
		$.ajax({
			url:"${ctx}/admin/workerProblem/doSaveConfirm",
			type: "post",
			data:{no:"${workerProblem.no}",confirmRemark:$("#confirmRemark").val(),cwStatus:$("#cwStatus").val(),custWkPk:"${workerProblem.custwkpk}"},
			dataType: "json",
			cache: false,
			error: function(obj){
