		  		...
		  		<form role="form" class="form-search" id="page_form"  action="" method="post" target="targetFrame">
					...
					<ul class="ul-form" style="height: 450px">
						...
						<li style="height: 100px;">
							<label class="control-textarea" style="width: 60px;">处理说明：</label>
							<textarea id="dealRemark" name="dealRemark" style="width: 250px;" 
								rows="10" >${workerProblem.dealRemark}</textarea>
						</li>
					</ul>	
				</form>
			</div>
...
$(function(){
	...
	$("#saveBut").on("click",function(){
		$.ajax({
			url:"${ctx}/admin/workerProblem/doSaveDeal",
			type: "post",
			data:{no:"${workerProblem.no}",dealRemark:$("#dealRemark").val(),cwStatus:$("#cwStatus").val(),custWkPk:"${workerProblem.custwkpk}"},
			dataType: "json",
			cache: false,
			error: function(obj){
