...
function getCfmAmountByWt1(){
	var workType1=$("#workType1").val();
	if(workType1==""){
		return;
	}
	$.ajax({
		url:"${ctx}/admin/preWorkCostDetail/getCfmAmountByWt1",
		type:"post",
		data:{custCode:$("#custCode").val(),workType1:$("#workType1").val()},
		dataType:"json",
		cache:false,
		async:false,
		error:function(obj){
	...
	<div class="panel panel-system" >
	    <div class="panel-body" >
	      <div class="btn-group-xs" >
		      <button type="button" id="saveBtn" class="btn btn-system "  >二级审核</button>
					...
					<div class="row">
						<div class="col-xs-4">
							...
							<li>
									<label >工资类型</label>
										...
										sqlValueKey="Code" sqlLableKey="Descr"  value="${pWorkCostDetail.salaryType }"  ></house:dict>
									</label>
							</li>
							<li>
									<label >申请金额</label>
							...
							<li>	
									<label >卡号</label>
										<input type="text" id="cardId" name="cardId"   value="${pWorkCostDetail.cardId }"  />
									</label>												
							</li>
							<li>	
								<label >是否预扣</label>
						...
						<div class="col-xs-8">
							<div class="col-xs-6">
								...
								<li>
										<label >工种分类1</label>
											<select id="workType1" name="workType1"  onchange="getCfmAmountByWt1()"></select>
										</label>	
								</li>
								<li>
								...
								<li>	
										<label >户名</label>
											<input type="text" id="actName" name="actName"   value="${pWorkCostDetail.actName }"  />
										</label>
								</li>
								<li>	
									<label >总发包</label>
							...
							<div class="col-xs-6">
								...
								<li>
										<label >工种分类2</label>
											<select id="workType2" name="workType2"   onchange="setWorkCon()"></select>
										</label>
								</li>
								<li>
					...
					<li>	
						<li hidden="true">
							...
							<label >m_s</label>
								...
								<input type="text" id="m_s" name="m_s"   value="M"  readonly="true" />
							</label>
...
$("#saveBtn").on("click",function(){	
	...
	var cfmAmount = $.trim($("#cfmAmount").val());
	var salaryCtrl="${salaryCtrl }";//定额工资控制比例
	var isUpWater = "${IsUpWater}";
	var hasGNQXByCzybh = "${hasGNQXByCzybh}";
 	if (cfmAmount==""){
	art.dialog({content: "审核金额不能为空！",width: 200});
		return false;
	}
