			...
			<div class="btn-group-xs">
				<house:authorize authCode="CUSTINTPROG_ERRORREGISTER">
					<button style="align:left" type="button" class="btn btn-system "
						id="errorRegister" onclick="add('出错登记','1')" disabled="true">出错登记</button>
				</house:authorize>
				<house:authorize authCode="CUSTINTPROG_CANTINSTALL">
					<button style="align:left" type="button" class="btn btn-system "
						id="cantInstall" onclick="add('不能安装','2')" disabled="true">不能安装</button>
				</house:authorize>
				<house:authorize authCode="CUSTINTPROG_CONPENREGISTER">
					<button style="align:left" type="button" class="btn btn-system "
						id="conpenRegister" onclick="add('赔付登记','3')" disabled="true">赔付登记</button>
				</house:authorize>
				<house:authorize authCode="CUSTINTPROG_URGENTCALL">
					<button style="align:left" type="button" class="btn btn-system "
						id="urgentCall" onclick="add('加急单','4')" disabled="true">加急单</button>
				</house:authorize>
				<house:authorize authCode="CUSTINTPROG_RETURNREGISTER">
					<button style="align:left" type="button" class="btn btn-system "
						id=returnRegister onclick="add('退单登记','5')" disabled="true">退单登记</button>
				</house:authorize>
				<button style="align:left" type="button" class="btn btn-system "
				...
				<button style="align:left" type="button" class="btn btn-system "
					id="delete" disabled="true" onclick="del()">
					<span>删除 </span>
				</button>
				<button style="align:left" type="button" class="btn btn-system "
					id="excel" onclick="doExcelNow('集成进度明细表','dataTable','page_form')">
					<span>导出excel </span>
				</button>
			</div>
		</div>
