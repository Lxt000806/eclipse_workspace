...
<script type="text/javascript">
	...
	$(function() {
	    //初始化descr
		findDescr('resPart','RESPART','resPartDescr');
		findDescr('type','INTDTTYPE','typedescr');
		findDescr('isCupboard','YESNO','isCup');
		findDescr('cancelReson','CANCELRESON','cancelResonDescr');
					...
					<ul class="ul-form">
						...
						<c:if test="${showZrf!='yes' }">
							<div class="validate-group row">
								<li class="form-validate"><label>责任方</label> <house:xtdm
										id="resPart" dictCode="RESPART" 
										value="${intProgDetail.resPart }" 
										onchange="findDescr('resPart','RESPART','resPartDescr');"></house:xtdm>
								</li>
							</div>
						</c:if>
						<c:if test="${isReturn=='yes'}">
							<div class="validate-group row">
								<li class="form-validate"><label>是否橱柜</label> <house:xtdm
										id="isCupboard" dictCode="YESNO"
										onchange="findDescr('isCupboard','YESNO','isCup')"></house:xtdm>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate"><label><span
										class="required">*</span>退单原因</label> <house:xtdm id="cancelReson"
										dictCode="CANCELRESON"
										onchange="findDescr('cancelReson','CANCELRESON','cancelResonDescr')"></house:xtdm>
								</li>
							</div>
						</c:if>
						...
						<div class="validate-group row">
							<li class="form-validate"><label class="control-textarea">备注</label>
								<textarea id="remarks" name="remarks">${intProgDetail.remarks }</textarea>
							</li>
						</div>
					</ul>
				</form>
