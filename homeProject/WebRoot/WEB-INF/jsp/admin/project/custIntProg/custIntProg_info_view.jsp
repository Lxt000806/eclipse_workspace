...
$(function() {
	  	$("#tableSpl").openComponent_supplier({showValue:'${custIntProg.tablespl }',showLabel:'${custIntProg.tablespldescr }',readonly:true});
      	$("#cupSpl").openComponent_supplier({showValue:'${custIntProg.cupspl }',showLabel:'${custIntProg.cupspldescr }',readonly:true}); 
      	$("#intSpl").openComponent_supplier({showValue:'${custIntProg.intspl }',showLabel:'${custIntProg.intspldescr }',readonly:true});
      	$("#doorSpl").openComponent_supplier({showValue:'${custIntProg.doorspl }',showLabel:'${custIntProg.doorspldescr }',readonly:true}); 
					...
					<ul class="ul-form">
						<div class="validate-group row">
							...
							<li><label>增减总额</label> <input type="text" id="addreduceAll"
								...
								value="${custIntProg.addreduceall}" readonly />
							</li>
						</div>
						<div class="validate-group row">
							</li>
							...
							<li><label>其他板材</label> <input type="text" id="otherArea"
								name="otherArea" style="width:160px;"
								value="${custIntProg.otherarea}" readonly /> <span
								style="position: absolute;left:290px;width: 30px;top:3px;">平方</span>
							</li>
						</div>
						<div class="validate-group row">
							...
							<li><label>实木生态板</label> <input type="text" id="ecoArea"
								name="ecoArea" style="width:160px;"
								value="${custIntProg.ecoarea}" readonly /> <span
								style="position: absolute;left:290px;width: 30px;top:3px;">平方</span>
							</li>
						</div>
						<div class="validate-group row">
							...
							<li><label>实木颗粒板</label> <input type="text" id="mdfArea"
								name="mdfArea" style="width:160px;"
								value="${custIntProg.mdfarea}" readonly /> <span
								style="position: absolute;left:290px;width: 30px;top:3px;">平方</span>
							</li>
						</div>
						<div class="validate-group row">
						...
						<div class="validate-group row">
							...
							<li><label>橱柜供应商</label> <input type="text" id="cupSpl"
								...
								value="${custIntProg.cupspl }" disabled="true" />
							</li>
						</div>
						<div class="validate-group row">
						...
						<div class="validate-group row">
							...
							<li><label>集成供应商</label> <input type="text" id="intSpl"
								...
								value="${custIntProg.intspl }" disabled="true" />
							</li>
						</div>
						<div class="validate-group row">
							...
							<li class="form-validate"><label>推拉门下单日期</label> <input
						...
						<div class="validate-group row">
							...
							<li><label>推拉门供应商</label> <input type="text" id="doorSpl"
								...
								value="${custIntProg.doorspl }" disabled="true" />
						</div>
						<div class="validate-group row">
							...
							<li class="form-validate"><label>台面下单日期</label> <input
						...
						<div class="validate-group row">
							...
							<li><label>台面供应商</label> <input type="text" id="tableSpl"
								...
								value="${custIntProg.tablespl }" disabled="true" />
						</div>
						<div class="validate-group row">
							...
							<li class="form-validate"><label>橱柜材质</label> <house:dict
									id="cupMaterial" dictCode=""
									sql="select code, code+' '+descr fd from tIntMaterial "
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>集成材质</label> <house:dict
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>橱柜实际出货日期</label> <input
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>实际开工日期</label> <input
								...
								disabled="true" /></li>
							<li class="form-validate"><label>集成实际出货日期</label> <input
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>橱柜计划出货日期</label> <input
								...
								disabled="true" /></li>
							<li class="form-validate"><label>橱柜安装日期</label> <input
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>集成计划出货日期</label> <input
								...
								class="i-date" style="width:160px;"
								onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"
								value="${custIntProg.intinstalldate}'  pattern='yyyy-MM-dd'/>"
								disabled="true" /></li>
							<li class="form-validate"><label>集成安装日期</label> <input
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>橱柜质检日期</label> <input
								...
								disabled="true" /></li>
							<li class="form-validate"><label>橱柜交付日期</label> <input
						...
						<div class="validate-group row">
							...
							<li class="form-validate"><label>集成质检日期</label> <input
								...
								value="${custIntProg.cupcheckdate==''?'':custIntProg.cupcheckdate.substring(0,10)}"
								disabled="true" /></li>
							<li class="form-validate"><label>集成交付日期</label> <input
						...
						<div class="validate-group row">
							<li class="form-validate"><label>台面出货日期</label> <input
							...
							<li class="form-validate"><label>衣柜设计完成日期</label> 
								<input type="text" id="intDesignDate" name="intDesignDate" class="i-date" style="width:160px;" disabled="true"
							...
							<li class="form-validate"><label>橱柜设计完成日期</label> 
								<input type="text" id="cupDesignDate" name="cupDesignDate" class="i-date" style="width:160px;" disabled="true"
								onFocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})" value="${custIntProg.cupdesigndate}" />
							</li>
							<li class="form-validate"><label class="control-textarea">备注信息</label>
								<textarea id="remarks" name="remarks" disabled="true">${custIntProg.remarks }</textarea>
							</li>
						</div>
					</ul>
				</form>
