...
<head>
	...
	$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable",{
			...
			styleUI: "Bootstrap", 
			colModel : [
				{name: "workercodedescr", index: "workercodedescr", width: 120, label: "工人", sortable: true, align: "left"},
				{name: "worktype12descr", index: "worktype12descr", width: 120, label: "工种", sortable: true, align: "left"},
				{name: "issigndescr", index: "issigndescr", width: 90, label: "是否签约", sortable: true, align: "left"},
				{name: "zjts", index: "zjts", width: 120, label: "在建套数", sortable: true, align: "left"},
				{name: "leveldescr", index: "leveldescr", width: 120, label: "工人等级", sortable: true, align: "left"},
				{name: "monthts", index: "monthts", width: 120, label: "本月完成套数", sortable: true, align: "left"},
				{name: "yearts", index: "yearts", width: 120, label: "本年完成套数", sortable: true, align: "left"}
			],
...
<body>
	<div class="body-box-list">
			...
			<div class="query-form">
				<form role="form" class="form-search" id="page_form" action="" method="post" target="targetFrame">
					...
					<ul class="ul-form">
						...
						<li>
							<label>是否签约</label>
							<house:xtdm  id="isSign" dictCode="YESNO" style="width:160px;" value="${custWorkerApp.isSign}"></house:xtdm>
						</li>
						<li >
		...
		<div class="btn-panel">
			...
			<button type="button" class="btn btn-system " onclick="doExcelNow('工人汇总分析')" title="导出当前excel数据" >
				<span>导出excel</span>
			</button>
		</div>	
	</div>
