...
<html>
<head>
	<title>ProgCheckApp查询code</title>
...
$(function(){
		Global.JqGrid.initJqGrid("dataTable",{
			...
			colModel : [
			  ...
			  ,
		      {name : 'AppDate',index : 'AppDate',width : 100,label:'appDate',sortable : true,align : "left"}
			  ,
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					...
					<tbody>
						<tr class="td-btn">	
							...
							<td class="td-value">
							<input type="text" id="pk" name="pk" style="width:160px;"  value="${progCheckApp.pk}" />
							</td>
							<td class="td-label">custCode</td>
							<td class="td-value">
							<input type="text" id="custCode" name="custCode" style="width:160px;"  value="${progCheckApp.custCode}" />
							</td>
							<td class="td-label">appDate</td>
							<td class="td-value">
							<input type="text" id="appDate" name="appDate" style="width:160px;"  value="${progCheckApp.appDate}" />
							</td>
						</tr>
						<tr class="td-btn">	
							<td class="td-label">appCzy</td>
							<td class="td-value">
							<input type="text" id="appCzy" name="appCzy" style="width:160px;"  value="${progCheckApp.appCzy}" />
							</td>
							<td class="td-label">remarks</td>
							<td class="td-value">
							<input type="text" id="remarks" name="remarks" style="width:160px;"  value="${progCheckApp.remarks}" />
							</td>
							<td class="td-label">lastUpdate</td>
							<td class="td-value">
							<input type="text" id="lastUpdate" name="lastUpdate" style="width:160px;"  value="${progCheckApp.lastUpdate}" />
							</td>
						</tr>
						<tr class="td-btn">	
							<td class="td-label">lastUpdatedBy</td>
							<td class="td-value">
							<input type="text" id="lastUpdatedBy" name="lastUpdatedBy" style="width:160px;"  value="${progCheckApp.lastUpdatedBy}" />
							</td>
							<td class="td-label">expired</td>
							<td class="td-value">
							<input type="text" id="expired" name="expired" style="width:160px;"  value="${progCheckApp.expired}" />
							</td>
							<td class="td-label">actionLog</td>
							<td class="td-value">
							<input type="text" id="actionLog" name="actionLog" style="width:160px;"  value="${progCheckApp.actionLog}" />
							</td>
						</tr>
						<tr>
