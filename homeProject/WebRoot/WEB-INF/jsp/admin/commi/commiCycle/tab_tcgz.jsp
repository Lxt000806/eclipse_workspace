...
<div class="body-box-list">
	<div class="container-fluid" id="id_tcgz">
	    <ul class="nav nav-tabs" style="padding-top: 10px;">  
	        <li class="active"><a href="#tab_tcgz_tcgxr" data-toggle="tab" onclick="setExcelTable('dataTable_tcgz_tcgxr','提成干系人')">提成干系人</a></li>
	        <li class=""><a href="#tab_tcgz_lpgxrtcgz" data-toggle="tab" onclick="setExcelTable('dataTable_tcgz_lpgxrtcgz','楼盘干系人提成规则')">楼盘干系人提成规则</a></li>
	    ...
	    <div class="tab-content">  
	        <div id="tab_tcgz_tcgxr" class="tab-pane fade in active" > 
	         	<jsp:include page="tab_tcgz_tcgxr.jsp"></jsp:include>
	        </div>  
	        <div id="tab_tcgz_lpgxrtcgz" class="tab-pane fade" > 
