...
<head>
	...
	$(function(){
		$("#saveBtn").on("click",function(){
			...
			$.ajax({
				url:"${ctx}/admin/commiCycle/doSave",
				type: "post",
				data: datas,
				dataType: "json",
				cache: false,
							...
							<form action="" method="post" id="page_form"
								...
								<ul class="ul-form">
									<li class="form-validate">
										...
										required data-bv-notempty-message="月份不能为空" />
									</li>
									<li><label>状态</label> <house:xtdm id="status"
											dictCode="SOFTPERFSTATUS" value="1" disabled="true"></house:xtdm>
									</li>
									<li class="form-validate">
										...
										required data-bv-notempty-message="浮动业绩开始月份不能为空" />
									</li>
									<li class="form-validate">
										...
										required data-bv-notempty-message="浮动业绩截止月份不能为空"/>
									</li>
									<li>
