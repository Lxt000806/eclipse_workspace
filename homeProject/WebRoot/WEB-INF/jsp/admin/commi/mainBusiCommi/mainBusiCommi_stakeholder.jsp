...
<head>
	...
	$(function(){
		Global.JqGrid.initJqGrid("dataTable",{
			url:"${ctx}/admin/mainBusiCommi/goStakeholderJqGrid",
			height:$(document).height()-$("#content-list").offset().top-100,
			styleUI: "Bootstrap", 
			postData:{
				chgNo:"${mainBusiCommi.chgNo}"
			},
			colModel : [
				...
				{name: "iscalcdeptperfdescr", index: "iscalcdeptperfdescr", width: 80, label: "计算部门业绩", sortable: true, align: "left"},
				{name: "iscalcpersonperfdescr", index: "iscalcpersonperfdescr", width: 80, label: "计算个人业绩", sortable: true, align: "left"},
