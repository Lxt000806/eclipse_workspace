...
function doSave(){
	...
	$.ajax({
		url:"${ctx}/admin/commiExprRule/doSave",
		type: "post",
		data: datas,
		dataType: "json",
		cache: false,
							...
							<div class="validate-group row">
								<li class="form-validate">
									...
									<house:dict id="role" dictCode="" sqlValueKey="Code" sqlLableKey="Descr"
									    sql="select Code,code+' '+Descr Descr from tRoll where Expired = 'F' and Code in ('01','24','00','63')" value="${commiExprRule.role }"></house:dict>
								</li>
								<li class="form-validate">
									<label>客户类型</label>
									<house:dict id="custType" dictCode="" sqlValueKey="Code" sqlLableKey="Descr"
										sql="select Code,code+' '+Desc1 Descr from tCusttype where Expired = 'F'" value="${commiExprRule.custType }"></house:dict>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
