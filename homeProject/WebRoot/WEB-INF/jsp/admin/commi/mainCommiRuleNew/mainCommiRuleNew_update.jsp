...
$(function() {
	...
	$("#saveBtn").on("click",function(){
		...
		Global.Form.submit("dataForm","${ctx}/admin/mainCommiRuleNew/doUpdate",param,function(ret){
			if(ret.rs==true){
				art.dialog({
					content:ret.msg,
					time:1000,
					...
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<ul class="ul-form">
							...
							<li class="form-validate">
								...
								<input type="text" id="fromProfit" name="fromProfit" style="width:160px;" onkeyup="value=value.replace(/[^(\-|\+)?\d+(\.\d+)?$]/g,'')" value="${mainCommiRuleNew.fromProfit }"/>
							</li>
							<li class="form-validate">
								<label><span class="required">*</span>毛利率至</label>
								<input type="text" id="toProfit" name="toProfit" style="width:160px;" onkeyup="value=value.replace(/[^(\-|\+)?\d+(\.\d+)?$]/g,'')" value="${mainCommiRuleNew.toProfit }"/>
							</li>
							<li class="form-validate">
							...
							<li class="form-validate">
								...
								<input type="text" id="commiPerc" name="commiPerc" style="width:160px;" onkeyup="value=value.replace(/[^(\-|\+)?\d+(\.\d+)?$]/g,'')" value="${mainCommiRuleNew.commiPerc }"/>
							</li>
							<li>
