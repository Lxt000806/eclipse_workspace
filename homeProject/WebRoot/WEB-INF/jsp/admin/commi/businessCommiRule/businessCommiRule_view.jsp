						...
						<ul class="ul-form">
							<div class="validate-group row">
								...
								<house:dict id="role" dictCode="" sqlValueKey="Code" sqlLableKey="Descr"
								    sql="select Code,code+' '+Descr Descr from tRoll where Expired = 'F'" value="${businessCommiRule.role}"></house:dict>
							</li>
								<li class="form-validate">
									<label>职位</label>
							...
							<div class="validate-group row">
								...
								<li class="form-validate">
									<label>类型</label>
									<house:xtdm id="type" dictCode="COMMIRULETYPE" value="${businessCommiRule.type}"></house:xtdm>                     
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
