...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_yjtc",{
			...
			colModel : [
				...
				{name: "commino", index: "commino", width: 70, label: "周期编号", sortable: true, align: "left",hidden:true},
...
function yjtc_view(id){
	...
	if(!ret){
	 ...
	 Global.Dialog.showDialog("viewDetail",{
		title:"业绩提成-查看",
		postData:{pk:ret.pk,sigmCommiNo:ret.commino},
...
function doQueryType(){
	...
	"setGridParam",{
		datatype:"json",
		postData:{mon:$("#mon").val(),type:$("#commiType").val()},
		page:1,
		url:"${ctx}/admin/commiCustStakeholder/goJqGrid",
	}
	).trigger("reloadGrid"); 
	...
	<div class="panel panel-system">
		<div class="panel-body">
			...
			<div class="btn-group-xs">
				<select style="width:160px; border-radius:5px" onchange="doQueryType()" id="commiType">
