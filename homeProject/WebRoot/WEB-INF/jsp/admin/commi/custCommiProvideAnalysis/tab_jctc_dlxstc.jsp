...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_jcdlxstc",{
			...
			height:400,
			colModel : [
			    {name: "address", index: "address", width: 120, label: "楼盘", sortable: true, align: "left",formatter:jcdlxstc_custBtn},
...
function jcdlxstc_viewBase(){
	Global.Dialog.showDialog("viewBase",{
		title:"材料明细查询",
		url:"${ctx}/admin/intBusiCommi/goBase?isInd=1",
		height:800,
		width:1300
	});
}
...
function jcdlxstc_viewSum(){
	Global.Dialog.showDialog("viewSum",{
		title:"提成汇总查询",
		url:"${ctx}/admin/intBusiCommi/goSum?isInd=1",
		height:600,
		width:1000
	});
}
