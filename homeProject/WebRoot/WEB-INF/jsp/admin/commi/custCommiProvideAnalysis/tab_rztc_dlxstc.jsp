...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_rzdlxstc",{
			...
			height:400,
			colModel : [
			    {name: "address", index: "address", width: 120, label: "楼盘", sortable: true, align: "left",formatter:rzdlxstc_custBtn},
...
function rzdlxstc_viewBase(){
	Global.Dialog.showDialog("viewBase",{
		title:"材料明细查询",
		url:"${ctx}/admin/softBusiCommi/goBase?isInd=1",
		height:800,
		width:1300
	});
}
...
function rzdlxstc_viewSum(){
	Global.Dialog.showDialog("viewSum",{
		title:"提成汇总查询",
		url:"${ctx}/admin/softBusiCommi/goSum?isInd=1",
		height:600,
		width:1000
	});
}
