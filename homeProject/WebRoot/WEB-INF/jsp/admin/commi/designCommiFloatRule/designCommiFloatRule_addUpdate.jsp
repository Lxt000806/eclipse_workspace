						...
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" id="cardinalFrom" name="cardinalFrom" style="width:160px;" value="${map.cardinalfrom }"/>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>提成基数至</label>
									<input type="text" id="cardinalTo" name="cardinalTo" style="width:160px;" value="${map.cardinalto }"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>提成点</label>
									<input type="text" id="commiPer" name="commiPer" style="width:160px;" value="${map.commiper }"/>
								</li>
							</div>
							<div class="validate-group row">
								<li>
