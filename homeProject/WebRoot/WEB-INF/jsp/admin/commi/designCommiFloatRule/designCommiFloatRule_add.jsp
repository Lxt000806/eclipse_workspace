...
function doSave(){
	...
	/* if(cardinalFrom != "" && cardinalFrom > 1){
		art.dialog({
			content:"提成基数从只能在0-1之间",
		});
		return;
	}
	if(cardinalTo != "" && cardinalTo > 1){
		art.dialog({
			content:"提成基数至只能在0-1之间",
		});
		return;
	} */
						...
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									...
									<input type="text" id="cardinalFrom" name="cardinalFrom" style="width:160px;"/>
								</li>
								<li class="form-validate">
									<label><span class="required">*</span>提成基数至</label>
									<input type="text" id="cardinalTo" name="cardinalTo" style="width:160px;"/>
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>提成点</label>
									<input type="text" id="commiPer" name="commiPer" style="width:160px;"/>
								</li>
							</div>
							<div class="validate-group row">
								<li>
