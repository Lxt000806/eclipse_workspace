...
$(function() {
	...
	$("#department").openComponent_department({callBack: checkDepartment, readonly: true,
			showValue:"${designCommiRule.department}", showLabel:"${department.desc1}"});	
	$("#empCode").openComponent_employee({callBack: checkEmpCode, readonly:true,
			...
			<div class="panel panel-info" >  
				<div class="panel-body">
					<form action="" method="post" id="dataForm" class="form-search">
						...
						<input type="hidden" name="expired" id= "expired" value="${designCommiRule.expired }"/>
						<ul class="ul-form">
							<div class="validate-group row">
								<li class="form-validate">
									<label><span class="required">*</span>角色</label>
									<house:dict id="role" dictCode="" sqlValueKey="Code" sqlLableKey="Descr" disabled="true"
							...
							<div class="validate-group row">
								...
								<li class="form-validate">
									...
									<house:xtdm id="checkCommiType" dictCode="COMMIRULETYPE" value="${designCommiRule.checkCommiType }" 
											onchange="chgType()"></house:xtdm>                     
								</li>
							</div>
							<div class="validate-group row">
								<li class="form-validate">
							...
							<div class="validate-group row">
								<li>
		                            ...
		                            <input type="checkbox" name="expiredCheckbox"
		                                   ${designCommiRule.expired == 'T' ? 'checked' : ''} onclick="checkExpired(this)"/>
		                        </li>
							</div>
						</ul>
					</form>
