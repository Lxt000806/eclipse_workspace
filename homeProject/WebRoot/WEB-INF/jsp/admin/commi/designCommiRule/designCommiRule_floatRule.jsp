...
<script type="text/javascript">
	...
	$(function() {
		Global.JqGrid.initJqGrid("dataTable", {
			url:"${ctx}/admin/designCommiFloatRule/goJqGrid",
	...
	function goUpdate(){
		...
		Global.Dialog.showDialog("floatRuleView",{
			title:"设计提成规则管理--浮动规则编辑",
			postData:{pk: ret.pk},
			url:"${ctx}/admin/designCommiFloatRule/goUpdate",
			height:548,
			width:1058,
	        resizable: true,
			returnFun:goto_query
	...
	function doExpired(){
		...
		art.dialog({
			...
			ok: function () {
				$.ajax({
					url:"${ctx}/admin/designCommiFloatRule/doExpired",
					type:"post",
					data:{pk:ret.pk},
					dataType:"json",
					cache:false,
	...
	<div class="body-box-list">
		<div class="query-form">
			<form action="" method="post" id="page_form" class="form-search">
				...
				<input type="hidden" id="expired"  name="expired" value="${designCommiRule.expired }"/>
				<ul class="ul-form">
					<li>
						<label>规则名称</label>		
