...
$(function(){
        //设计提成
		Global.JqGrid.initJqGrid("dataTable_againCommi",{
			url:"${ctx}/admin/commiCustStakeholder/goJqGrid",           
			postData:{beginMon:"${employee.beginMon}",endMon:"${employee.endMon}",empCode:"${employee.number}",role:"24"},
			rowNum: 100000000,
			height:400,
			colModel : [
...
<div class="body-box-list">
	...
	<div class="pageContent">
		<table id="dataTable_againCommi"></table>
	</div>
</div>
