...
$(function(){
		...
		Global.JqGrid.initJqGrid("dataTable_zcdlxstc",{
			...
			height:400,
			colModel : [
			    {name: "address", index: "address", width: 200, label: "楼盘", sortable: true, align: "left",formatter:zcdlxstc_custBtn},
...
function zcdlxstc_viewBase(){
	Global.Dialog.showDialog("viewBase",{
		title:"材料明细查询",
		url:"${ctx}/admin/mainBusiCommi/goBase?commiNo="+$("#commiNo").val()+"&&isInd=1",
		height:800,
		width:1300
	});
}
...
function zcdlxstc_viewSum(){
	Global.Dialog.showDialog("viewSum",{
		title:"提成汇总查询",
		url:"${ctx}/admin/mainBusiCommi/goSum?commiNo="+$("#commiNo").val()+"&&isInd=1",
		height:600,
		width:1000
	});
}
