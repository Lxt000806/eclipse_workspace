...
(function($){
	...
	data = {
		...
		//添加3.5.41版本的功能（开始） add by zb on 20191205
	...
	tools = {
		...
		//添加3.5.41版本的快捷键 add by zb on 20191204
	...
	$.fn.zTree = {
		...
		init: function(obj, zSetting, zNodes) {
			...
			var zTreeTools = {
				...
				//主页搜索测试 fuzzysearch离焦问题,删掉即可解决（新版本也不存在了） modify by zb on 20191228
				expandNode : function(node, expandFlag, sonSign, focus, callbackFlag) {
					...
					if (sonSign) {
						...
						view.expandCollapseSonNode(this.setting, node, expandFlag, true, null);
					} else {
					...
					function showNodeFocus() {
						var a = $("#" + node.tId + consts.id.ICON).get(0);
						if (a && focus !== false) {
...
(function($){
	...
	data = zt._z.data,
	event = zt._z.event,
	$$ = tools.$;//添加3.5.41版本的快捷键 add by zb on 20191204
