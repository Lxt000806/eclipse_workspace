    ...
    $(".uploadImgs-add").click(function () {
        ...
        lastInput.bind("change", function () {
            if (lastInput[0].files) { //谷歌 IE10以上          
                ...
                var upImgs = "<div class='show-img-div2'><span><img src='../../commons/easyUpload/upload/img/close.png' /></span><img src='" + imgSrc + "'/></div>";
                $("#labelId").before(upImgs);
                //$(".type-file-div").append(lastInput.clone()); //如果需要和IE方式一样的方式添加多个 input 去上传 打开这个注释

            } else { //IE9 IE8兼容
                var upImgs = "<div class='show-img-div2'><span><img src='../../commons/easyUpload/upload/img/close.png' /></span><img class='ie-imgshow' src='../../commons/easyUpload/upload/img/null.png' /></div>";
                $("#labelId").before(upImgs);
                lastInput[0].select();
...
function createPreDiv() {
    var divStr = "<div class=\"imgs-bg\">\n <div class=\"middle\">\n <div class=\"middle-img\">\n <img src=\"\">\n</div>\n<div class=\"left\">\n<img src=\"../../commons/easyUpload/upload/img/left.png\">\n</div>\n<div class=\"right\">\n <img src=\"../../commons/easyUpload/upload/img/right.png\">\n</div>\n<p>\xD7</p>\n</div>\n </div>";
    $('body').append(divStr);
