...
public class SignfieldInfo {
	...
	public String toString() {
		return "SignfieldInfo [autoExecute=" + autoExecute
				+ ", actorIndentityType=" + actorIndentityType + ", fileId="
				+ fileId + ", sealType=" + sealType + ", signDateBean="
				+ signDateBean + ", signType=" + signType + ", posBean="
				+ posBean + ", width=" + width + "]";
	}
