...
public class HttpHelper {
	 ...
	 * @author 宫清
	 */
	public static JSONObject doCommHttp(RequestType reqType, String url, String paramStr) throws Exception {
	...
	private static Map<String, String> buildCommHeader() {
		...
		header.put("X-Tsign-Open-App-Id", ESignBean.PROJECT_ID);
		header.put("X-Tsign-Open-Token", ESignUtils.ESIGN_TOKEN);
