...
public class ESignBean {
	...
	// 模拟环境域名
	public static final String host = SystemConfig.getProperty("host", "", "eSign");
	// 生产环境域名
//	public static final String host = "https://openapi.esign.cn";

	// 项目Id(应用Id）
	public static final String PROJECT_ID = SystemConfig.getProperty("projectId", "", "eSign");
	// 项目密钥(应用密钥）
	public static final String PROJECT_SECRET = SystemConfig.getProperty("projectSecret", "", "eSign");
	
	// 流程过期时间  
	public static final long EXPIRED_TIME = Long.parseLong(SystemConfig.getProperty("expireTime", "", "eSign"));
	
	// 提前获取Token时间
	public static final long TOKEN_PRE_TIME = 1000 * 60 * 5;
	...
	//机构认证
	public static final String orgIdentity_URL(String accountId) {
		return host + "/v2/identity/auth/web/" + accountId+"/orgIdentityUrl";
	}
	...
	//删除机构印章
	public static final String deleteSealByOrgId_URL(String orgId,String sealId) {
		return host + "/v1/organizations/"+orgId+"/seals/" + sealId;
	}
	...
	// 查询流程文档关键字坐标
	public static final String getKeywordsPosition_URL(String fileId, String param) {
		StringBuffer keywordsPosition = new StringBuffer();
		keywordsPosition.append(host).append("/v1/documents/");
		keywordsPosition.append(fileId);
		keywordsPosition.append("/searchWordsPosition");
		keywordsPosition.append("?keywords="+param);
