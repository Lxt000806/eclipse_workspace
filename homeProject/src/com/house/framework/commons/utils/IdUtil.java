...
public class IdUtil {
	...
	/**
	 * 将以多个ID组成的字符串，分割组装成List<String> 
	 * 默认分割为","
	 * @param ids 多个ID组成的字符串
	 * @return
	 */
	public static List<String> splitStringIds(String ids){
		return splitStringIds(ids, ",");
	}
	 ...
	 * @return
	 */
	public static List<String> splitStringIds(String ids, String splitStr){
		if(StringUtils.isBlank(ids))
			return null;
		if(StringUtils.isBlank(splitStr)){
			splitStr = ",";
