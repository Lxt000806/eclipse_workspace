...
public class ExcelOptUtil {
	...
	public static void main(String[] args){
		String filePath = "i:/abc.xls";
		
		List<HSSFSheet> sheets = ExcelOptUtil.getSheets(ExcelOptUtil.getWorkbook(filePath));
		List<List<HSSFCell>> cells = ExcelOptUtil.getCells(sheets.get(0));
