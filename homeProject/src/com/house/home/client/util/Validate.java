...
public class Validate {
	 ...
	 */
	public static final String MOBILE ="^0?(13[0-9]|15[0-9]|18[0-9]|14[57])[0-9]{8}$";
	/**
	 * 天翼宝手机133 153 189 180 181五个号段
	 */
	public static final String TYB_MOBILE ="^0?(133|153|189|180|181)[0-9]{8}$";
    //验证九地市
	public static final String CITY ="^0?59[0-9]";
...
//	public static final String PWD = "^([0-9]|[a-z]|[A-Z]|_|`|!|~|@|#|\\$|%|\\^|\\*|\\+|=|,|.|\\?|;|'|\"|:|)|(|\\}|\\{|/|\\|\\\\|)+";
	public static final String PWD = "^([0-9]|[a-z]|[A-Z]|_|`|!|~|@|#|\\$|%|\\^|\\*|\\+|=|,|\\.\\?|;|'|\"|:|\\)|\\(|\\}|\\{|/|\\||\\\\)+$";
	/**
	 * 简单日期正则：YYYY-MM-DD
	 */
	public static final String DATE_SIMPLE="(19|20)[0-9]{2}-((0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-8])|(0[1-9]|1[0-2])-(29|30)|(0[13578]|1[02])-31)";
	/***
	 * 日期正则 支持：
	 *  YYYY-MM-DD 
	 *	YYYY/MM/DD 
...
////------------------验证方法	   
	...
	/**
	 * 判断是否为天翼宝手机号码 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static  boolean isTybMobile(String str) {
		return Regular(str,TYB_MOBILE);
	}
	/**
	 * 判断是否为Url 符合返回ture
	 * @param str
	...
	/**
	 * 判断字段是否为简单日期 符合返回ture
	 * @param str
	 * @return boolean
	 */
	public static  boolean isSimpleDate(String str) {
		return Regular(str,DATE_SIMPLE);
	}	
	/**
	 * 判断字段是否为日期 符合返回ture
	 * @param str
	 ...
	 * @return boolean
	 */
	public static  boolean validateSpecialStr(String str) {
		Pattern p = Pattern.compile(STR_SPECIAL);
		Matcher m = p.matcher(str);
		return m.find();
	}	
 	...
 	public static  boolean isPwd(String str){
 		if(StrisNull(str))
 			return false; 
 		return Regular(str,Validate.PWD);
 	}	
	public static void main(String[] args) {
//		String regex = "\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*" ;   
//		Pattern   p   =   Pattern.compile(regex);  
//		Matcher   m   =   p.matcher("13459455561");  
		System.out.println(Validate.validateSpecialStr("2323"));   
