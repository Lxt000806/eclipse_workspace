...
public class Resources extends Object {
    ...
    public static File getSystemResourceFile(String resource) throws Exception {
        File file = new File(Thread.currentThread().getContextClassLoader().getResource(".").toURI());
        String url = file.getParent() + resource;
        file = new File(url);
        return file;
    }
    ...
    public static void main(String[] args) {
        try {
            File systemResourceFile = getSystemResourceFile("/../../conf/rbt_spring.xml");
            if (systemResourceFile.exists())
                System.out.println("--------file = " + systemResourceFile);
