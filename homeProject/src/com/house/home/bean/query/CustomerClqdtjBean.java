 ...
 * 客户签订bean
 */
public class CustomerClqdtjBean implements java.io.Serializable {
	...
	@ExcelAnnotation(exportName="门", order=10)
   	private Double doorAmount;
	@ExcelAnnotation(exportName="卫浴", order=11)
   	private Double bathAmount;
	@ExcelAnnotation(exportName="主材开关", order=12)
   	private Double switchAmount;
	@ExcelAnnotation(exportName="其他", order=13)
   	private Double otherAmount;
	@ExcelAnnotation(exportName="石材", order=14)
   	private Double stoneAmount;
	@ExcelAnnotation(exportName="服务性开关", order=15)
   	private Double servSwitchAmount;
	@ExcelAnnotation(exportName="主材成本", order=16)
   	private Double mainCost;
	@ExcelAnnotation(exportName="主材毛利润", order=17)
   	private Double grossProfit;
	@ExcelAnnotation(exportName="主材每平方净利", order=18)
