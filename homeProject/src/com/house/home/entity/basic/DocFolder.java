...
public class DocFolder extends BaseEntity {
	...
	@Transient
	private String docFolderViewRole;
	@Transient
	private String adminCzyDescr;
	@Transient
	private String docFolderViewRoleDescr;
	@Transient
	...
	public String getDocFolderViewRole() {
		return docFolderViewRole;
	}

	public void setDocFolderViewRole(String docFolderViewRole) {
		this.docFolderViewRole = docFolderViewRole;
	}
	...
	public String getDocFolderViewRoleDescr() {
		return docFolderViewRoleDescr;
	}

	public void setDocFolderViewRoleDescr(String docFolderViewRoleDescr) {
		this.docFolderViewRoleDescr = docFolderViewRoleDescr;
	}
