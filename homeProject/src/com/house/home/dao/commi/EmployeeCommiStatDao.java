...
public class EmployeeCommiStatDao extends BaseDao {
	public Page<Map<String,Object>> findPageBySql(Page<Map<String,Object>> page, Employee employee) {
		...
		try{
			...
			call = conn.prepareCall("{Call pEmployeeCommiStat(?,?,?,?,?,?,?)}");
			call.setInt(1, employee.getBeginMon());
			call.setInt(2, employee.getEndMon());
			call.setString(3, employee.getDepartment1());
			call.setString(4, employee.getDepartment2());
			call.setString(5, employee.getNumber());
			call.setString(6, employee.getPositionType());
			call.setString(7, employee.getShowNoCommiEmp());
			call.execute();
