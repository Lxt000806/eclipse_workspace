...
@Repository
public class DesignManRankingDao extends BaseDao{

	/**
	 * 设计师排名查询
	 * @author	created by zb
	 * @date	2018-12-11--下午12:02:13
	 * @param page
	 * @param customer
	 * @return
	 */
	public Page<Map<String, Object>> findPageBySql(
		...
		try{
			...
			call = conn.prepareCall("{Call pDesignManRanking(?,?,?,?,?,?)}");
			...
			call.setString(5, page.getPageOrderBy());
			call.setString(6, page.getPageOrder());
			call.execute();
