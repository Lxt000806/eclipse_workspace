...
@Repository
public class BusinessCustFlowAnalyDao extends BaseDao{
	/**
	 * 业务客户流向分析
	 * @author	created by zb
	 * @date	2019-8-27--下午4:20:16
	 * @param page
	 * @param customer
	 * @return
	 */
	...
	public Page<Map<String, Object>> findPageBySql(
		...
		try{
			...
			call = conn.prepareCall("{Call pBusinessCustFlowAnaly(?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			call.setString(1, customer.getDepartment1());
			call.setString(2, customer.getDepartment2());
			...
			call.setString(6, customer.getCzybh());
			call.setString(7, customer.getCustRight());
			call.setInt(8, page.getPageSize());
			call.setInt(9, page.getPageNo());
			call.setString(10, page.getPageOrderBy());
			call.setString(11, page.getPageOrder() == ""?"desc":"asc");
			call.registerOutParameter(12, Types.INTEGER);
			call.setString(13, customer.getEmpCode());
			call.execute();
			ResultSet rs = call.getResultSet(); 
			List<Map<String, Object>> list=BeanConvertUtil.resultSetToList(rs);
			page.setResult(list);
			page.setTotalCount(call.getInt(12));
		}catch(Exception e){
			e.printStackTrace();
		}finally{
	...
	public Page<Map<String, Object>> findCrtDetailPageBySql(
		...
		String sql = "select * from (select cc.Code,cc.Address,cc.Area,cc.CustType,ct.Desc1 CustTypeDescr,cc.VisitDate,em2.NameChi DesignMan,em2.Department1 DesignDepartment1, "
					+"dm12.Desc1 designdepartment1descr,em2.Department2 DesignDepartment2,dm22.Desc1 DesignDepartment2Descr,em.NameChi BusinessMan, "
					+"em.Department1,dm1.Desc1 Department1Descr,em.Department2,dm2.Desc1 Department2Descr "
					+"from tCustomer cc "
					+"left join tCusttype ct on ct.Code=cc.CustType "
					+"inner join tCustStakeholder cs on cs.CustCode = cc.Code and cs.Role='00' "
					...
					+"inner join tCustStakeholder cs3 on cs3.CustCode = cc.Code and cs3.Role='01' "
	...
	public Page<Map<String, Object>> findSetDetailPageBySql(
			Page<Map<String, Object>> page, Employee employee, UserContext uc) {
		List<Object> list = new ArrayList<Object>(); 
		String sql = "select * from (select cc.Code,cc.Address,cc.Area,cc.CustType,ct.Desc1 CustTypeDescr,cc.SetDate,em2.NameChi DesignMan,em2.Department1 DesignDepartment1, "
					+"dm12.Desc1 designdepartment1descr,em2.Department2 DesignDepartment2,dm22.Desc1 DesignDepartment2Descr,em.NameChi BusinessMan, "
					+"em.Department1,dm1.Desc1 Department1Descr,em.Department2,dm2.Desc1 Department2Descr "
					+"from tCustomer cc "
					+"left join tCusttype ct on ct.Code=cc.CustType "
	...
	public Page<Map<String, Object>> findSignDetailPageBySql(
			Page<Map<String, Object>> page, Employee employee, UserContext uc) {
		List<Object> list = new ArrayList<Object>(); 
		String sql = "select * from (select cc.Code,cc.Address,cc.Area,cc.CustType,ct.Desc1 CustTypeDescr,cc.SignDate,em2.NameChi DesignMan,em2.Department1 DesignDepartment1, "
					+"dm12.Desc1 designdepartment1descr,em2.Department2 DesignDepartment2,dm22.Desc1 DesignDepartment2Descr,em.NameChi BusinessMan, "
					+"em.Department1,dm1.Desc1 Department1Descr,em.Department2,dm2.Desc1 Department2Descr,cc.ContractFee "
					+"from tCustomer cc "
					+"left join tCusttype ct on ct.Code=cc.CustType   "
					+"inner join tCustStakeholder cs on cs.CustCode=cc.Code and cs.Role='00' "
					+"inner join tEmployee em2 on em2.Number=cs.EmpCode "
		...
		list.add(uc.getCzybh());
		sql += "union all "
		  	+  "select cc.Code,cc.Address,cc.Area,cc.CustType,ct.Desc1 CustTypeDescr,asn.SignDate,em2.NameChi DesignMan,em2.Department1 DesignDepartment1, "
			+  "dm12.Desc1 designdepartment1descr,em2.Department2 DesignDepartment2,dm22.Desc1 DesignDepartment2Descr,em.NameChi BusinessMan, "
			+  "em.Department1,dm1.Desc1 Department1Descr,em.Department2,dm2.Desc1 Department2Descr,Asn.ContractFee "
			+  "from tCustomer cc "
			+  "inner join tCustStakeholder cs on cs.CustCode=cc.Code and cs.Role='00' "
			+  "inner join tEmployee em2 on em2.Number=cs.EmpCode "
			+  "left join tDepartment1 dm12 on em2.Department1 = dm12.Code "
